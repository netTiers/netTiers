<? include("inc.top.php"); ?>
					...
					<div class="itemizedlist">
						<ul type="disc">
							...
							<li>
								the code is fully <em>nDoc</em> commented (it use to Description extended properties of the data table and column) and follow the microsoft naming guidelines.
							</li>
							<li>Open source ! You can modify the templates and contribute (<a href="http://www.sourceforge.net/projects/cstemplates" target="_top">http://www.sourceforge.net/projects/cstemplates</a>)</li>
						</ul>
					</div>
