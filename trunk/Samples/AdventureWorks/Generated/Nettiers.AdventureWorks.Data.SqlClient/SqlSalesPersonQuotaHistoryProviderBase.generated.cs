...
/*
	...
	Important: Do not modify this file. Edit the file SqlSalesPersonQuotaHistoryProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSalesPersonQuotaHistoryProviderBase : SalesPersonQuotaHistoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSalesPersonQuotaHistoryProviderBase"/> instance.
		/// </summary>
		public SqlSalesPersonQuotaHistoryProviderBase()
		{
		}
	...
	public SqlSalesPersonQuotaHistoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _salesPersonId, System.DateTime _quotaDate)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesPersonQuotaHistory_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SalesPersonQuotaHistory)
					,_salesPersonId,_quotaDate);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SalesPersonQuotaHistory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesPersonQuotaHistory_Get_List", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SalesPersonQuotaHistory> GetBySalesPersonId(TransactionManager transactionManager, System.Int32 _salesPersonId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesPersonQuotaHistory_GetBySalesPersonId", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesPersonQuotaHistory_GetByRowguid", _useStoredProcedure);
		...
		#region GetBySalesPersonIdQuotaDate
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory> entities)
		{
			...
			bulkCopy.DestinationTableName = "SalesPersonQuotaHistory";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("SalesPersonID", typeof(System.Int32));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("QuotaDate", typeof(System.DateTime));
			...
			bulkCopy.ColumnMappings.Add("QuotaDate", "QuotaDate");
			...
			foreach(Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["QuotaDate"] = entity.QuotaDate;
							
				
					row["SalesQuota"] = entity.SalesQuota;
