...
/*
	...
	Important: Do not modify this file. Edit the file SqlSpecialOfferProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSpecialOfferProviderBase : SpecialOfferProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSpecialOfferProviderBase"/> instance.
		/// </summary>
		public SqlSpecialOfferProviderBase()
		{
		}
	...
	public SqlSpecialOfferProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<SpecialOffer> GetByProductIdFromSpecialOfferProduct(TransactionManager transactionManager, System.Int32 _productId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_GetByProductIdFromSpecialOfferProduct", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@ProductId", DbType.Int32, _productId);
			
			IDataReader reader = null;
			// Create collection and fill
			TList<SpecialOffer> rows = new TList<SpecialOffer>();
			
			try
			{
				// Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByProductIdFromSpecialOfferProduct", rows)); 
				...
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByProductIdFromSpecialOfferProduct", rows)); 
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _specialOfferId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SpecialOffer)
					,_specialOfferId);
		...
		public override TList<SpecialOffer> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<SpecialOffer>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@DiscountPct", DbType.Currency, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@MinQty", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@MaxQty", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@ModifiedDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("discountpct ") || clause.Trim().StartsWith("discountpct="))
				{
					database.SetParameterValue(commandWrapper, "@DiscountPct", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				...
				if (clause.Trim().StartsWith("minqty ") || clause.Trim().StartsWith("minqty="))
				{
					database.SetParameterValue(commandWrapper, "@MinQty", 
						clause.Trim().Remove(0,6).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("maxqty ") || clause.Trim().StartsWith("maxqty="))
				{
					database.SetParameterValue(commandWrapper, "@MaxQty", 
						clause.Trim().Remove(0,6).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SpecialOffer objects.</returns>
		public override TList<SpecialOffer> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_Find_Dynamic", typeof(SpecialOfferColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SpecialOffer> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SpecialOffer objects.</returns>
		public override TList<SpecialOffer> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Nettiers.AdventureWorks.Entities.SpecialOffer GetByRowguid(TransactionManager transactionManager, System.Guid _rowguid, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_GetByRowguid", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Rowguid", DbType.Guid, _rowguid);
			
			IDataReader reader = null;
			TList<SpecialOffer> tmp = new TList<SpecialOffer>();
			try
			{
				//Provider Data Requesting Command Event
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Nettiers.AdventureWorks.Entities.SpecialOffer GetBySpecialOfferId(TransactionManager transactionManager, System.Int32 _specialOfferId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SpecialOffer_GetBySpecialOfferId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetBySpecialOfferId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetBySpecialOfferId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Nettiers.AdventureWorks.Entities.SpecialOffer> entities)
		{
			...
			bulkCopy.DestinationTableName = "SpecialOffer";
			...
			DataColumn col2 = dataTable.Columns.Add("DiscountPct", typeof(System.Decimal));
			col2.AllowDBNull = false;		
			DataColumn col3 = dataTable.Columns.Add("Type", typeof(System.String));
			...
			DataColumn col7 = dataTable.Columns.Add("MinQty", typeof(System.Int32));
			col7.AllowDBNull = false;		
			DataColumn col8 = dataTable.Columns.Add("MaxQty", typeof(System.Int32));
			...
			bulkCopy.ColumnMappings.Add("DiscountPct", "DiscountPct");
			...
			foreach(Nettiers.AdventureWorks.Entities.SpecialOffer entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["DiscountPct"] = entity.DiscountPct;
					...
					row["MinQty"] = entity.MinQty;
							
				
					row["MaxQty"] = entity.MaxQty.HasValue ? (object) entity.MaxQty  : System.DBNull.Value;
