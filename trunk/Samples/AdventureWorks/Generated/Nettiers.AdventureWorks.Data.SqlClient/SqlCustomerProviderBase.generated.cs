...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<Customer> GetByAddressIdFromCustomerAddress(TransactionManager transactionManager, System.Int32 _addressId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_GetByAddressIdFromCustomerAddress", _useStoredProcedure);
			...
			try
			{
				...
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAddressIdFromCustomerAddress", rows)); 
				...
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAddressIdFromCustomerAddress", rows)); 
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_Delete", _useStoredProcedure);
		...
		public override TList<Customer> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@CustomerType", DbType.StringFixedLength, DBNull.Value);
		...
		public override TList<Customer> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_Find_Dynamic", typeof(CustomerColumn), filter, orderBy, start, pageLength);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_Get_List", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_GetPaged", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_GetByAccountNumber", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@AccountNumber", DbType.AnsiString, _accountNumber);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_GetByRowguid", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Customer> GetByTerritoryId(TransactionManager transactionManager, System.Int32? _territoryId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_GetByTerritoryId", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_GetByCustomerId", _useStoredProcedure);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<Nettiers.AdventureWorks.Entities.Customer> entities)
		{
			...
			DataColumn col2 = dataTable.Columns.Add("AccountNumber", typeof(System.String));
			col2.AllowDBNull = false;		
			DataColumn col3 = dataTable.Columns.Add("CustomerType", typeof(System.String));
			...
			foreach(Nettiers.AdventureWorks.Entities.Customer entity in entities)
			{
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_Customer_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@CustomerId", DbType.Int32, 4);
			...
			object _customerId = database.GetParameterValue(commandWrapper, "@CustomerId");
			entity.CustomerId = (System.Int32)_customerId;
