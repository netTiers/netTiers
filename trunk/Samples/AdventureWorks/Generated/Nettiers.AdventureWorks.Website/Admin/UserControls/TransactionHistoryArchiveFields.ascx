<%@ Control Language="C#" ClassName="TransactionHistoryArchiveFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataTransactionId" Text='<%# Bind("TransactionId") %>'></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataTransactionId" runat="server" Display="Dynamic" ControlToValidate="dataTransactionId" ErrorMessage="Required"></asp:RequiredFieldValidator><asp:RangeValidator ID="RangeVal_dataTransactionId" runat="server" Display="Dynamic" ControlToValidate="dataTransactionId" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
