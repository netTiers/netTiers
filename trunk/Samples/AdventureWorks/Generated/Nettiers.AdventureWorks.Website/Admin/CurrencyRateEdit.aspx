<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="CurrencyRateEdit.aspx.cs" Inherits="CurrencyRateEdit" Title="CurrencyRate Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Currency Rate - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="CurrencyRateId" runat="server" DataSourceID="CurrencyRateDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/CurrencyRateFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:CurrencyRateDataSource ID="CurrencyRateDataSource" runat="server"
			SelectMethod="GetByCurrencyRateId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="CurrencyRateId" QueryStringField="CurrencyRateId" Type="String" />
		...
		<data:SalesOrderHeaderDataSource ID="SalesOrderHeaderDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:SalesOrderHeaderFilter  Column="CurrencyRateId" QueryStringField="CurrencyRateId" /> 
					</Filters>
				</data:SqlParameter>
