...
{		
	...
	///<summary>
	/// An interface representation of the 'ProductProductPhoto' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IProductProductPhoto.cs file instead.
	/// All custom implementations should be done in the <see cref="IProductProductPhoto"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IProductProductPhotoServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{ProductProductPhoto}" /> from the datasource based on the FK_ProductProductPhoto_Product_ProductID key.
		...
		TList<ProductProductPhoto> GetByProductId(System.Int32 _productId);
		...
		TList<ProductProductPhoto> GetByProductId(System.Int32 _productId, int start, int pageLength, out int totalCount);
		
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{ProductProductPhoto}" /> from the datasource based on the FK_ProductProductPhoto_ProductPhoto_ProductPhotoID key.
		...
		TList<ProductProductPhoto> GetByProductPhotoId(System.Int32 _productPhotoId);
		...
		TList<ProductProductPhoto> GetByProductPhotoId(System.Int32 _productPhotoId, int start, int pageLength, out int totalCount);
		...
		ProductProductPhoto Get(ProductProductPhotoKey key);
		...
		ProductProductPhoto GetByProductIdProductPhotoId(System.Int32 _productId, System.Int32 _productPhotoId);
		...
		ProductProductPhoto GetByProductIdProductPhotoId(System.Int32 _productId, System.Int32 _productPhotoId, int start, int pageLength, out int totalCount);
		...
		TList<ProductProductPhoto> GetAll();
		...
		TList<ProductProductPhoto> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<ProductProductPhoto> GetPaged(out int totalCount);
		...
		TList<ProductProductPhoto> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<ProductProductPhoto> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<ProductProductPhoto> Find(string whereClause)	;
		...
		TList<ProductProductPhoto> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<ProductProductPhoto> Find(IFilterParameterCollection parameters);
		...
		TList<ProductProductPhoto> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<ProductProductPhoto> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a ProductProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductProductPhoto.Insert(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		...
		bool Insert(ProductProductPhoto entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{ProductProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductProductPhoto> Insert(TList<ProductProductPhoto> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a ProductProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductProductPhoto.Update(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Update(ProductProductPhoto entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{ProductProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductProductPhoto> Update(TList<ProductProductPhoto> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a ProductProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductProductPhoto.Save(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		ProductProductPhoto Save(ProductProductPhoto entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{ProductProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductProductPhoto> Save(TList<ProductProductPhoto> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a ProductProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductProductPhoto.Delete(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Delete(ProductProductPhoto entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{ProductProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductProductPhoto> Delete(TList<ProductProductPhoto> entityCollection);
		...
		bool Delete(ProductProductPhotoKey key);
		...
		bool Delete(System.Int32 _productId, System.Int32 _productPhotoId);
