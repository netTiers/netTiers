...
{		
	...
	///<summary>
	/// An interface representation of the 'ProductPhoto' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IProductPhoto.cs file instead.
	/// All custom implementations should be done in the <see cref="IProductPhoto"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IProductPhotoServiceBase
	{
		...
		ProductPhoto Get(ProductPhotoKey key);
		...
		ProductPhoto GetByProductPhotoId(System.Int32 _productPhotoId);
		...
		ProductPhoto GetByProductPhotoId(System.Int32 _productPhotoId, int start, int pageLength, out int totalCount);
		...
		TList<ProductPhoto> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<ProductPhoto> GetPaged(out int totalCount);
		...
		TList<ProductPhoto> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<ProductPhoto> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<ProductPhoto> Find(string whereClause)	;
		...
		TList<ProductPhoto> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<ProductPhoto> Find(IFilterParameterCollection parameters);
		...
		TList<ProductPhoto> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<ProductPhoto> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a ProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(ProductPhoto entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{ProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductPhoto> Insert(TList<ProductPhoto> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a ProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(ProductPhoto entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{ProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductPhoto> Update(TList<ProductPhoto> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a ProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		ProductPhoto Save(ProductPhoto entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{ProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductPhoto> Save(TList<ProductPhoto> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a ProductPhoto object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(ProductPhoto entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{ProductPhoto}" /> to the datasource.
		/// </summary>
		...
		TList<ProductPhoto> Delete(TList<ProductPhoto> entityCollection);
		...
		bool Delete(ProductPhotoKey key);
		...
		bool Delete(System.Int32 _productPhotoId);
		...
		/// <returns>Returns a typed collection of TList<ProductPhoto> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		
        
		TList<ProductPhoto> GetByProductIdFromProductProductPhoto(System.Int32 _productId);
		...
		TList<ProductPhoto> GetByProductIdFromProductProductPhoto(System.Int32 _productId, int start, int pageLength, out int totalCount);
