...
{		
	...
	///<summary>
	/// An interface representation of the 'JobCandidate' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IJobCandidate.cs file instead.
	/// All custom implementations should be done in the <see cref="IJobCandidate"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IJobCandidateServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{JobCandidate}" /> from the datasource based on the FK_JobCandidate_Employee_EmployeeID key.
		///		FK_JobCandidate_Employee_EmployeeID Description: Foreign key constraint referencing Employee.EmployeeID.
		/// </summary>
		/// <param name="_employeeId">Employee identification number if applicant was hired. Foreign key to Employee.EmployeeID.</param>
		/// <returns>Returns a generic collection of JobCandidate objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		
        
		TList<JobCandidate> GetByEmployeeId(System.Int32? _employeeId);
		...
		/// <returns>Returns a collection <see cref="TList{JobCandidate}" /> of <c>JobCandidate</c> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		
        
		TList<JobCandidate> GetByEmployeeId(System.Int32? _employeeId, int start, int pageLength, out int totalCount);
		...
		JobCandidate Get(JobCandidateKey key);
		...
		JobCandidate GetByJobCandidateId(System.Int32 _jobCandidateId);
		...
		JobCandidate GetByJobCandidateId(System.Int32 _jobCandidateId, int start, int pageLength, out int totalCount);
		...
		TList<JobCandidate> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<JobCandidate> GetPaged(out int totalCount);
		...
		TList<JobCandidate> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<JobCandidate> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<JobCandidate> Find(string whereClause)	;
		...
		TList<JobCandidate> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<JobCandidate> Find(IFilterParameterCollection parameters);
		...
		TList<JobCandidate> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<JobCandidate> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a JobCandidate object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(JobCandidate entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{JobCandidate}" /> to the datasource.
		/// </summary>
		...
		TList<JobCandidate> Insert(TList<JobCandidate> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a JobCandidate object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(JobCandidate entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{JobCandidate}" /> to the datasource.
		/// </summary>
		...
		TList<JobCandidate> Update(TList<JobCandidate> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a JobCandidate object into the datasource using a transaction.
		/// </summary>
		...
		JobCandidate Save(JobCandidate entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{JobCandidate}" /> to the datasource.
		/// </summary>
		...
		TList<JobCandidate> Save(TList<JobCandidate> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a JobCandidate object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(JobCandidate entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{JobCandidate}" /> to the datasource.
		/// </summary>
		...
		TList<JobCandidate> Delete(TList<JobCandidate> entityCollection);
		...
		bool Delete(JobCandidateKey key);
		...
		bool Delete(System.Int32 _jobCandidateId);
