...
{		
	...
	///<summary>
	/// An interface representation of the 'DatabaseLog' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IDatabaseLog.cs file instead.
	/// All custom implementations should be done in the <see cref="IDatabaseLog"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IDatabaseLogServiceBase
	{
		...
		DatabaseLog Get(DatabaseLogKey key);
		...
		DatabaseLog GetByDatabaseLogId(System.Int32 _databaseLogId);
		...
		DatabaseLog GetByDatabaseLogId(System.Int32 _databaseLogId, int start, int pageLength, out int totalCount);
		...
		TList<DatabaseLog> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<DatabaseLog> GetPaged(out int totalCount);
		...
		TList<DatabaseLog> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<DatabaseLog> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<DatabaseLog> Find(string whereClause)	;
		...
		TList<DatabaseLog> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<DatabaseLog> Find(IFilterParameterCollection parameters);
		...
		TList<DatabaseLog> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<DatabaseLog> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a DatabaseLog object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(DatabaseLog entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{DatabaseLog}" /> to the datasource.
		/// </summary>
		...
		TList<DatabaseLog> Insert(TList<DatabaseLog> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a DatabaseLog object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(DatabaseLog entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{DatabaseLog}" /> to the datasource.
		/// </summary>
		...
		TList<DatabaseLog> Update(TList<DatabaseLog> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a DatabaseLog object into the datasource using a transaction.
		/// </summary>
		...
		DatabaseLog Save(DatabaseLog entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{DatabaseLog}" /> to the datasource.
		/// </summary>
		...
		TList<DatabaseLog> Save(TList<DatabaseLog> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a DatabaseLog object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(DatabaseLog entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{DatabaseLog}" /> to the datasource.
		/// </summary>
		...
		TList<DatabaseLog> Delete(TList<DatabaseLog> entityCollection);
		...
		bool Delete(DatabaseLogKey key);
		...
		bool Delete(System.Int32 _databaseLogId);
