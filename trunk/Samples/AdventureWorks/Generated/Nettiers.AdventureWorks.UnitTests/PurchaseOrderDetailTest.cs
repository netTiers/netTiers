...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PurchaseOrderDetailTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  PurchaseOrderDetail objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public PurchaseOrderDetail CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            PurchaseOrderDetail mock = PurchaseOrderDetailTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, PurchaseOrderDetail mock)
        {
            PurchaseOrderDetailTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(PurchaseOrderDetail mock)
        {
