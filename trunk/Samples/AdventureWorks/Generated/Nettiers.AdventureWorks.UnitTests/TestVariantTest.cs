...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TestVariantTest"/> instance.
		/// </summary>	
		public TestVariantTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TestVariant objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public TestVariant CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            TestVariant mock = TestVariantTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, TestVariant mock)
        {
            TestVariantTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(TestVariant mock)
        {
