...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ContactTest"/> instance.
		/// </summary>	
		public ContactTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Contact objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(Contact mock)
        {
            //Code your changes to the data object here.

            //Set the XML to null
            mock.AdditionalContactInfo = null;
            mock.EmailPromotion = 1;
        }
    }
}
