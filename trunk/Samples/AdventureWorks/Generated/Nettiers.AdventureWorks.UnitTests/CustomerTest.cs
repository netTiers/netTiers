...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CustomerTest"/> instance.
		/// </summary>	
		public CustomerTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Customer objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Customer CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Customer mock = CustomerTest.CreateMockInstance_Generated(tm);
