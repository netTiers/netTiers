...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PurchaseOrderHeaderTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  PurchaseOrderHeader objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(PurchaseOrderHeader mock)
        {
            //Code your changes to the data object here.
            mock.ShipDate = mock.OrderDate.AddDays(2);
            mock.Status = TestUtility.Instance.RandomByte(1, 4);
        }
    }
}
