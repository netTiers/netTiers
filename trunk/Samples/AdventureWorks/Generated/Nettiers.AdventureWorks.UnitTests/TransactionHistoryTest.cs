...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TransactionHistoryTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  TransactionHistory objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public TransactionHistory CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            TransactionHistory mock = TransactionHistoryTest.CreateMockInstance_Generated(tm);
        ...
        static private void SetSpecialTestData(TransactionHistory mock)
        {
