...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductSubcategoryTest"/> instance.
		/// </summary>	
		public ProductSubcategoryTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ProductSubcategory objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(ProductSubcategory mock)
        {
