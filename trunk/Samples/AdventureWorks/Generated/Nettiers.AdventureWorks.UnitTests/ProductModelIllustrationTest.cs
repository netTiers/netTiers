...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductModelIllustrationTest"/> instance.
		/// </summary>	
		public ProductModelIllustrationTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ProductModelIllustration objects of the database.
		/// </summary>
        ...
        ///</summary>
        static public ProductModelIllustration CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ProductModelIllustration mock = ProductModelIllustrationTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ProductModelIllustration mock)
        {
            ProductModelIllustrationTest.UpdateMockInstance_Generated(tm, mock);
