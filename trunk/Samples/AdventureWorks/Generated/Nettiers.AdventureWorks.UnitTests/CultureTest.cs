...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CultureTest"/> instance.
		/// </summary>	
		public CultureTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Culture objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Culture CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Culture mock = CultureTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Culture mock)
        {
            CultureTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Culture mock)
        {
