...
{
    /// <summary>
    /// Provides tests for the and <see cref="DatabaseLog"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
	/// This file is generated once and will never be overwritten.
	/// </remarks>
    [TestFixture]
    public partial class DatabaseLogTest
    {    	
		/// <summary>
		/// Creates a new <see cref="DatabaseLogTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  DatabaseLog objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Updates a mock DatabaseLog entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Delete the mock DatabaseLog entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize the mock DatabaseLog entity from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize a DatabaseLog collection from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
