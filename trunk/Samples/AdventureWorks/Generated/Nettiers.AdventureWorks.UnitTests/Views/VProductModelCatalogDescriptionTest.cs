...
{
    /// <summary>
    /// Provides tests for the <see cref="VProductModelCatalogDescription"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VProductModelCatalogDescriptionTest"/> instance.
		/// </summary>	
		public VProductModelCatalogDescriptionTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VProductModelCatalogDescription objects of the database.
		/// </summary>
