...
{
    /// <summary>
    /// Provides tests for the <see cref="VJobCandidateEducation"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VJobCandidateEducationTest"/> instance.
		/// </summary>	
		public VJobCandidateEducationTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VJobCandidateEducation objects of the database.
		/// </summary>
