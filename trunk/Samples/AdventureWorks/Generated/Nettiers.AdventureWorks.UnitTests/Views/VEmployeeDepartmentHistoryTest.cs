...
{
    /// <summary>
    /// Provides tests for the <see cref="VEmployeeDepartmentHistory"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VEmployeeDepartmentHistoryTest"/> instance.
		/// </summary>	
		public VEmployeeDepartmentHistoryTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VEmployeeDepartmentHistory objects of the database.
		/// </summary>
