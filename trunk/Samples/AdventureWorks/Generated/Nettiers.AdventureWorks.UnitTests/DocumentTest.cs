...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="DocumentTest"/> instance.
		/// </summary>	
		public DocumentTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Document objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Document CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Document mock = DocumentTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Document mock)
        {
            DocumentTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Document mock)
        {
            //Code your changes to the data object here.
            mock.Status = TestUtility.Instance.RandomByte(1, 3);
        }
    }
}
