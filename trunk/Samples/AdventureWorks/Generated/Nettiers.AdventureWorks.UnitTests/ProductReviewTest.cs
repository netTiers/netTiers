...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductReviewTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  ProductReview objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ProductReview CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ProductReview mock = ProductReviewTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ProductReview mock)
        {
            ProductReviewTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ProductReview mock)
        {
            //Code your changes to the data object here.
            mock.Rating = TestUtility.Instance.RandomNumber(1, 5);
        }
    }
}
