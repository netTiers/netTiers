...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ShipMethodTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  ShipMethod objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ShipMethod CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ShipMethod mock = ShipMethodTest.CreateMockInstance_Generated(tm);
        ...
        static private void SetSpecialTestData(ShipMethod mock)
        {
