...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ErrorLogTest"/> instance.
		/// </summary>	
		public ErrorLogTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ErrorLog objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ErrorLog CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ErrorLog mock = ErrorLogTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ErrorLog mock)
        {
            ErrorLogTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ErrorLog mock)
        {
