...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="StateProvinceTest"/> instance.
		/// </summary>	
		public StateProvinceTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  StateProvince objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(StateProvince mock)
        {
