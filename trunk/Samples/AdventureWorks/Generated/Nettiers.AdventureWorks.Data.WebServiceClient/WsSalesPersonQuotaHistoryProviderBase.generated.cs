...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory objects.
	///</summary>
	public abstract partial class WsSalesPersonQuotaHistoryProviderBase : SalesPersonQuotaHistoryProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsSalesPersonQuotaHistoryProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsSalesPersonQuotaHistoryProviderBase()
		{		
		}
		...
		public WsSalesPersonQuotaHistoryProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static WsProxy.SalesPersonQuotaHistory[] Convert(Nettiers.AdventureWorks.Entities.TList<SalesPersonQuotaHistory> items)
		{
			WsProxy.SalesPersonQuotaHistory[] outItems = new WsProxy.SalesPersonQuotaHistory[items.Count];
			int count = 0;
		
			foreach (Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory item in items)
			{
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _salesPersonId, System.DateTime _quotaDate)
			{
				try
				{
				// call the proxy
				...
				bool result = proxy.SalesPersonQuotaHistoryProvider_Delete(_salesPersonId, _quotaDate);				
				return result;
				}
		...
		public override Nettiers.AdventureWorks.Entities.TList<SalesPersonQuotaHistory> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.SalesPersonQuotaHistory[] items = proxy.SalesPersonQuotaHistoryProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SalesPersonQuotaHistory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.SalesPersonQuotaHistory[] items = proxy.SalesPersonQuotaHistoryProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SalesPersonQuotaHistory> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.SalesPersonQuotaHistory[] items = proxy.SalesPersonQuotaHistoryProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>		
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SalesPersonQuotaHistory> GetBySalesPersonId(TransactionManager transactionManager, System.Int32 _salesPersonId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SalesPersonQuotaHistory[] items = proxy.SalesPersonQuotaHistoryProvider_GetBySalesPersonId(_salesPersonId, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory GetByRowguid(TransactionManager transactionManager, System.Guid _rowguid, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SalesPersonQuotaHistory items = proxy.SalesPersonQuotaHistoryProvider_GetByRowguid(_rowguid, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory GetBySalesPersonIdQuotaDate(TransactionManager transactionManager, System.Int32 _salesPersonId, System.DateTime _quotaDate, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SalesPersonQuotaHistory items = proxy.SalesPersonQuotaHistoryProvider_GetBySalesPersonIdQuotaDate(_salesPersonId, _quotaDate, start, pageLength, out count);
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<SalesPersonQuotaHistory> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.SalesPersonQuotaHistoryProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.SalesPersonQuotaHistory entity)
		{
			...
			try
			{
				WsProxy.SalesPersonQuotaHistory result = proxy.SalesPersonQuotaHistoryProvider_Update(Convert(entity));
				Convert(entity, result);
