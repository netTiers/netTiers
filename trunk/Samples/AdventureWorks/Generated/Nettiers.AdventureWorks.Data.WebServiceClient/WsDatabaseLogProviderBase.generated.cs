...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.DatabaseLog.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.DatabaseLog objects.
	///</summary>
	public abstract partial class WsDatabaseLogProviderBase : DatabaseLogProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsDatabaseLogProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsDatabaseLogProviderBase()
		{		
		}
		...
		public WsDatabaseLogProviderBase(string url)
		{
			this.Url = url;
		}
		...
		public override Nettiers.AdventureWorks.Entities.TList<DatabaseLog> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.DatabaseLog[] items = proxy.DatabaseLogProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.DatabaseLog objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<DatabaseLog> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.DatabaseLog[] items = proxy.DatabaseLogProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.DatabaseLog GetByDatabaseLogId(TransactionManager transactionManager, System.Int32 _databaseLogId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.DatabaseLog items = proxy.DatabaseLogProvider_GetByDatabaseLogId(_databaseLogId, start, pageLength, out count);
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<DatabaseLog> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.DatabaseLogProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.DatabaseLog entity)
		{
			...
			try
			{
				WsProxy.DatabaseLog result = proxy.DatabaseLogProvider_Update(Convert(entity));
				Convert(entity, result);
