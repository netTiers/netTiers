...
/*
	...
	Important: Do not modify this file. Edit the file SqlInventoryProvider.cs instead.
*/
...
namespace netTiers.Petshop.Data.SqlClient
{
	...
	///</summary>
	public partial class SqlInventoryProviderBase : InventoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlInventoryProviderBase"/> instance.
		/// </summary>
		public SqlInventoryProviderBase()
		{
		}
	...
	public SqlInventoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Guid itemId, System.Guid suppId, byte[] timestamp)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Inventory)
					,itemId,suppId);
		...
		public override netTiers.Petshop.Entities.TList<Inventory> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new netTiers.Petshop.Entities.TList<Inventory>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@Qty", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Timestamp", DbType.Binary, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("qty ") || clause.Trim().StartsWith("qty="))
				{
					database.SetParameterValue(commandWrapper, "@Qty", 
						clause.Replace("qty","").Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			netTiers.Petshop.Entities.TList<Inventory> rows = new netTiers.Petshop.Entities.TList<Inventory>();
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_Get_List", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_GetPaged", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_GetByItemId", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_GetBySuppId", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_GetByItemIdSuppId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@ItemId", DbType.Guid, itemId);
				database.AddInParameter(commandWrapper, "@SuppId", DbType.Guid, suppId);
			
			IDataReader reader = null;
			netTiers.Petshop.Entities.TList<Inventory> tmp = new netTiers.Petshop.Entities.TList<Inventory>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.Petshop.Entities.Inventory> entities)
		{
			...
			DataColumn col0 = dataTable.Columns.Add("ItemId", typeof(System.Guid));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("SuppId", typeof(System.Guid));
			col1.AllowDBNull = false;		
			DataColumn col2 = dataTable.Columns.Add("Qty", typeof(System.Int32));
			col2.AllowDBNull = false;		
			DataColumn col3 = dataTable.Columns.Add("Timestamp", typeof(System.Byte[]));
			...
			foreach(netTiers.Petshop.Entities.Inventory entity in entities)
			{
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Inventory_Update", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@ItemId", DbType.Guid, entity.ItemId );
			database.AddInParameter(commandWrapper, "@OriginalItemId", DbType.Guid, entity.OriginalItemId);
			database.AddInParameter(commandWrapper, "@SuppId", DbType.Guid, entity.SuppId );
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = database.GetStoredProcCommand("CSP_Inventory_GetMaxSupplier");
