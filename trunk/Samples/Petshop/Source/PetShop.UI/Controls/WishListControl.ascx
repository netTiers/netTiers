<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WishListControl.ascx.cs" Inherits="PetShop.UI.Controls.WishListControl" %>
...
<asp:Repeater ID="repWishList" runat="server">
    ...
    <ItemTemplate>
            <tr class="listItem">
				...
				<td style="width:100%;">
                    <a id="A1" runat="server" href='<%# string.Format("~/Items.aspx?itemId={0}&productId={1}&categoryId={2}", Eval("ItemId"), Eval("ProductId"), Eval("CategoryId")) %>'><%# string.Format("{0} {1}", Eval("Name"), Eval("Type")) %></a>
                </td>
