...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CountryRegionCurrencyTest"/> instance.
		/// </summary>	
		public CountryRegionCurrencyTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  CountryRegionCurrency objects of the database.
		/// </summary>
