...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ContactCreditCardTest"/> instance.
		/// </summary>	
		public ContactCreditCardTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ContactCreditCard objects of the database.
		/// </summary>
        ...
        ///</summary>
        static public ContactCreditCard CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ContactCreditCard mock = ContactCreditCardTest.CreateMockInstance_Generated(tm);
