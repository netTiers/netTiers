...
{
    /// <summary>
    /// Provides tests for the and <see cref="SalesOrderHeaderSalesReason"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
	/// This file is generated once and will never be overwritten.
	/// </remarks>
    [TestFixture]
    public partial class SalesOrderHeaderSalesReasonTest
    {    	
		/// <summary>
		/// Creates a new <see cref="SalesOrderHeaderSalesReasonTest"/> instance.
		/// </summary>	
		public SalesOrderHeaderSalesReasonTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SalesOrderHeaderSalesReason objects of the database.
		/// </summary>
		...
		/// <summary>
		/// Deep load all SalesOrderHeaderSalesReason children.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize the mock SalesOrderHeaderSalesReason entity from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize a SalesOrderHeaderSalesReason collection from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SalesOrderHeaderSalesReason CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SalesOrderHeaderSalesReason mock = SalesOrderHeaderSalesReasonTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, SalesOrderHeaderSalesReason mock)
        {
            SalesOrderHeaderSalesReasonTest.UpdateMockInstance_Generated(tm, mock);
