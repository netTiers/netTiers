...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SalesTaxRateTest"/> instance.
		/// </summary>	
		public SalesTaxRateTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SalesTaxRate objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(SalesTaxRate mock)
        {
            //Code your changes to the data object here.
            mock.TaxType = TestUtility.Instance.RandomByte(1, 3);
        }
    }
}
