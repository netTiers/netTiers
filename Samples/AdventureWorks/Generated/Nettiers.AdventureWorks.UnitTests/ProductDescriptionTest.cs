...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductDescriptionTest"/> instance.
		/// </summary>	
		public ProductDescriptionTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ProductDescription objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(ProductDescription mock)
        {
