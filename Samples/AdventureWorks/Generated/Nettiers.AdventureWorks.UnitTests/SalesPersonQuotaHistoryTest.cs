...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SalesPersonQuotaHistoryTest"/> instance.
		/// </summary>	
		public SalesPersonQuotaHistoryTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SalesPersonQuotaHistory objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SalesPersonQuotaHistory CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SalesPersonQuotaHistory mock = SalesPersonQuotaHistoryTest.CreateMockInstance_Generated(tm);
