...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductModelProductDescriptionCultureTest"/> instance.
		/// </summary>	
		public ProductModelProductDescriptionCultureTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ProductModelProductDescriptionCulture objects of the database.
		/// </summary>
