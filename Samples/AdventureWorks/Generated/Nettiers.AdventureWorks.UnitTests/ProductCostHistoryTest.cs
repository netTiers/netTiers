...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductCostHistoryTest"/> instance.
		/// </summary>	
		public ProductCostHistoryTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ProductCostHistory objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(ProductCostHistory mock)
        {
