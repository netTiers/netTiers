...
{
    /// <summary>
    /// Provides tests for the <see cref="VSalesPersonSalesByFiscalYears"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VSalesPersonSalesByFiscalYearsTest"/> instance.
		/// </summary>	
		public VSalesPersonSalesByFiscalYearsTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VSalesPersonSalesByFiscalYears objects of the database.
		/// </summary>
