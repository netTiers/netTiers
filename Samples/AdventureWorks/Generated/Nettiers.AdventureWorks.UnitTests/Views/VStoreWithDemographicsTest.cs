...
{
    /// <summary>
    /// Provides tests for the <see cref="VStoreWithDemographics"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VStoreWithDemographicsTest"/> instance.
		/// </summary>	
		public VStoreWithDemographicsTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VStoreWithDemographics objects of the database.
		/// </summary>
