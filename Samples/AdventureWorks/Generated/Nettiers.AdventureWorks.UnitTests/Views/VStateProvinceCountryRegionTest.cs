...
{
    /// <summary>
    /// Provides tests for the <see cref="VStateProvinceCountryRegion"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VStateProvinceCountryRegionTest"/> instance.
		/// </summary>	
		public VStateProvinceCountryRegionTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VStateProvinceCountryRegion objects of the database.
		/// </summary>
