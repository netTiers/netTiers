...
{
    /// <summary>
    /// Provides tests for the <see cref="VEmployee"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VEmployeeTest"/> instance.
		/// </summary>	
		public VEmployeeTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VEmployee objects of the database.
		/// </summary>
