...
{
    /// <summary>
    /// Provides tests for the <see cref="VJobCandidate"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VJobCandidateTest"/> instance.
		/// </summary>	
		public VJobCandidateTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VJobCandidate objects of the database.
		/// </summary>
