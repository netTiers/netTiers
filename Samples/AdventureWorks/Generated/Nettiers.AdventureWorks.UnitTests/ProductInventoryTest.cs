...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductInventoryTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  ProductInventory objects of the database.
		/// </summary>
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ProductInventory mock)
        {
            ProductInventoryTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ProductInventory mock)
        {
            //Code your changes to the data object here.
            mock.Shelf = "N/A";
            mock.Bin = TestUtility.Instance.RandomByte(0, 100);
        }
    }
}
