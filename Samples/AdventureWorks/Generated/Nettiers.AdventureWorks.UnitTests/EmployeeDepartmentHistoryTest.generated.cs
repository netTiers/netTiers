...
/*
	...
	Important: Do not modify this file. Edit the file EmployeeDepartmentHistoryTest.cs instead.
*/
...
namespace Nettiers.AdventureWorks.UnitTests
{
   ...
   public partial class EmployeeDepartmentHistoryTest
    {
    	// the EmployeeDepartmentHistory instance used to test the repository.
		protected EmployeeDepartmentHistory mock;

		// the TList<EmployeeDepartmentHistory> instance used to test the repository.
		protected TList<EmployeeDepartmentHistory> mockCollection;
        ...
        static public void Init_Generated()
        {
			...
			System.Console.WriteLine("-- Testing the EmployeeDepartmentHistory Entity with the {0} --", Nettiers.AdventureWorks.Data.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		/// <summary>
		/// Selects all EmployeeDepartmentHistory objects of the database.
		/// </summary>
		private void Step_02_SelectAll_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				mockCollection = DataRepository.EmployeeDepartmentHistoryProvider.Find(tm, null, "", 0, 10, out count );
				Assert.IsTrue(count >= 0 && mockCollection != null, "Query Failed to issue Find Command.");

				System.Console.WriteLine("DataRepository.EmployeeDepartmentHistoryProvider.Find():");
		...
		private void Step_04_Update_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				Assert.IsTrue(DataRepository.EmployeeDepartmentHistoryProvider.Update(tm, mock), "Update failed.");

				System.Console.WriteLine("DataRepository.EmployeeDepartmentHistoryProvider.Update(mock):");
				System.Console.WriteLine(mock);
		...
		private void Step_05_Delete_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				mock =  (EmployeeDepartmentHistory)CreateMockInstance(tm);
				DataRepository.EmployeeDepartmentHistoryProvider.Insert(tm, mock);

				Assert.IsTrue(DataRepository.EmployeeDepartmentHistoryProvider.Delete(tm, mock), "Delete failed.");
				System.Console.WriteLine("DataRepository.EmployeeDepartmentHistoryProvider.Delete(mock):");
				System.Console.WriteLine(mock);
		...
		private void Step_07_DeserializeEntity_Generated()
		{
			...
			{
				object item = EntityHelper.DeserializeEntityXml<EmployeeDepartmentHistory>(sr.ReadToEnd());
				sr.Close();
			}
		...
		private void Step_08_SerializeCollection_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				string fileName = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "temp_EmployeeDepartmentHistoryCollection.xml");

				mock = CreateMockInstance(tm);
				TList<EmployeeDepartmentHistory> mockCollection = new TList<EmployeeDepartmentHistory>();
				mockCollection.Add(mock);

				EntityHelper.SerializeXml(mockCollection, fileName);

				Assert.IsTrue(System.IO.File.Exists(fileName), "Serialized mock collection not found");
				System.Console.WriteLine("TList<EmployeeDepartmentHistory> correctly serialized to a temporary file.");
			}
		}
		...
		private void Step_09_DeserializeCollection_Generated()
		{
			...
			XmlSerializer mySerializer = new XmlSerializer(typeof(TList<EmployeeDepartmentHistory>));
			using (System.IO.FileStream myFileStream = new System.IO.FileStream(fileName,  System.IO.FileMode.Open))
			{
				TList<EmployeeDepartmentHistory> mockCollection = (TList<EmployeeDepartmentHistory>) mySerializer.Deserialize(myFileStream);
				myFileStream.Close();
			}

			System.IO.File.Delete(fileName);
			System.Console.WriteLine("TList<EmployeeDepartmentHistory> correctly deserialized from a temporary file.");
		}
		#endregion
