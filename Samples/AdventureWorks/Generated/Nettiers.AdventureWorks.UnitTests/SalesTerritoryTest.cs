...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SalesTerritoryTest"/> instance.
		/// </summary>	
		public SalesTerritoryTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  SalesTerritory objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(SalesTerritory mock)
        {
