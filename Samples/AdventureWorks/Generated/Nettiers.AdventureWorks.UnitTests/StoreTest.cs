...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="StoreTest"/> instance.
		/// </summary>	
		public StoreTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Store objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Store CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Store mock = StoreTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Store mock)
        {
            StoreTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Store mock)
        {
