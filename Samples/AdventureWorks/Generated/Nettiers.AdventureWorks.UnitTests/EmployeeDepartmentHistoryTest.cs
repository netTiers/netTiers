...
{
    /// <summary>
    /// Provides tests for the and <see cref="EmployeeDepartmentHistory"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
	/// This file is generated once and will never be overwritten.
	/// </remarks>
    [TestFixture]
    public partial class EmployeeDepartmentHistoryTest
    {    	
		/// <summary>
		/// Creates a new <see cref="EmployeeDepartmentHistoryTest"/> instance.
		/// </summary>	
		public EmployeeDepartmentHistoryTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  EmployeeDepartmentHistory objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Updates a mock EmployeeDepartmentHistory entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Delete the mock EmployeeDepartmentHistory entity into the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize the mock EmployeeDepartmentHistory entity from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Serialize a EmployeeDepartmentHistory collection into a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
		...
		/// <summary>
		/// Deserialize a EmployeeDepartmentHistory collection from a temporary file.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(EmployeeDepartmentHistory mock)
        {
