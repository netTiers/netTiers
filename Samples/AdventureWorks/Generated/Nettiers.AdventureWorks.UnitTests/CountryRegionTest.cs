...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CountryRegionTest"/> instance.
		/// </summary>	
		public CountryRegionTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  CountryRegion objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(CountryRegion mock)
        {
