...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SpecialOfferTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  SpecialOffer objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public SpecialOffer CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            SpecialOffer mock = SpecialOfferTest.CreateMockInstance_Generated(tm);
