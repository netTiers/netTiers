...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductPhotoTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  ProductPhoto objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(ProductPhoto mock)
        {
