...
{
	/// <summary>
	/// This is the abstract edit form for the <see cref="Entities.Currency"/> entity.
	/// </summary>
	/// <remarks>This class is overwritten by .netTiers at each generation.</remarks>
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	public abstract class CurrencyEditControlBase : System.Windows.Forms.UserControl
	{
		#region Fields
		...
		/// <summary>
		/// TextBox for the CurrencyCode property. 
		/// </summary>
		protected System.Windows.Forms.TextBox uxCurrencyCode;
		...
		/// <summary>
		/// Gets or sets the <see cref="Entities.Currency"/> entity to edit with this form.
		/// </summary>
		/// <value>The <see cref="Entities.Currency"/> instance.</value>
		...
		private void BindControls()
		{
			...
			this.uxCurrencyCode.DataBindings.Add("Text", this.uxBindingSource, "CurrencyCode", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CurrencyEditControlBase"/> class.
		/// </summary>
		public CurrencyEditControlBase()
		{
			InitializeComponent();			
		...
		{
			if (_Currency != null) _Currency.Validate();
		}	
		...
		public void InitializeComponent()
		{
			...
			this.uxCurrencyCode = new System.Windows.Forms.TextBox();
			...
			this.uxCurrencyCodeLabel.Location = new System.Drawing.Point(3, 0);
			...
			this.uxCurrencyCode.Width = 250;
			this.uxCurrencyCode.MaxLength = 3;
			//this.uxTableLayoutPanel.Controls.Add(this.uxCurrencyCode);
			this.uxCurrencyCode.Location = new System.Drawing.Point(160, 0);
			...
			// 
			// CurrencyEditControlBase
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			//this.Controls.Add(this.uxTableLayoutPanel);
			this.AutoScroll = true;
			this.Name = "CurrencyEditControlBase";
