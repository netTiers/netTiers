...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'CustomerAddress' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the ICustomerAddress.cs file instead.
	/// All custom implementations should be done in the <see cref="ICustomerAddress"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface ICustomerAddressServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{CustomerAddress}" /> from the datasource based on the FK_CustomerAddress_Address_AddressID key.
		...
		TList<CustomerAddress> GetByAddressId(System.Int32 _addressId);
		...
		TList<CustomerAddress> GetByAddressId(System.Int32 _addressId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{CustomerAddress}" /> from the datasource based on the FK_CustomerAddress_AddressType_AddressTypeID key.
		...
		TList<CustomerAddress> GetByAddressTypeId(System.Int32 _addressTypeId);
		...
		TList<CustomerAddress> GetByAddressTypeId(System.Int32 _addressTypeId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{CustomerAddress}" /> from the datasource based on the FK_CustomerAddress_Customer_CustomerID key.
		...
		TList<CustomerAddress> GetByCustomerId(System.Int32 _customerId);
		...
		TList<CustomerAddress> GetByCustomerId(System.Int32 _customerId, int start, int pageLength, out int totalCount);
		...
		CustomerAddress Get(CustomerAddressKey key);
		...
		CustomerAddress GetByRowguid(System.Guid _rowguid);
		...
		CustomerAddress GetByRowguid(System.Guid _rowguid, int start, int pageLength, out int totalCount);
		...
		CustomerAddress GetByCustomerIdAddressId(System.Int32 _customerId, System.Int32 _addressId);
		...
		CustomerAddress GetByCustomerIdAddressId(System.Int32 _customerId, System.Int32 _addressId, int start, int pageLength, out int totalCount);
		...
		TList<CustomerAddress> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<CustomerAddress> GetPaged(out int totalCount);
		...
		TList<CustomerAddress> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<CustomerAddress> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<CustomerAddress> Find(string whereClause)	;
		...
		TList<CustomerAddress> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<CustomerAddress> Find(IFilterParameterCollection parameters);
		...
		TList<CustomerAddress> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<CustomerAddress> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a CustomerAddress object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(CustomerAddress entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{CustomerAddress}" /> to the datasource.
		/// </summary>
		...
		TList<CustomerAddress> Insert(TList<CustomerAddress> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a CustomerAddress object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(CustomerAddress entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{CustomerAddress}" /> to the datasource.
		/// </summary>
		...
		TList<CustomerAddress> Update(TList<CustomerAddress> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a CustomerAddress object into the datasource using a transaction.
		/// </summary>
		...
		CustomerAddress Save(CustomerAddress entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{CustomerAddress}" /> to the datasource.
		/// </summary>
		...
		TList<CustomerAddress> Save(TList<CustomerAddress> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a CustomerAddress object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(CustomerAddress entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{CustomerAddress}" /> to the datasource.
		/// </summary>
		...
		TList<CustomerAddress> Delete(TList<CustomerAddress> entityCollection);
		...
		bool Delete(CustomerAddressKey key);
		...
		bool Delete(System.Int32 _customerId, System.Int32 _addressId);
