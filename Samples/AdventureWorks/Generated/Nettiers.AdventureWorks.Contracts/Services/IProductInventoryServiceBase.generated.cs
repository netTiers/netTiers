...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'ProductInventory' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IProductInventory.cs file instead.
	/// All custom implementations should be done in the <see cref="IProductInventory"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IProductInventoryServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{ProductInventory}" /> from the datasource based on the FK_ProductInventory_Location_LocationID key.
		...
		TList<ProductInventory> GetByLocationId(System.Int16 _locationId);
		...
		TList<ProductInventory> GetByLocationId(System.Int16 _locationId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{ProductInventory}" /> from the datasource based on the FK_ProductInventory_Product_ProductID key.
		...
		TList<ProductInventory> GetByProductId(System.Int32 _productId);
		...
		TList<ProductInventory> GetByProductId(System.Int32 _productId, int start, int pageLength, out int totalCount);
		...
		ProductInventory Get(ProductInventoryKey key);
		...
		ProductInventory GetByProductIdLocationId(System.Int32 _productId, System.Int16 _locationId);
		...
		ProductInventory GetByProductIdLocationId(System.Int32 _productId, System.Int16 _locationId, int start, int pageLength, out int totalCount);
		...
		TList<ProductInventory> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<ProductInventory> GetPaged(out int totalCount);
		...
		TList<ProductInventory> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<ProductInventory> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<ProductInventory> Find(string whereClause)	;
		...
		TList<ProductInventory> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<ProductInventory> Find(IFilterParameterCollection parameters);
		...
		TList<ProductInventory> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<ProductInventory> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a ProductInventory object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductInventory.Insert(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		...
		bool Insert(ProductInventory entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{ProductInventory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductInventory> Insert(TList<ProductInventory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a ProductInventory object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductInventory.Update(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Update(ProductInventory entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{ProductInventory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductInventory> Update(TList<ProductInventory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a ProductInventory object into the datasource using a transaction.
		/// </summary>
		...
		ProductInventory Save(ProductInventory entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{ProductInventory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductInventory> Save(TList<ProductInventory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a ProductInventory object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(ProductInventory entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{ProductInventory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductInventory> Delete(TList<ProductInventory> entityCollection);
		...
		bool Delete(ProductInventoryKey key);
		...
		bool Delete(System.Int32 _productId, System.Int16 _locationId);
