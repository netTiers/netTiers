...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'Vendor' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IVendor.cs file instead.
	/// All custom implementations should be done in the <see cref="IVendor"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IVendorServiceBase
	{
		...
		Vendor GetByAccountNumber(System.String _accountNumber);
		...
		Vendor GetByAccountNumber(System.String _accountNumber, int start, int pageLength, out int totalCount);
		...
		Vendor GetByVendorId(System.Int32 _vendorId);
		...
		Vendor GetByVendorId(System.Int32 _vendorId, int start, int pageLength, out int totalCount);
		...
		TList<Vendor> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<Vendor> GetPaged(out int totalCount);
		...
		TList<Vendor> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<Vendor> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<Vendor> Find(string whereClause)	;
		...
		TList<Vendor> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<Vendor> Find(IFilterParameterCollection parameters);
		...
		TList<Vendor> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<Vendor> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a Vendor object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{Vendor}" /> to the datasource.
		/// </summary>
		...
		TList<Vendor> Insert(TList<Vendor> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a Vendor object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{Vendor}" /> to the datasource.
		/// </summary>
		...
		TList<Vendor> Update(TList<Vendor> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a Vendor object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{Vendor}" /> to the datasource.
		/// </summary>
		...
		TList<Vendor> Save(TList<Vendor> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a Vendor object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{Vendor}" /> to the datasource.
		/// </summary>
		...
		TList<Vendor> Delete(TList<Vendor> entityCollection);
		...
		bool Delete(System.Int32 _vendorId);
		...
		/// <returns>Returns a typed collection of TList<Vendor> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]


		TList<Vendor> GetByProductIdFromProductVendor(System.Int32 _productId);
		...
		TList<Vendor> GetByProductIdFromProductVendor(System.Int32 _productId, int start, int pageLength, out int totalCount);
		...
		TList<Vendor> GetByAddressIdFromVendorAddress(System.Int32 _addressId);
		...
		TList<Vendor> GetByAddressIdFromVendorAddress(System.Int32 _addressId, int start, int pageLength, out int totalCount);
		...
		TList<Vendor> GetByContactIdFromVendorContact(System.Int32 _contactId);
		...
		TList<Vendor> GetByContactIdFromVendorContact(System.Int32 _contactId, int start, int pageLength, out int totalCount);
