...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'ProductCostHistory' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IProductCostHistory.cs file instead.
	/// All custom implementations should be done in the <see cref="IProductCostHistory"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IProductCostHistoryServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{ProductCostHistory}" /> from the datasource based on the FK_ProductCostHistory_Product_ProductID key.
		...
		TList<ProductCostHistory> GetByProductId(System.Int32 _productId);
		...
		TList<ProductCostHistory> GetByProductId(System.Int32 _productId, int start, int pageLength, out int totalCount);
		...
		ProductCostHistory Get(ProductCostHistoryKey key);
		...
		ProductCostHistory GetByProductIdStartDate(System.Int32 _productId, System.DateTime _startDate);
		...
		ProductCostHistory GetByProductIdStartDate(System.Int32 _productId, System.DateTime _startDate, int start, int pageLength, out int totalCount);
		...
		TList<ProductCostHistory> GetAll();
		...
		TList<ProductCostHistory> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<ProductCostHistory> GetPaged(out int totalCount);
		...
		TList<ProductCostHistory> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<ProductCostHistory> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<ProductCostHistory> Find(string whereClause)	;
		...
		TList<ProductCostHistory> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<ProductCostHistory> Find(IFilterParameterCollection parameters);
		...
		TList<ProductCostHistory> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<ProductCostHistory> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a ProductCostHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductCostHistory.Insert(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		...
		bool Insert(ProductCostHistory entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{ProductCostHistory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductCostHistory> Insert(TList<ProductCostHistory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a ProductCostHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductCostHistory.Update(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Update(ProductCostHistory entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{ProductCostHistory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductCostHistory> Update(TList<ProductCostHistory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a ProductCostHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductCostHistory.Save(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		ProductCostHistory Save(ProductCostHistory entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{ProductCostHistory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductCostHistory> Save(TList<ProductCostHistory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a ProductCostHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		ProductCostHistory.Delete(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Delete(ProductCostHistory entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{ProductCostHistory}" /> to the datasource.
		/// </summary>
		...
		TList<ProductCostHistory> Delete(TList<ProductCostHistory> entityCollection);
		...
		bool Delete(ProductCostHistoryKey key);
