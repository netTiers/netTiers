...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'SalesPerson' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the ISalesPerson.cs file instead.
	/// All custom implementations should be done in the <see cref="ISalesPerson"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface ISalesPersonServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{SalesPerson}" /> from the datasource based on the FK_SalesPerson_Employee_SalesPersonID key.
		///		FK_SalesPerson_Employee_SalesPersonID Description: Foreign key constraint referencing Employee.EmployeeID.
		/// </summary>
		...
		TList<SalesPerson> GetBySalesPersonId(System.Int32 _salesPersonId);
		...
		TList<SalesPerson> GetBySalesPersonId(System.Int32 _salesPersonId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{SalesPerson}" /> from the datasource based on the FK_SalesPerson_SalesTerritory_TerritoryID key.
		...
		TList<SalesPerson> GetByTerritoryId(System.Int32? _territoryId);
		...
		TList<SalesPerson> GetByTerritoryId(System.Int32? _territoryId, int start, int pageLength, out int totalCount);
		...
		SalesPerson Get(SalesPersonKey key);
		...
		SalesPerson GetByRowguid(System.Guid _rowguid);
		...
		SalesPerson GetByRowguid(System.Guid _rowguid, int start, int pageLength, out int totalCount);
		...
		TList<SalesPerson> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<SalesPerson> GetPaged(out int totalCount);
		...
		TList<SalesPerson> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<SalesPerson> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<SalesPerson> Find(string whereClause)	;
		...
		TList<SalesPerson> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<SalesPerson> Find(IFilterParameterCollection parameters);
		...
		TList<SalesPerson> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<SalesPerson> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		bool Insert(SalesPerson entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{SalesPerson}" /> to the datasource.
		/// </summary>
		...
		TList<SalesPerson> Insert(TList<SalesPerson> entityCollection);
		...
		bool Update(SalesPerson entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{SalesPerson}" /> to the datasource.
		/// </summary>
		...
		TList<SalesPerson> Update(TList<SalesPerson> entityCollection);
		...
		SalesPerson Save(SalesPerson entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{SalesPerson}" /> to the datasource.
		/// </summary>
		...
		TList<SalesPerson> Save(TList<SalesPerson> entityCollection);
		...
		bool Delete(SalesPerson entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{SalesPerson}" /> to the datasource.
		/// </summary>
		...
		TList<SalesPerson> Delete(TList<SalesPerson> entityCollection);
		...
		bool Delete(SalesPersonKey key);
		...
		bool Delete(System.Int32 _salesPersonId);
