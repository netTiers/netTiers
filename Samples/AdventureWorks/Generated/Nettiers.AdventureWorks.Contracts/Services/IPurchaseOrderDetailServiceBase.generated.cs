...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'PurchaseOrderDetail' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IPurchaseOrderDetail.cs file instead.
	/// All custom implementations should be done in the <see cref="IPurchaseOrderDetail"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IPurchaseOrderDetailServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{PurchaseOrderDetail}" /> from the datasource based on the FK_PurchaseOrderDetail_Product_ProductID key.
		///		FK_PurchaseOrderDetail_Product_ProductID Description: Foreign key constraint referencing Product.ProductID.
		/// </summary>
		...
		TList<PurchaseOrderDetail> GetByProductId(System.Int32 _productId);
		...
		TList<PurchaseOrderDetail> GetByProductId(System.Int32 _productId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{PurchaseOrderDetail}" /> from the datasource based on the FK_PurchaseOrderDetail_PurchaseOrderHeader_PurchaseOrderID key.
		...
		TList<PurchaseOrderDetail> GetByPurchaseOrderId(System.Int32 _purchaseOrderId);
		...
		TList<PurchaseOrderDetail> GetByPurchaseOrderId(System.Int32 _purchaseOrderId, int start, int pageLength, out int totalCount);
		...
		PurchaseOrderDetail Get(PurchaseOrderDetailKey key);
		...
		PurchaseOrderDetail GetByPurchaseOrderIdPurchaseOrderDetailId(System.Int32 _purchaseOrderId, System.Int32 _purchaseOrderDetailId);
		...
		PurchaseOrderDetail GetByPurchaseOrderIdPurchaseOrderDetailId(System.Int32 _purchaseOrderId, System.Int32 _purchaseOrderDetailId, int start, int pageLength, out int totalCount);
		...
		TList<PurchaseOrderDetail> GetAll();
		...
		TList<PurchaseOrderDetail> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<PurchaseOrderDetail> GetPaged(out int totalCount);
		...
		TList<PurchaseOrderDetail> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<PurchaseOrderDetail> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<PurchaseOrderDetail> Find(string whereClause)	;
		...
		TList<PurchaseOrderDetail> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<PurchaseOrderDetail> Find(IFilterParameterCollection parameters);
		...
		TList<PurchaseOrderDetail> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<PurchaseOrderDetail> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a PurchaseOrderDetail object into the datasource using a transaction.
		/// </summary>
		...
		///		PurchaseOrderDetail.Insert(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		...
		bool Insert(PurchaseOrderDetail entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{PurchaseOrderDetail}" /> to the datasource.
		/// </summary>
		...
		TList<PurchaseOrderDetail> Insert(TList<PurchaseOrderDetail> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a PurchaseOrderDetail object into the datasource using a transaction.
		/// </summary>
		...
		///		PurchaseOrderDetail.Update(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Update(PurchaseOrderDetail entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{PurchaseOrderDetail}" /> to the datasource.
		/// </summary>
		...
		TList<PurchaseOrderDetail> Update(TList<PurchaseOrderDetail> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a PurchaseOrderDetail object into the datasource using a transaction.
		/// </summary>
		...
		PurchaseOrderDetail Save(PurchaseOrderDetail entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{PurchaseOrderDetail}" /> to the datasource.
		/// </summary>
		...
		TList<PurchaseOrderDetail> Save(TList<PurchaseOrderDetail> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a PurchaseOrderDetail object into the datasource using a transaction.
		/// </summary>
		...
		///		PurchaseOrderDetail.Delete(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Delete(PurchaseOrderDetail entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{PurchaseOrderDetail}" /> to the datasource.
		/// </summary>
		...
		TList<PurchaseOrderDetail> Delete(TList<PurchaseOrderDetail> entityCollection);
		...
		bool Delete(PurchaseOrderDetailKey key);
		...
		bool Delete(System.Int32 _purchaseOrderId, System.Int32 _purchaseOrderDetailId);
