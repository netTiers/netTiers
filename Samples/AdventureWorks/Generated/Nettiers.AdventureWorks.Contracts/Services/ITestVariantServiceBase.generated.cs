...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'TestVariant' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the ITestVariant.cs file instead.
	/// All custom implementations should be done in the <see cref="ITestVariant"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface ITestVariantServiceBase
	{
		...
		TestVariant Get(TestVariantKey key);
		...
		TestVariant GetByTestVariantId(System.Int32 _testVariantId);
		...
		TestVariant GetByTestVariantId(System.Int32 _testVariantId, int start, int pageLength, out int totalCount);
		...
		TList<TestVariant> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<TestVariant> GetPaged(out int totalCount);
		...
		TList<TestVariant> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<TestVariant> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<TestVariant> Find(string whereClause)	;
		...
		TList<TestVariant> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<TestVariant> Find(IFilterParameterCollection parameters);
		...
		TList<TestVariant> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<TestVariant> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a TestVariant object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(TestVariant entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{TestVariant}" /> to the datasource.
		/// </summary>
		...
		TList<TestVariant> Insert(TList<TestVariant> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a TestVariant object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(TestVariant entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{TestVariant}" /> to the datasource.
		/// </summary>
		...
		TList<TestVariant> Update(TList<TestVariant> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a TestVariant object into the datasource using a transaction.
		/// </summary>
		...
		TestVariant Save(TestVariant entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{TestVariant}" /> to the datasource.
		/// </summary>
		...
		TList<TestVariant> Save(TList<TestVariant> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a TestVariant object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(TestVariant entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{TestVariant}" /> to the datasource.
		/// </summary>
		...
		TList<TestVariant> Delete(TList<TestVariant> entityCollection);
		...
		bool Delete(TestVariantKey key);
		...
		bool Delete(System.Int32 _testVariantId);
