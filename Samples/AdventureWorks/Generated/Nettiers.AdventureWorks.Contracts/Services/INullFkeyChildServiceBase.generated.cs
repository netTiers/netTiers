...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'NullFKeyChild' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the INullFkeyChild.cs file instead.
	/// All custom implementations should be done in the <see cref="INullFkeyChild"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface INullFkeyChildServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{NullFkeyChild}" /> from the datasource based on the FK_NullFKeyChild_NullFKeyParent key.
		...
		TList<NullFkeyChild> GetByNullFkeyParentId(System.Int32? _nullFkeyParentId);
		...
		TList<NullFkeyChild> GetByNullFkeyParentId(System.Int32? _nullFkeyParentId, int start, int pageLength, out int totalCount);
		...
		NullFkeyChild Get(NullFkeyChildKey key);
		...
		NullFkeyChild GetByNullFkeyChildId(System.Int32 _nullFkeyChildId);
		...
		NullFkeyChild GetByNullFkeyChildId(System.Int32 _nullFkeyChildId, int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyChild> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyChild> GetPaged(out int totalCount);
		...
		TList<NullFkeyChild> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyChild> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyChild> Find(string whereClause)	;
		...
		TList<NullFkeyChild> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyChild> Find(IFilterParameterCollection parameters);
		...
		TList<NullFkeyChild> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<NullFkeyChild> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a NullFkeyChild object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(NullFkeyChild entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{NullFkeyChild}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyChild> Insert(TList<NullFkeyChild> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a NullFkeyChild object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(NullFkeyChild entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{NullFkeyChild}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyChild> Update(TList<NullFkeyChild> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a NullFkeyChild object into the datasource using a transaction.
		/// </summary>
		...
		NullFkeyChild Save(NullFkeyChild entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{NullFkeyChild}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyChild> Save(TList<NullFkeyChild> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a NullFkeyChild object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(NullFkeyChild entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{NullFkeyChild}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyChild> Delete(TList<NullFkeyChild> entityCollection);
		...
		bool Delete(NullFkeyChildKey key);
		...
		bool Delete(System.Int32 _nullFkeyChildId);
