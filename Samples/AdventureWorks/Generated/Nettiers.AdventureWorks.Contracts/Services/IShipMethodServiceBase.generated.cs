...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'ShipMethod' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IShipMethod.cs file instead.
	/// All custom implementations should be done in the <see cref="IShipMethod"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IShipMethodServiceBase
	{
		...
		ShipMethod Get(ShipMethodKey key);
		...
		ShipMethod GetByName(System.String _name);
		...
		ShipMethod GetByName(System.String _name, int start, int pageLength, out int totalCount);
		...
		ShipMethod GetByRowguid(System.Guid _rowguid);
		...
		ShipMethod GetByRowguid(System.Guid _rowguid, int start, int pageLength, out int totalCount);
		...
		ShipMethod GetByShipMethodId(System.Int32 _shipMethodId);
		...
		ShipMethod GetByShipMethodId(System.Int32 _shipMethodId, int start, int pageLength, out int totalCount);
		...
		TList<ShipMethod> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<ShipMethod> GetPaged(out int totalCount);
		...
		TList<ShipMethod> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<ShipMethod> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<ShipMethod> Find(string whereClause)	;
		...
		TList<ShipMethod> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<ShipMethod> Find(IFilterParameterCollection parameters);
		...
		TList<ShipMethod> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<ShipMethod> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a ShipMethod object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{ShipMethod}" /> to the datasource.
		/// </summary>
		...
		TList<ShipMethod> Insert(TList<ShipMethod> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a ShipMethod object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{ShipMethod}" /> to the datasource.
		/// </summary>
		...
		TList<ShipMethod> Update(TList<ShipMethod> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a ShipMethod object into the datasource using a transaction.
		/// </summary>
		...
		ShipMethod Save(ShipMethod entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{ShipMethod}" /> to the datasource.
		/// </summary>
		...
		TList<ShipMethod> Save(TList<ShipMethod> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a ShipMethod object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{ShipMethod}" /> to the datasource.
		/// </summary>
		...
		TList<ShipMethod> Delete(TList<ShipMethod> entityCollection);
		...
		bool Delete(System.Int32 _shipMethodId);
