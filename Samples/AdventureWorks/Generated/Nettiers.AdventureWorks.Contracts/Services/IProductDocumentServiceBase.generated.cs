...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'ProductDocument' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IProductDocument.cs file instead.
	/// All custom implementations should be done in the <see cref="IProductDocument"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IProductDocumentServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{ProductDocument}" /> from the datasource based on the FK_ProductDocument_Document_DocumentID key.
		...
		TList<ProductDocument> GetByDocumentId(System.Int32 _documentId);
		...
		TList<ProductDocument> GetByDocumentId(System.Int32 _documentId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{ProductDocument}" /> from the datasource based on the FK_ProductDocument_Product_ProductID key.
		...
		TList<ProductDocument> GetByProductId(System.Int32 _productId);
		...
		TList<ProductDocument> GetByProductId(System.Int32 _productId, int start, int pageLength, out int totalCount);
		...
		ProductDocument Get(ProductDocumentKey key);
		...
		ProductDocument GetByProductIdDocumentId(System.Int32 _productId, System.Int32 _documentId);
		...
		ProductDocument GetByProductIdDocumentId(System.Int32 _productId, System.Int32 _documentId, int start, int pageLength, out int totalCount);
		...
		TList<ProductDocument> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<ProductDocument> GetPaged(out int totalCount);
		...
		TList<ProductDocument> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<ProductDocument> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<ProductDocument> Find(string whereClause)	;
		...
		TList<ProductDocument> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<ProductDocument> Find(IFilterParameterCollection parameters);
		...
		TList<ProductDocument> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<ProductDocument> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a ProductDocument object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(ProductDocument entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{ProductDocument}" /> to the datasource.
		/// </summary>
		...
		TList<ProductDocument> Insert(TList<ProductDocument> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a ProductDocument object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(ProductDocument entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{ProductDocument}" /> to the datasource.
		/// </summary>
		...
		TList<ProductDocument> Update(TList<ProductDocument> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a ProductDocument object into the datasource using a transaction.
		/// </summary>
		...
		ProductDocument Save(ProductDocument entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{ProductDocument}" /> to the datasource.
		/// </summary>
		...
		TList<ProductDocument> Save(TList<ProductDocument> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a ProductDocument object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(ProductDocument entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{ProductDocument}" /> to the datasource.
		/// </summary>
		...
		TList<ProductDocument> Delete(TList<ProductDocument> entityCollection);
		...
		bool Delete(ProductDocumentKey key);
		...
		bool Delete(System.Int32 _productId, System.Int32 _documentId);
