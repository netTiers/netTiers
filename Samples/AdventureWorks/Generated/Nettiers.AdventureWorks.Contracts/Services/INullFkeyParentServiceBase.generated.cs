...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'NullFKeyParent' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the INullFkeyParent.cs file instead.
	/// All custom implementations should be done in the <see cref="INullFkeyParent"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface INullFkeyParentServiceBase
	{
		...
		NullFkeyParent Get(NullFkeyParentKey key);
		...
		NullFkeyParent GetByNullFkeyParentId(System.Int32 _nullFkeyParentId);
		...
		NullFkeyParent GetByNullFkeyParentId(System.Int32 _nullFkeyParentId, int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyParent> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyParent> GetPaged(out int totalCount);
		...
		TList<NullFkeyParent> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyParent> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyParent> Find(string whereClause)	;
		...
		TList<NullFkeyParent> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<NullFkeyParent> Find(IFilterParameterCollection parameters);
		...
		TList<NullFkeyParent> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<NullFkeyParent> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a NullFkeyParent object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(NullFkeyParent entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{NullFkeyParent}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyParent> Insert(TList<NullFkeyParent> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a NullFkeyParent object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(NullFkeyParent entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{NullFkeyParent}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyParent> Update(TList<NullFkeyParent> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a NullFkeyParent object into the datasource using a transaction.
		/// </summary>
		...
		NullFkeyParent Save(NullFkeyParent entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{NullFkeyParent}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyParent> Save(TList<NullFkeyParent> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a NullFkeyParent object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(NullFkeyParent entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{NullFkeyParent}" /> to the datasource.
		/// </summary>
		...
		TList<NullFkeyParent> Delete(TList<NullFkeyParent> entityCollection);
		...
		bool Delete(NullFkeyParentKey key);
		...
		bool Delete(System.Int32 _nullFkeyParentId);
