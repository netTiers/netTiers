...
{		
	...
	///<summary>
	/// An interface representation of the 'SalesTerritoryHistory' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the ISalesTerritoryHistory.cs file instead.
	/// All custom implementations should be done in the <see cref="ISalesTerritoryHistory"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface ISalesTerritoryHistoryServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{SalesTerritoryHistory}" /> from the datasource based on the FK_SalesTerritoryHistory_SalesPerson_SalesPersonID key.
		...
		TList<SalesTerritoryHistory> GetBySalesPersonId(System.Int32 _salesPersonId);
		...
		TList<SalesTerritoryHistory> GetBySalesPersonId(System.Int32 _salesPersonId, int start, int pageLength, out int totalCount);
		
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{SalesTerritoryHistory}" /> from the datasource based on the FK_SalesTerritoryHistory_SalesTerritory_TerritoryID key.
		...
		TList<SalesTerritoryHistory> GetByTerritoryId(System.Int32 _territoryId);
		...
		TList<SalesTerritoryHistory> GetByTerritoryId(System.Int32 _territoryId, int start, int pageLength, out int totalCount);
		...
		SalesTerritoryHistory Get(SalesTerritoryHistoryKey key);
		...
		SalesTerritoryHistory GetByRowguid(System.Guid _rowguid);
		...
		SalesTerritoryHistory GetByRowguid(System.Guid _rowguid, int start, int pageLength, out int totalCount);
		...
		SalesTerritoryHistory GetBySalesPersonIdStartDateTerritoryId(System.Int32 _salesPersonId, System.DateTime _startDate, System.Int32 _territoryId);
		...
		SalesTerritoryHistory GetBySalesPersonIdStartDateTerritoryId(System.Int32 _salesPersonId, System.DateTime _startDate, System.Int32 _territoryId, int start, int pageLength, out int totalCount);
		...
		TList<SalesTerritoryHistory> GetAll();
		...
		TList<SalesTerritoryHistory> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<SalesTerritoryHistory> GetPaged(out int totalCount);
		...
		TList<SalesTerritoryHistory> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<SalesTerritoryHistory> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<SalesTerritoryHistory> Find(string whereClause)	;
		...
		TList<SalesTerritoryHistory> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<SalesTerritoryHistory> Find(IFilterParameterCollection parameters);
		...
		TList<SalesTerritoryHistory> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<SalesTerritoryHistory> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a SalesTerritoryHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		SalesTerritoryHistory.Insert(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		...
		bool Insert(SalesTerritoryHistory entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{SalesTerritoryHistory}" /> to the datasource.
		/// </summary>
		...
		TList<SalesTerritoryHistory> Insert(TList<SalesTerritoryHistory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a SalesTerritoryHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		SalesTerritoryHistory.Update(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Update(SalesTerritoryHistory entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{SalesTerritoryHistory}" /> to the datasource.
		/// </summary>
		...
		TList<SalesTerritoryHistory> Update(TList<SalesTerritoryHistory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a SalesTerritoryHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		SalesTerritoryHistory.Save(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		SalesTerritoryHistory Save(SalesTerritoryHistory entity);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{SalesTerritoryHistory}" /> to the datasource.
		/// </summary>
		...
		TList<SalesTerritoryHistory> Save(TList<SalesTerritoryHistory> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a SalesTerritoryHistory object into the datasource using a transaction.
		/// </summary>
		...
		///		SalesTerritoryHistory.Delete(entity);
		///	}
        ///	catch (Exception e)
        ///	{
		///		if (tm != null &amp;&amp; tm.IsOpen) tm.Rollback();
		...
		bool Delete(SalesTerritoryHistory entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{SalesTerritoryHistory}" /> to the datasource.
		/// </summary>
		...
		TList<SalesTerritoryHistory> Delete(TList<SalesTerritoryHistory> entityCollection);
		...
		bool Delete(SalesTerritoryHistoryKey key);
		...
		bool Delete(System.Int32 _salesPersonId, System.DateTime _startDate, System.Int32 _territoryId);
