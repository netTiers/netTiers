...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'Document' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IDocument.cs file instead.
	/// All custom implementations should be done in the <see cref="IDocument"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IDocumentServiceBase
	{
		...
		Document GetByFileNameRevision(System.String _fileName, System.String _revision);
		...
		Document GetByFileNameRevision(System.String _fileName, System.String _revision, int start, int pageLength, out int totalCount);
		...
		Document GetByDocumentId(System.Int32 _documentId);
		...
		Document GetByDocumentId(System.Int32 _documentId, int start, int pageLength, out int totalCount);
		...
		TList<Document> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<Document> GetPaged(out int totalCount);
		...
		TList<Document> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<Document> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<Document> Find(string whereClause)	;
		...
		TList<Document> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<Document> Find(IFilterParameterCollection parameters);
		...
		TList<Document> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<Document> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a Document object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{Document}" /> to the datasource.
		/// </summary>
		...
		TList<Document> Insert(TList<Document> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a Document object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{Document}" /> to the datasource.
		/// </summary>
		...
		TList<Document> Update(TList<Document> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a Document object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{Document}" /> to the datasource.
		/// </summary>
		...
		TList<Document> Save(TList<Document> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a Document object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{Document}" /> to the datasource.
		/// </summary>
		...
		TList<Document> Delete(TList<Document> entityCollection);
		...
		bool Delete(System.Int32 _documentId);
		...
		/// <returns>Returns a typed collection of TList<Document> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]


		TList<Document> GetByProductIdFromProductDocument(System.Int32 _productId);
		...
		TList<Document> GetByProductIdFromProductDocument(System.Int32 _productId, int start, int pageLength, out int totalCount);
