...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'Store' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IStore.cs file instead.
	/// All custom implementations should be done in the <see cref="IStore"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IStoreServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{Store}" /> from the datasource based on the FK_Store_Customer_CustomerID key.
		///		FK_Store_Customer_CustomerID Description: Foreign key constraint referencing Customer.CustomerID.
		/// </summary>
		...
		TList<Store> GetByCustomerId(System.Int32 _customerId);
		...
		/// <returns>Returns a collection <see cref="TList{Store}" /> of <c>Store</c> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]


		TList<Store> GetByCustomerId(System.Int32 _customerId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{Store}" /> from the datasource based on the FK_Store_SalesPerson_SalesPersonID key.
		///		FK_Store_SalesPerson_SalesPersonID Description: Foreign key constraint referencing SalesPerson.SalesPersonID
		/// </summary>
		...
		TList<Store> GetBySalesPersonId(System.Int32? _salesPersonId);
		...
		TList<Store> GetBySalesPersonId(System.Int32? _salesPersonId, int start, int pageLength, out int totalCount);
		...
		Store GetByRowguid(System.Guid _rowguid);
		...
		Store GetByRowguid(System.Guid _rowguid, int start, int pageLength, out int totalCount);
		...
		TList<Store> GetByDemographics(string _demographics);
		...
		TList<Store> GetByDemographics(string _demographics, int start, int pageLength, out int totalCount);
		...
		TList<Store> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<Store> GetPaged(out int totalCount);
		...
		TList<Store> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<Store> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<Store> Find(string whereClause)	;
		...
		TList<Store> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<Store> Find(IFilterParameterCollection parameters);
		...
		TList<Store> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<Store> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{Store}" /> to the datasource.
		/// </summary>
		...
		TList<Store> Insert(TList<Store> entityCollection);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{Store}" /> to the datasource.
		/// </summary>
		...
		TList<Store> Update(TList<Store> entityCollection);
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{Store}" /> to the datasource.
		/// </summary>
		...
		TList<Store> Save(TList<Store> entityCollection);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{Store}" /> to the datasource.
		/// </summary>
		...
		TList<Store> Delete(TList<Store> entityCollection);
		...
		/// <returns>Returns a typed collection of TList<Store> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]


		TList<Store> GetByContactIdFromStoreContact(System.Int32 _contactId);
		...
		TList<Store> GetByContactIdFromStoreContact(System.Int32 _contactId, int start, int pageLength, out int totalCount);
