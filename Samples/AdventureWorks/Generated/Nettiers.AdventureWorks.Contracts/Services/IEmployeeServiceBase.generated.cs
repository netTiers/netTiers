...
namespace Nettiers.AdventureWorks.Contracts.Services
{
	...
	///<summary>
	/// An interface representation of the 'Employee' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IEmployee.cs file instead.
	/// All custom implementations should be done in the <see cref="IEmployee"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IEmployeeServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{Employee}" /> from the datasource based on the FK_Employee_Contact_ContactID key.
		...
		TList<Employee> GetByContactId(System.Int32 _contactId);
		...
		TList<Employee> GetByContactId(System.Int32 _contactId, int start, int pageLength, out int totalCount);

		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{Employee}" /> from the datasource based on the FK_Employee_Employee_ManagerID key.
		///		FK_Employee_Employee_ManagerID Description: Foreign key constraint referencing Employee.ManagerID.
		/// </summary>
		...
		TList<Employee> GetByManagerId(System.Int32? _managerId);
		...
		TList<Employee> GetByManagerId(System.Int32? _managerId, int start, int pageLength, out int totalCount);
		...
		Employee GetByLoginId(System.String _loginId);
		...
		Employee GetByLoginId(System.String _loginId, int start, int pageLength, out int totalCount);
		...
		Employee GetByNationalIdNumber(System.String _nationalIdNumber);
		...
		Employee GetByNationalIdNumber(System.String _nationalIdNumber, int start, int pageLength, out int totalCount);
		...
		Employee GetByRowguid(System.Guid _rowguid);
		...
		Employee GetByRowguid(System.Guid _rowguid, int start, int pageLength, out int totalCount);
		...
		Employee GetByEmployeeId(System.Int32 _employeeId);
		...
		Employee GetByEmployeeId(System.Int32 _employeeId, int start, int pageLength, out int totalCount);
		...
		TList<Employee> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<Employee> GetPaged(out int totalCount);
		...
		TList<Employee> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<Employee> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<Employee> Find(string whereClause)	;
		...
		TList<Employee> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<Employee> Find(IFilterParameterCollection parameters);
		...
		TList<Employee> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<Employee> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a Employee object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{Employee}" /> to the datasource.
		/// </summary>
		...
		TList<Employee> Insert(TList<Employee> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a Employee object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{Employee}" /> to the datasource.
		/// </summary>
		...
		TList<Employee> Update(TList<Employee> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a Employee object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{Employee}" /> to the datasource.
		/// </summary>
		...
		TList<Employee> Save(TList<Employee> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a Employee object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{Employee}" /> to the datasource.
		/// </summary>
		...
		TList<Employee> Delete(TList<Employee> entityCollection);
		...
		bool Delete(System.Int32 _employeeId);
		...
		/// <returns>Returns a typed collection of TList<Employee> objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]


		TList<Employee> GetByAddressIdFromEmployeeAddress(System.Int32 _addressId);
		...
		TList<Employee> GetByAddressIdFromEmployeeAddress(System.Int32 _addressId, int start, int pageLength, out int totalCount);
