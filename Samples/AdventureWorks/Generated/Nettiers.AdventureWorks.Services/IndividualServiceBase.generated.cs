...
{		
	...
	/// All custom implementations should be done in the <see cref="Individual"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class IndividualServiceBase : ServiceBase<Individual, IndividualKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="Individual"/> instance .
		///</summary>
		public IndividualServiceBase() : base()
		{
		}
		...
		public static Individual CreateIndividual(System.Int32 _customerId, System.Int32 _contactId, string _demographics, System.DateTime _modifiedDate)
		{
			Individual newEntityIndividual = new Individual();
			newEntityIndividual.CustomerId  = _customerId;
			newEntityIndividual.ContactId  = _contactId;
			newEntityIndividual.Demographics  = _demographics;
			newEntityIndividual.ModifiedDate  = _modifiedDate;
			return newEntityIndividual;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<Individual> securityContext = new SecurityContext<Individual>();
		...
		///</summary>
		public static SecurityContext<Individual> SecurityContext
		{
			get
			{
		...
		/// <summary>
		/// 	public virtual method that Gets rows in a <see cref="TList{Individual}" /> from the datasource based on the FK_Individual_Contact_ContactID key.
		...
		public virtual TList<Individual> GetByContactId(System.Int32 _contactId)
		{
            ...
            {					
				...
				list = new TList<Individual>(dataProvider.IndividualProvider.GetByContactId(transactionManager, _contactId));
			}
            catch (Exception exc)
            {
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Individual> GetByContactId(System.Int32 _contactId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByContactId");
            ...
            {					
				...
				list = new TList<Individual>(dataProvider.IndividualProvider.GetByContactId(transactionManager, _contactId, start, pageLength, out totalCount));
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public override Individual Get(IndividualKey key)
		{
			return GetByCustomerId(key.CustomerId);
		}

		/// <summary>
		///  method that Gets rows in a <see cref="TList{Individual}" /> from the datasource based on the primary key PK_Individual_CustomerID index.
		/// </summary>
		/// <param name="_customerId">Unique customer identification number. Foreign key to Customer.CustomerID.</param>
		/// <returns>Returns an instance of the <see cref="Individual"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Individual GetByCustomerId(System.Int32 _customerId)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				entity = dataProvider.IndividualProvider.GetByCustomerId(transactionManager, _customerId)   as Individual;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns an instance of the <see cref="Individual"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Individual GetByCustomerId(System.Int32 _customerId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByCustomerId");
            ...
            {	
				...
				entity = dataProvider.IndividualProvider.GetByCustomerId(transactionManager, _customerId, start, pageLength, out totalCount)   as Individual;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Individual> GetByDemographics(string _demographics)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.IndividualProvider.GetByDemographics(transactionManager, _demographics)  ;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns an instance of the <see cref="TList{Individual}"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Individual> GetByDemographics(string _demographics, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByDemographics");
            ...
            {	
				...
				list = dataProvider.IndividualProvider.GetByDemographics(transactionManager, _demographics, start, pageLength, out totalCount)  ;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// </summary>
		/// <returns></returns>
		public override TList<Individual> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.IndividualProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<Individual> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.IndividualProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<Individual> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Individual</c> objects.</returns>
		public virtual TList<Individual> GetPaged(int start, int pageLength, out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>Individual</c> objects.</returns>
		public override TList<Individual> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.IndividualProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<Individual> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.IndividualProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<Individual> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.IndividualProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>Individual</c> objects.</returns>
		public virtual TList<Individual> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>Individual</c> objects.</returns>
        public virtual TList<Individual> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Individual</c> objects.</returns>
		public virtual TList<Individual> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.IndividualProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>Individual</c> objects.</returns>
        public virtual TList<Individual> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>Individual</c> objects.</returns>
		public virtual TList<Individual> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.IndividualProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(Individual entity)
		{
            ...
            {	
				...
				result = dataProvider.IndividualProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{Individual}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<Individual> Insert(TList<Individual> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Individual>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.IndividualProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(Individual entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.IndividualProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{Individual}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Individual> Update(TList<Individual> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Individual>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.IndividualProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override Individual Save(Individual entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.IndividualProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{Individual}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<Individual> Save(TList<Individual> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Individual>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.IndividualProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(Individual entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.IndividualProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{Individual}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<Individual> Delete(TList<Individual> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Individual>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.IndividualProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(IndividualKey key)
		{
		...
		public virtual bool Delete(System.Int32 _customerId)
		{
			...
			try
            {
				...
				result = dataProvider.IndividualProvider.Delete(transactionManager, _customerId);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="Individual"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="Individual"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Individual DeepLoadByCustomerId(System.Int32 _customerId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByCustomerId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			Individual entity = GetByCustomerId(_customerId);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="TList&lt;Individual&gt;"/> by the entity keys.  The criteria of the child 
		/// property collections only N Levels Deep based on the <see cref="DeepLoadType"/>.
		/// </summary>
		/// <param name="_demographics">Personal information such as hobbies, and income collected from online shoppers. Used for sales analysis.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">Individual Property Collection Type Array To Include or Exclude from Load</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;Individual&gt;"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Individual> DeepLoadByDemographics(string _demographics, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByDemographics");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			TList<Individual> list = GetByDemographics(_demographics);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(Individual)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Individual entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Individual entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="Individual"/> object to load.</param>
		...
		/// <param name="childTypes">Individual Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(Individual entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.IndividualProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{Individual}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Individual)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{Individual}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Individual> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{Individual}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(Individual)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<Individual> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{Individual}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{Individual}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="Individual"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<Individual> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.IndividualProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="Individual"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">Individual Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Individual entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Individual entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.IndividualProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{Individual}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{Individual} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<Individual> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{Individual}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{Individual}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">Individual Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<Individual> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.IndividualProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
