...
namespace Nettiers.AdventureWorks.Services
{
	...
	/// All custom implementations should be done in the <see cref="TimestampPk"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class TimestampPkServiceBase : ServiceBase<TimestampPk, TimestampPkKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="TimestampPk"/> instance .
		///</summary>
		public TimestampPkServiceBase() : base()
		{
		}
		...
		{
			TimestampPk newEntityTimestampPk = new TimestampPk();
			newEntityTimestampPk.SomeText  = _someText;
			return newEntityTimestampPk;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<TimestampPk> securityContext = new SecurityContext<TimestampPk>();
		...
		///</summary>
		public static SecurityContext<TimestampPk> SecurityContext
		{
			get
			{
		...
		public override TimestampPk Get(TimestampPkKey key)
		{
			return GetByTimestampPk(key.TimestampPk);
		}
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TimestampPk GetByTimestampPk(System.Byte[] _timestampPk)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByTimestampPk");
			#endregion Security check

			#region Initialisation
			TimestampPk entity = null;
			...
			try
            {
				...
				entity = dataProvider.TimestampPkProvider.GetByTimestampPk(transactionManager, _timestampPk)   as TimestampPk;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="TimestampPk"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TimestampPk GetByTimestampPk(System.Byte[] _timestampPk, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByTimestampPk");
			...
			try
            {
				...
				entity = dataProvider.TimestampPkProvider.GetByTimestampPk(transactionManager, _timestampPk, start, pageLength, out totalCount)   as TimestampPk;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// </summary>
		/// <returns></returns>
		public override TList<TimestampPk> GetAll()
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				list = dataProvider.TimestampPkProvider.GetAll(transactionManager);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<TimestampPk> GetAll(int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			...
			try
            {
				...
				list = dataProvider.TimestampPkProvider.GetAll(transactionManager, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<TimestampPk> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>TimestampPk</c> objects.</returns>
		public virtual TList<TimestampPk> GetPaged(int start, int pageLength, out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>TimestampPk</c> objects.</returns>
		public override TList<TimestampPk> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				list = dataProvider.TimestampPkProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<TimestampPk> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				list = dataProvider.TimestampPkProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<TimestampPk> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
			...
			try
            {
				...
				list = dataProvider.TimestampPkProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>TimestampPk</c> objects.</returns>
		public virtual TList<TimestampPk> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>TimestampPk</c> objects.</returns>
        public virtual TList<TimestampPk> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>TimestampPk</c> objects.</returns>
		public virtual TList<TimestampPk> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
			...
			try
            {
				...
				list = dataProvider.TimestampPkProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>TimestampPk</c> objects.</returns>
        public virtual TList<TimestampPk> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>TimestampPk</c> objects.</returns>
		public virtual TList<TimestampPk> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
			...
			try
            {
				...
				list = dataProvider.TimestampPkProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(TimestampPk entity)
		{
			...
			try
            {
				...
				result = dataProvider.TimestampPkProvider.Insert(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{TimestampPk}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<TimestampPk> Insert(TList<TimestampPk> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<TimestampPk>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.TimestampPkProvider.Insert(transactionManager, entityCollection);
		...
		public override bool Update(TimestampPk entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				result = dataProvider.TimestampPkProvider.Update(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{TimestampPk}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<TimestampPk> Update(TList<TimestampPk> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<TimestampPk>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.TimestampPkProvider.Update(transactionManager, entityCollection);
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override TimestampPk Save(TimestampPk entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.TimestampPkProvider.Save(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{TimestampPk}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<TimestampPk> Save(TList<TimestampPk> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<TimestampPk>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.TimestampPkProvider.Save(transactionManager, entityCollection);
		...
		public override bool Delete(TimestampPk entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				result = dataProvider.TimestampPkProvider.Delete(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{TimestampPk}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<TimestampPk> Delete(TList<TimestampPk> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<TimestampPk>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.TimestampPkProvider.Delete(transactionManager, entityCollection);
		...
		public bool Delete(TimestampPkKey key)
		{
			return Delete(key.TimestampPk );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Byte[] _timestampPk)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.TimestampPkProvider.Delete(transactionManager, _timestampPk);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="TimestampPk"/> by the entity keys.  The criteria of the child
		...
		/// <returns>Returns an instance of the <see cref="TimestampPk"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TimestampPk DeepLoadByTimestampPk(System.Byte[] _timestampPk, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByTimestampPk");
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;

			TimestampPk entity = GetByTimestampPk(_timestampPk);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(TimestampPk)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TimestampPk entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TimestampPk entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="TimestampPk"/> object to load.</param>
		...
		/// <param name="childTypes">TimestampPk Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TimestampPk entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.TimestampPkProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{TimestampPk}" /> object with all of the child
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(TimestampPk)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{TimestampPk}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<TimestampPk> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}

		/// <summary>
		/// Deep Loads the <see cref="TList{TimestampPk}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(TimestampPk)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<TimestampPk> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}

		/// <summary>
		/// Deep Loads the entire <see cref="TList{TimestampPk}" /> object with criteria based of the child
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{TimestampPk}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="TimestampPk"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<TimestampPk> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.TimestampPkProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="TimestampPk"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">TimestampPk Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TimestampPk entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TimestampPk entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				result = dataProvider.TimestampPkProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{TimestampPk}" /> object with all of the child
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{TimestampPk} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<TimestampPk> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}

		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{TimestampPk}" /> object with criteria based of the child
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{TimestampPk}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">TimestampPk Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<TimestampPk> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.TimestampPkProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
