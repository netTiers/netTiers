...
namespace Nettiers.AdventureWorks.Services
{
	...
	/// All custom implementations should be done in the <see cref="ContactType"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class ContactTypeServiceBase : ServiceBase<ContactType, ContactTypeKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="ContactType"/> instance .
		///</summary>
		public ContactTypeServiceBase() : base()
		{
		}
		...
		{
			ContactType newEntityContactType = new ContactType();
			newEntityContactType.Name  = _name;
			newEntityContactType.ModifiedDate  = _modifiedDate;
			return newEntityContactType;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<ContactType> securityContext = new SecurityContext<ContactType>();
		...
		///</summary>
		public static SecurityContext<ContactType> SecurityContext
		{
			get
			{
		...
		public override ContactType Get(ContactTypeKey key)
		{
			return GetByContactTypeId(key.ContactTypeId);
		}
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ContactType GetByName(System.String _name)
		{
			...
			try
            {
				...
				entity = dataProvider.ContactTypeProvider.GetByName(transactionManager, _name)   as ContactType;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="ContactType"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ContactType GetByName(System.String _name, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByName");
			...
			try
            {
				...
				entity = dataProvider.ContactTypeProvider.GetByName(transactionManager, _name, start, pageLength, out totalCount)   as ContactType;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns an instance of the <see cref="ContactType"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ContactType GetByContactTypeId(System.Int32 _contactTypeId)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				entity = dataProvider.ContactTypeProvider.GetByContactTypeId(transactionManager, _contactTypeId)   as ContactType;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns an instance of the <see cref="ContactType"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ContactType GetByContactTypeId(System.Int32 _contactTypeId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByContactTypeId");
			...
			try
            {
				...
				entity = dataProvider.ContactTypeProvider.GetByContactTypeId(transactionManager, _contactTypeId, start, pageLength, out totalCount)   as ContactType;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// </summary>
		/// <returns></returns>
		public override TList<ContactType> GetAll()
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				list = dataProvider.ContactTypeProvider.GetAll(transactionManager);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<ContactType> GetAll(int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
			...
			try
            {
				...
				list = dataProvider.ContactTypeProvider.GetAll(transactionManager, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<ContactType> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>ContactType</c> objects.</returns>
		public virtual TList<ContactType> GetPaged(int start, int pageLength, out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>ContactType</c> objects.</returns>
		public override TList<ContactType> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				list = dataProvider.ContactTypeProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<ContactType> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				list = dataProvider.ContactTypeProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<ContactType> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
			...
			try
            {
				...
				list = dataProvider.ContactTypeProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>ContactType</c> objects.</returns>
		public virtual TList<ContactType> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>ContactType</c> objects.</returns>
        public virtual TList<ContactType> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>ContactType</c> objects.</returns>
		public virtual TList<ContactType> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
			...
			try
            {
				...
				list = dataProvider.ContactTypeProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>ContactType</c> objects.</returns>
        public virtual TList<ContactType> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>ContactType</c> objects.</returns>
		public virtual TList<ContactType> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
			...
			try
            {
				...
				list = dataProvider.ContactTypeProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(ContactType entity)
		{
			...
			try
            {
				...
				result = dataProvider.ContactTypeProvider.Insert(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{ContactType}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<ContactType> Insert(TList<ContactType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<ContactType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ContactTypeProvider.Insert(transactionManager, entityCollection);
		...
		public override bool Update(ContactType entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				result = dataProvider.ContactTypeProvider.Update(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{ContactType}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<ContactType> Update(TList<ContactType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<ContactType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ContactTypeProvider.Update(transactionManager, entityCollection);
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override ContactType Save(ContactType entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.ContactTypeProvider.Save(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{ContactType}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<ContactType> Save(TList<ContactType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<ContactType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ContactTypeProvider.Save(transactionManager, entityCollection);
		...
		public override bool Delete(ContactType entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				result = dataProvider.ContactTypeProvider.Delete(transactionManager, entity);
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{ContactType}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<ContactType> Delete(TList<ContactType> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<ContactType>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ContactTypeProvider.Delete(transactionManager, entityCollection);
		...
		public bool Delete(ContactTypeKey key)
		{
			return Delete(key.ContactTypeId );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int32 _contactTypeId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.ContactTypeProvider.Delete(transactionManager, _contactTypeId);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="ContactType"/> by the entity keys.  The criteria of the child
		...
		/// <returns>Returns an instance of the <see cref="ContactType"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ContactType DeepLoadByName(System.String _name, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByName");
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;

			ContactType entity = GetByName(_name);
		...
		/// <returns>Returns an instance of the <see cref="ContactType"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ContactType DeepLoadByContactTypeId(System.Int32 _contactTypeId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByContactTypeId");
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;

			ContactType entity = GetByContactTypeId(_contactTypeId);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(ContactType)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ContactType entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ContactType entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="ContactType"/> object to load.</param>
		...
		/// <param name="childTypes">ContactType Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ContactType entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.ContactTypeProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{ContactType}" /> object with all of the child
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(ContactType)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{ContactType}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<ContactType> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}

		/// <summary>
		/// Deep Loads the <see cref="TList{ContactType}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(ContactType)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<ContactType> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}

		/// <summary>
		/// Deep Loads the entire <see cref="TList{ContactType}" /> object with criteria based of the child
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{ContactType}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="ContactType"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<ContactType> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.ContactTypeProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="ContactType"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">ContactType Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(ContactType entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(ContactType entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
			...
			try
            {
				...
				result = dataProvider.ContactTypeProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{ContactType}" /> object with all of the child
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{ContactType} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<ContactType> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}

		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{ContactType}" /> object with criteria based of the child
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{ContactType}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">ContactType Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<ContactType> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.ContactTypeProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
