...
{		
	...
	/// All custom implementations should be done in the <see cref="SalesReason"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class SalesReasonServiceBase : ServiceBase<SalesReason, SalesReasonKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="SalesReason"/> instance .
		///</summary>
		public SalesReasonServiceBase() : base()
		{
		}
		...
		{
			SalesReason newEntitySalesReason = new SalesReason();
			newEntitySalesReason.Name  = _name;
			newEntitySalesReason.ReasonType  = _reasonType;
			newEntitySalesReason.ModifiedDate  = _modifiedDate;
			return newEntitySalesReason;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<SalesReason> securityContext = new SecurityContext<SalesReason>();
		...
		///</summary>
		public static SecurityContext<SalesReason> SecurityContext
		{
			get
			{
		...
		public override SalesReason Get(SalesReasonKey key)
		{
			return GetBySalesReasonId(key.SalesReasonId);
		}
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual SalesReason GetBySalesReasonId(System.Int32 _salesReasonId)
		{
            ...
            {	
				...
				entity = dataProvider.SalesReasonProvider.GetBySalesReasonId(transactionManager, _salesReasonId)   as SalesReason;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="SalesReason"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual SalesReason GetBySalesReasonId(System.Int32 _salesReasonId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetBySalesReasonId");
            ...
            {	
				...
				entity = dataProvider.SalesReasonProvider.GetBySalesReasonId(transactionManager, _salesReasonId, start, pageLength, out totalCount)   as SalesReason;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// </summary>
		/// <returns></returns>
		public override TList<SalesReason> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<SalesReason> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<SalesReason> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>SalesReason</c> objects.</returns>
		public virtual TList<SalesReason> GetPaged(int start, int pageLength, out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>SalesReason</c> objects.</returns>
		public override TList<SalesReason> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<SalesReason> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<SalesReason> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>SalesReason</c> objects.</returns>
		public virtual TList<SalesReason> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>SalesReason</c> objects.</returns>
        public virtual TList<SalesReason> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>SalesReason</c> objects.</returns>
		public virtual TList<SalesReason> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>SalesReason</c> objects.</returns>
        public virtual TList<SalesReason> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>SalesReason</c> objects.</returns>
		public virtual TList<SalesReason> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(SalesReason entity)
		{
            ...
            {	
				...
				result = dataProvider.SalesReasonProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{SalesReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<SalesReason> Insert(TList<SalesReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<SalesReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.SalesReasonProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(SalesReason entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.SalesReasonProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{SalesReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<SalesReason> Update(TList<SalesReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<SalesReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.SalesReasonProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override SalesReason Save(SalesReason entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.SalesReasonProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{SalesReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<SalesReason> Save(TList<SalesReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<SalesReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.SalesReasonProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(SalesReason entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.SalesReasonProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{SalesReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<SalesReason> Delete(TList<SalesReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<SalesReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.SalesReasonProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(SalesReasonKey key)
		{
			return Delete(key.SalesReasonId );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int32 _salesReasonId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.SalesReasonProvider.Delete(transactionManager, _salesReasonId);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<SalesReason> GetBySalesOrderIdFromSalesOrderHeaderSalesReason(System.Int32 _salesOrderId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetBySalesOrderIdFromSalesOrderHeaderSalesReason");
			#endregion Security check
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.GetBySalesOrderIdFromSalesOrderHeaderSalesReason(transactionManager, _salesOrderId);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of SalesReason objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<SalesReason> GetBySalesOrderIdFromSalesOrderHeaderSalesReason(System.Int32 _salesOrderId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetBySalesOrderIdFromSalesOrderHeaderSalesReason");
            ...
            {	
				...
				list = dataProvider.SalesReasonProvider.GetBySalesOrderIdFromSalesOrderHeaderSalesReason(transactionManager, _salesOrderId, start,  pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="SalesReason"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="SalesReason"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual SalesReason DeepLoadBySalesReasonId(System.Int32 _salesReasonId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadBySalesReasonId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			SalesReason entity = GetBySalesReasonId(_salesReasonId);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(SalesReason)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(SalesReason entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(SalesReason entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="SalesReason"/> object to load.</param>
		...
		/// <param name="childTypes">SalesReason Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(SalesReason entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.SalesReasonProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{SalesReason}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(SalesReason)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{SalesReason}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<SalesReason> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{SalesReason}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(SalesReason)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<SalesReason> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{SalesReason}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{SalesReason}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="SalesReason"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<SalesReason> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.SalesReasonProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="SalesReason"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">SalesReason Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(SalesReason entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(SalesReason entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.SalesReasonProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{SalesReason}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{SalesReason} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<SalesReason> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{SalesReason}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{SalesReason}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">SalesReason Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<SalesReason> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.SalesReasonProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
