...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.JobCandidate.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.JobCandidate objects.
	///</summary>
	public abstract partial class WsJobCandidateProviderBase : JobCandidateProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="WsJobCandidateProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsJobCandidateProviderBase()
		{
		}
		...
		public WsJobCandidateProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.JobCandidate Convert(WsProxy.JobCandidate item)
		{
			Nettiers.AdventureWorks.Entities.JobCandidate outItem = item == null ? null : new Nettiers.AdventureWorks.Entities.JobCandidate();
		...
		/// Convert a nettiers collection to the ws proxy collection.
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.JobCandidate Convert(Nettiers.AdventureWorks.Entities.JobCandidate outItem , WsProxy.JobCandidate item)
		{
			if (item != null && outItem != null)
			{
				outItem.JobCandidateId = item.JobCandidateId;
				outItem.EmployeeId = item.EmployeeId;
				outItem.Resume = item.Resume;
		...
		/// </summary>
		public static WsProxy.JobCandidate Convert(Nettiers.AdventureWorks.Entities.JobCandidate item)
		{
			WsProxy.JobCandidate outItem = new WsProxy.JobCandidate();
			outItem.JobCandidateId = item.JobCandidateId;
			outItem.EmployeeId = item.EmployeeId;
			outItem.Resume = item.Resume;
			outItem.ModifiedDate = item.ModifiedDate;
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _jobCandidateId)
			{
				...
				bool result = proxy.JobCandidateProvider_Delete(_jobCandidateId);
				return result;
				}
		...
		public override Nettiers.AdventureWorks.Entities.TList<JobCandidate> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.JobCandidate[] items = proxy.JobCandidateProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.JobCandidate objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<JobCandidate> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.JobCandidate[] items = proxy.JobCandidateProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.JobCandidate objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<JobCandidate> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.JobCandidate[] items = proxy.JobCandidateProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.JobCandidate GetByJobCandidateId(TransactionManager transactionManager, System.Int32 _jobCandidateId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.JobCandidate items = proxy.JobCandidateProvider_GetByJobCandidateId(_jobCandidateId, start, pageLength, out count);
		...
		public override bool Insert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.JobCandidate entity)
		{
			...
			try
			{
				WsProxy.JobCandidate result = proxy.JobCandidateProvider_Insert(Convert(entity));
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<JobCandidate> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.JobCandidateProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.JobCandidate entity)
		{
			...
			try
			{
				WsProxy.JobCandidate result = proxy.JobCandidateProvider_Update(Convert(entity));
				Convert(entity, result);
