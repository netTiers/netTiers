...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	/// </summary>
	public partial class WsVJobCandidateEmploymentProviderBase : VJobCandidateEmploymentProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsVJobCandidateEmploymentProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsVJobCandidateEmploymentProviderBase()
		{		
		}
		...
		public WsVJobCandidateEmploymentProviderBase(string url)
		{
			this.url = url;
		}
		...
		public override VList<VJobCandidateEmployment> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			...
			WsProxy.VJobCandidateEmployment[] items = proxy.VJobCandidateEmploymentProvider_Get(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VJobCandidateEmployment objects.</returns>
		public override VList<VJobCandidateEmployment> GetAll(TransactionManager transactionManager, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.VJobCandidateEmployment[] items = proxy.VJobCandidateEmploymentProvider_GetAll(start, pageLength);			
			return Convert(items); 
			}
			catch(SoapException soex)
			{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VJobCandidateEmployment objects.</returns>
		public override VList<VJobCandidateEmployment> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
