...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	/// </summary>
	public partial class WsVStateProvinceCountryRegionProviderBase : VStateProvinceCountryRegionProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="WsVStateProvinceCountryRegionProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsVStateProvinceCountryRegionProviderBase()
		{
		}
		...
		public WsVStateProvinceCountryRegionProviderBase(string url)
		{
			this.url = url;
		}
		...
		public override VList<VStateProvinceCountryRegion> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			...
			WsProxy.VStateProvinceCountryRegion[] items = proxy.VStateProvinceCountryRegionProvider_Get(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VStateProvinceCountryRegion objects.</returns>
		public override VList<VStateProvinceCountryRegion> GetAll(TransactionManager transactionManager, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.VStateProvinceCountryRegion[] items = proxy.VStateProvinceCountryRegionProvider_GetAll(start, pageLength);
			return Convert(items);
			}
			catch(SoapException soex)
			{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VStateProvinceCountryRegion objects.</returns>
		public override VList<VStateProvinceCountryRegion> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
