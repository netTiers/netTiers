...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	/// </summary>
	public partial class WsVSalesPersonProviderBase : VSalesPersonProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsVSalesPersonProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsVSalesPersonProviderBase()
		{		
		}
		...
		public WsVSalesPersonProviderBase(string url)
		{
			this.url = url;
		}
		...
		/// </summary>
		public static WsProxy.VSalesPerson Convert(VSalesPerson item)
		{			
			WsProxy.VSalesPerson outItem = new WsProxy.VSalesPerson();			
			outItem.SalesPersonId = item.SalesPersonId;
			outItem.Title = item.Title;
			outItem.FirstName = item.FirstName;
			outItem.MiddleName = item.MiddleName;
		...
		public override VList<VSalesPerson> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			...
			WsProxy.VSalesPerson[] items = proxy.VSalesPersonProvider_Get(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VSalesPerson objects.</returns>
		public override VList<VSalesPerson> GetAll(TransactionManager transactionManager, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.VSalesPerson[] items = proxy.VSalesPersonProvider_GetAll(start, pageLength);			
			return Convert(items); 
			}
			catch(SoapException soex)
			{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VSalesPerson objects.</returns>
		public override VList<VSalesPerson> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
