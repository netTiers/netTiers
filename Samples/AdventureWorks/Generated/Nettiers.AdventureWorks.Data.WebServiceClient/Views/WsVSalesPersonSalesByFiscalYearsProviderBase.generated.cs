...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	/// </summary>
	public partial class WsVSalesPersonSalesByFiscalYearsProviderBase : VSalesPersonSalesByFiscalYearsProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="WsVSalesPersonSalesByFiscalYearsProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsVSalesPersonSalesByFiscalYearsProviderBase()
		{
		}
		...
		public WsVSalesPersonSalesByFiscalYearsProviderBase(string url)
		{
			this.url = url;
		}
		...
		/// </summary>
		public static WsProxy.VSalesPersonSalesByFiscalYears Convert(VSalesPersonSalesByFiscalYears item)
		{
			WsProxy.VSalesPersonSalesByFiscalYears outItem = new WsProxy.VSalesPersonSalesByFiscalYears();
			outItem.SalesPersonId = item.SalesPersonId;
			outItem.FullName = item.FullName;
			outItem.Title = item.Title;
			outItem.SalesTerritory = item.SalesTerritory;
		...
		public override VList<VSalesPersonSalesByFiscalYears> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			...
			WsProxy.VSalesPersonSalesByFiscalYears[] items = proxy.VSalesPersonSalesByFiscalYearsProvider_Get(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VSalesPersonSalesByFiscalYears objects.</returns>
		public override VList<VSalesPersonSalesByFiscalYears> GetAll(TransactionManager transactionManager, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.VSalesPersonSalesByFiscalYears[] items = proxy.VSalesPersonSalesByFiscalYearsProvider_GetAll(start, pageLength);
			return Convert(items);
			}
			catch(SoapException soex)
			{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VSalesPersonSalesByFiscalYears objects.</returns>
		public override VList<VSalesPersonSalesByFiscalYears> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
