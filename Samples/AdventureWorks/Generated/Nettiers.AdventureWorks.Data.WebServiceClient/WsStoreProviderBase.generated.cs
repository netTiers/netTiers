...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.Store.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.Store objects.
	///</summary>
	public abstract partial class WsStoreProviderBase : StoreProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsStoreProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsStoreProviderBase()
		{		
		}
		...
		public WsStoreProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.TList<Store> Convert(WsProxy.Store[] items)
		{
			Nettiers.AdventureWorks.Entities.TList<Store> outItems = new Nettiers.AdventureWorks.Entities.TList<Store>();
			foreach(WsProxy.Store item in items)
			{
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.Store Convert(WsProxy.Store item)
		{	
			Nettiers.AdventureWorks.Entities.Store outItem = item == null ? null : new Nettiers.AdventureWorks.Entities.Store();
		...
		/// Convert a nettiers collection to the ws proxy collection.
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.Store Convert(Nettiers.AdventureWorks.Entities.Store outItem , WsProxy.Store item)
		{	
		...
		/// </summary>
		public static WsProxy.Store Convert(Nettiers.AdventureWorks.Entities.Store item)
		{			
			WsProxy.Store outItem = new WsProxy.Store();			
			outItem.CustomerId = item.CustomerId;
			outItem.Name = item.Name;
			outItem.SalesPersonId = item.SalesPersonId;
			outItem.Demographics = item.Demographics;
		...
		/// </summary>
		public static WsProxy.Store[] Convert(Nettiers.AdventureWorks.Entities.TList<Store> items)
		{
			WsProxy.Store[] outItems = new WsProxy.Store[items.Count];
			int count = 0;
		
			foreach (Nettiers.AdventureWorks.Entities.Store item in items)
			{
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _customerId)
			{
				...
				bool result = proxy.StoreProvider_Delete(_customerId);				
				return result;
				}
				catch(SoapException soex)
				{
		...
		public override Nettiers.AdventureWorks.Entities.TList<Store> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.Store[] items = proxy.StoreProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.Store objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<Store> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.Store[] items = proxy.StoreProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.Store objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<Store> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.Store[] items = proxy.StoreProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.Store GetByRowguid(TransactionManager transactionManager, System.Guid _rowguid, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.Store items = proxy.StoreProvider_GetByRowguid(_rowguid, start, pageLength, out count);
		...
		/// <param name="count">out parameter to get total records for query</param>	
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Nettiers.AdventureWorks.Entities.TList&lt;Store&gt;"/> class.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<Store> GetBySalesPersonId(TransactionManager transactionManager, System.Int32? _salesPersonId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.Store[] items = proxy.StoreProvider_GetBySalesPersonId(_salesPersonId, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.Store GetByCustomerId(TransactionManager transactionManager, System.Int32 _customerId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.Store items = proxy.StoreProvider_GetByCustomerId(_customerId, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="Nettiers.AdventureWorks.Entities.TList&lt;Store&gt;"/> class.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<Store> GetByDemographics(TransactionManager transactionManager, string _demographics, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.Store[] items = proxy.StoreProvider_GetByDemographics(_demographics, start, pageLength, out count);
		...
		public override bool Insert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.Store entity)
		{
			...
			try
			{
				WsProxy.Store result = proxy.StoreProvider_Insert(Convert(entity));
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<Store> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.StoreProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.Store entity)
		{
			...
			try
			{
				WsProxy.Store result = proxy.StoreProvider_Update(Convert(entity));
				Convert(entity, result);
