...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.ProductListPriceHistory.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.ProductListPriceHistory objects.
	///</summary>
	public abstract partial class WsProductListPriceHistoryProviderBase : ProductListPriceHistoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="WsProductListPriceHistoryProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsProductListPriceHistoryProviderBase()
		{
		}
		...
		public WsProductListPriceHistoryProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> Convert(WsProxy.ProductListPriceHistory[] items)
		{
			Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> outItems = new Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory>();
			foreach(WsProxy.ProductListPriceHistory item in items)
			{
		...
		/// </summary>
		public static WsProxy.ProductListPriceHistory[] Convert(Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> items)
		{
			WsProxy.ProductListPriceHistory[] outItems = new WsProxy.ProductListPriceHistory[items.Count];
			int count = 0;

			foreach (Nettiers.AdventureWorks.Entities.ProductListPriceHistory item in items)
			{
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _productId, System.DateTime _startDate)
			{
				...
				bool result = proxy.ProductListPriceHistoryProvider_Delete(_productId, _startDate);
				return result;
				}
		...
		public override Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.ProductListPriceHistory[] items = proxy.ProductListPriceHistoryProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductListPriceHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.ProductListPriceHistory[] items = proxy.ProductListPriceHistoryProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductListPriceHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.ProductListPriceHistory[] items = proxy.ProductListPriceHistoryProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductListPriceHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> GetByProductId(TransactionManager transactionManager, System.Int32 _productId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ProductListPriceHistory[] items = proxy.ProductListPriceHistoryProvider_GetByProductId(_productId, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.ProductListPriceHistory GetByProductIdStartDate(TransactionManager transactionManager, System.Int32 _productId, System.DateTime _startDate, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ProductListPriceHistory items = proxy.ProductListPriceHistoryProvider_GetByProductIdStartDate(_productId, _startDate, start, pageLength, out count);
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<ProductListPriceHistory> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.ProductListPriceHistoryProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.ProductListPriceHistory entity)
		{
			...
			try
			{
				WsProxy.ProductListPriceHistory result = proxy.ProductListPriceHistoryProvider_Update(Convert(entity));
				Convert(entity, result);
