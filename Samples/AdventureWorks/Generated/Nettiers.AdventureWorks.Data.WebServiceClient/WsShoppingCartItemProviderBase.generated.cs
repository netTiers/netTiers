...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.ShoppingCartItem.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.ShoppingCartItem objects.
	///</summary>
	public abstract partial class WsShoppingCartItemProviderBase : ShoppingCartItemProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="WsShoppingCartItemProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsShoppingCartItemProviderBase()
		{
		}
		...
		public WsShoppingCartItemProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.ShoppingCartItem Convert(WsProxy.ShoppingCartItem item)
		{
			Nettiers.AdventureWorks.Entities.ShoppingCartItem outItem = item == null ? null : new Nettiers.AdventureWorks.Entities.ShoppingCartItem();
		...
		/// Convert a nettiers collection to the ws proxy collection.
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.ShoppingCartItem Convert(Nettiers.AdventureWorks.Entities.ShoppingCartItem outItem , WsProxy.ShoppingCartItem item)
		{
			if (item != null && outItem != null)
			{
				outItem.ShoppingCartItemId = item.ShoppingCartItemId;
				outItem.ShoppingCartId = item.ShoppingCartId;
				outItem.Quantity = item.Quantity;
				outItem.ProductId = item.ProductId;
				outItem.DateCreated = item.DateCreated;
		...
		/// </summary>
		public static WsProxy.ShoppingCartItem Convert(Nettiers.AdventureWorks.Entities.ShoppingCartItem item)
		{
			WsProxy.ShoppingCartItem outItem = new WsProxy.ShoppingCartItem();
			outItem.ShoppingCartItemId = item.ShoppingCartItemId;
			outItem.ShoppingCartId = item.ShoppingCartId;
			outItem.Quantity = item.Quantity;
			outItem.ProductId = item.ProductId;
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _shoppingCartItemId)
			{
				...
				bool result = proxy.ShoppingCartItemProvider_Delete(_shoppingCartItemId);
				return result;
				}
		...
		public override Nettiers.AdventureWorks.Entities.TList<ShoppingCartItem> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.ShoppingCartItem[] items = proxy.ShoppingCartItemProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ShoppingCartItem objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ShoppingCartItem> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.ShoppingCartItem[] items = proxy.ShoppingCartItemProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ShoppingCartItem objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ShoppingCartItem> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.ShoppingCartItem[] items = proxy.ShoppingCartItemProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ShoppingCartItem objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ShoppingCartItem> GetByProductId(TransactionManager transactionManager, System.Int32 _productId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ShoppingCartItem[] items = proxy.ShoppingCartItemProvider_GetByProductId(_productId, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.ShoppingCartItem GetByShoppingCartItemId(TransactionManager transactionManager, System.Int32 _shoppingCartItemId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ShoppingCartItem items = proxy.ShoppingCartItemProvider_GetByShoppingCartItemId(_shoppingCartItemId, start, pageLength, out count);
		...
		public override bool Insert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.ShoppingCartItem entity)
		{
			...
			try
			{
				WsProxy.ShoppingCartItem result = proxy.ShoppingCartItemProvider_Insert(Convert(entity));
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<ShoppingCartItem> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.ShoppingCartItemProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.ShoppingCartItem entity)
		{
			...
			try
			{
				WsProxy.ShoppingCartItem result = proxy.ShoppingCartItemProvider_Update(Convert(entity));
				Convert(entity, result);
