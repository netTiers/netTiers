...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.ScrapReason.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.ScrapReason objects.
	///</summary>
	public abstract partial class WsScrapReasonProviderBase : ScrapReasonProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsScrapReasonProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsScrapReasonProviderBase()
		{		
		}
		...
		public WsScrapReasonProviderBase(string url)
		{
			this.Url = url;
		}
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int16 _scrapReasonId)
			{
				...
				bool result = proxy.ScrapReasonProvider_Delete(_scrapReasonId);				
				return result;
				}
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ScrapReason objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ScrapReason> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.ScrapReason[] items = proxy.ScrapReasonProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ScrapReason objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ScrapReason> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.ScrapReason[] items = proxy.ScrapReasonProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.ScrapReason GetByName(TransactionManager transactionManager, System.String _name, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ScrapReason items = proxy.ScrapReasonProvider_GetByName(_name, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.ScrapReason GetByScrapReasonId(TransactionManager transactionManager, System.Int16 _scrapReasonId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ScrapReason items = proxy.ScrapReasonProvider_GetByScrapReasonId(_scrapReasonId, start, pageLength, out count);
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<ScrapReason> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.ScrapReasonProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.ScrapReason entity)
		{
			...
			try
			{
				WsProxy.ScrapReason result = proxy.ScrapReasonProvider_Update(Convert(entity));
				Convert(entity, result);
