...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.SpecialOffer.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.SpecialOffer objects.
	///</summary>
	public abstract partial class WsSpecialOfferProviderBase : SpecialOfferProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsSpecialOfferProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsSpecialOfferProviderBase()
		{		
		}
		...
		public WsSpecialOfferProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.TList<SpecialOffer> Convert(WsProxy.SpecialOffer[] items)
		{
			Nettiers.AdventureWorks.Entities.TList<SpecialOffer> outItems = new Nettiers.AdventureWorks.Entities.TList<SpecialOffer>();
			foreach(WsProxy.SpecialOffer item in items)
			{
		...
		/// </summary>
		public static WsProxy.SpecialOffer[] Convert(Nettiers.AdventureWorks.Entities.TList<SpecialOffer> items)
		{
			WsProxy.SpecialOffer[] outItems = new WsProxy.SpecialOffer[items.Count];
			int count = 0;
		
			foreach (Nettiers.AdventureWorks.Entities.SpecialOffer item in items)
			{
		...
		public override TList<SpecialOffer> GetByProductIdFromSpecialOfferProduct(TransactionManager transactionManager, System.Int32 _productId, int start, int pagelen, out int count)
		{
			try
			{
			...
			WsProxy.SpecialOffer[] items = proxy.SpecialOfferProvider_GetByProductIdFromSpecialOfferProduct(_productId, start, pagelen, out count);
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _specialOfferId)
			{
				...
				bool result = proxy.SpecialOfferProvider_Delete(_specialOfferId);				
				return result;
				}
				catch(SoapException soex)
				{
		...
		public override Nettiers.AdventureWorks.Entities.TList<SpecialOffer> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.SpecialOffer[] items = proxy.SpecialOfferProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SpecialOffer objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SpecialOffer> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.SpecialOffer[] items = proxy.SpecialOfferProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SpecialOffer objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SpecialOffer> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.SpecialOffer[] items = proxy.SpecialOfferProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.SpecialOffer GetByRowguid(TransactionManager transactionManager, System.Guid _rowguid, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SpecialOffer items = proxy.SpecialOfferProvider_GetByRowguid(_rowguid, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.SpecialOffer GetBySpecialOfferId(TransactionManager transactionManager, System.Int32 _specialOfferId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SpecialOffer items = proxy.SpecialOfferProvider_GetBySpecialOfferId(_specialOfferId, start, pageLength, out count);
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<SpecialOffer> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.SpecialOfferProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.SpecialOffer entity)
		{
			...
			try
			{
				WsProxy.SpecialOffer result = proxy.SpecialOfferProvider_Update(Convert(entity));
				Convert(entity, result);
