...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.TestProduct.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.TestProduct objects.
	///</summary>
	public abstract partial class WsTestProductProviderBase : TestProductProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsTestProductProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsTestProductProviderBase()
		{		
		}
		...
		public WsTestProductProviderBase(string url)
		{
			this.Url = url;
		}
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _productId)
			{
				...
				bool result = proxy.TestProductProvider_Delete(_productId);				
				return result;
				}
		...
		public override Nettiers.AdventureWorks.Entities.TList<TestProduct> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.TestProduct[] items = proxy.TestProductProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.TestProduct objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<TestProduct> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.TestProduct[] items = proxy.TestProductProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.TestProduct objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<TestProduct> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.TestProduct[] items = proxy.TestProductProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<TestProduct> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.TestProductProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TestProduct entity)
		{
			...
			try
			{
				WsProxy.TestProduct result = proxy.TestProductProvider_Update(Convert(entity));
				Convert(entity, result);
