...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.SalesTerritoryHistory.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.SalesTerritoryHistory objects.
	///</summary>
	public abstract partial class WsSalesTerritoryHistoryProviderBase : SalesTerritoryHistoryProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsSalesTerritoryHistoryProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsSalesTerritoryHistoryProviderBase()
		{		
		}
		...
		public WsSalesTerritoryHistoryProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.SalesTerritoryHistory Convert(WsProxy.SalesTerritoryHistory item)
		{	
			Nettiers.AdventureWorks.Entities.SalesTerritoryHistory outItem = item == null ? null : new Nettiers.AdventureWorks.Entities.SalesTerritoryHistory();
		...
		/// </summary>
		public static WsProxy.SalesTerritoryHistory Convert(Nettiers.AdventureWorks.Entities.SalesTerritoryHistory item)
		{			
			WsProxy.SalesTerritoryHistory outItem = new WsProxy.SalesTerritoryHistory();			
			outItem.SalesPersonId = item.SalesPersonId;
			outItem.TerritoryId = item.TerritoryId;
			outItem.StartDate = item.StartDate;
			outItem.EndDate = item.EndDate;
			...
			outItem.OriginalTerritoryId = item.OriginalTerritoryId;
		...
		/// </summary>
		public static WsProxy.SalesTerritoryHistory[] Convert(Nettiers.AdventureWorks.Entities.TList<SalesTerritoryHistory> items)
		{
			WsProxy.SalesTerritoryHistory[] outItems = new WsProxy.SalesTerritoryHistory[items.Count];
			int count = 0;
		
			foreach (Nettiers.AdventureWorks.Entities.SalesTerritoryHistory item in items)
			{
		...
		public override Nettiers.AdventureWorks.Entities.TList<SalesTerritoryHistory> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.SalesTerritoryHistory[] items = proxy.SalesTerritoryHistoryProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritoryHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SalesTerritoryHistory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.SalesTerritoryHistory[] items = proxy.SalesTerritoryHistoryProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritoryHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SalesTerritoryHistory> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.SalesTerritoryHistory[] items = proxy.SalesTerritoryHistoryProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>		
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritoryHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SalesTerritoryHistory> GetBySalesPersonId(TransactionManager transactionManager, System.Int32 _salesPersonId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SalesTerritoryHistory[] items = proxy.SalesTerritoryHistoryProvider_GetBySalesPersonId(_salesPersonId, start, pageLength, out count);
		...
		/// <remarks></remarks>		
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritoryHistory objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<SalesTerritoryHistory> GetByTerritoryId(TransactionManager transactionManager, System.Int32 _territoryId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SalesTerritoryHistory[] items = proxy.SalesTerritoryHistoryProvider_GetByTerritoryId(_territoryId, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.SalesTerritoryHistory GetByRowguid(TransactionManager transactionManager, System.Guid _rowguid, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.SalesTerritoryHistory items = proxy.SalesTerritoryHistoryProvider_GetByRowguid(_rowguid, start, pageLength, out count);
		...
		public override bool Insert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.SalesTerritoryHistory entity)
		{
			...
			try
			{
				WsProxy.SalesTerritoryHistory result = proxy.SalesTerritoryHistoryProvider_Insert(Convert(entity));
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<SalesTerritoryHistory> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.SalesTerritoryHistoryProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.SalesTerritoryHistory entity)
		{
			...
			try
			{
				WsProxy.SalesTerritoryHistory result = proxy.SalesTerritoryHistoryProvider_Update(Convert(entity));
				Convert(entity, result);
