...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.StateProvince.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.StateProvince objects.
	///</summary>
	public abstract partial class WsStateProvinceProviderBase : StateProvinceProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="WsStateProvinceProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsStateProvinceProviderBase()
		{
		}
		...
		public WsStateProvinceProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.StateProvince Convert(WsProxy.StateProvince item)
		{
			Nettiers.AdventureWorks.Entities.StateProvince outItem = item == null ? null : new Nettiers.AdventureWorks.Entities.StateProvince();
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _stateProvinceId)
			{
				...
				bool result = proxy.StateProvinceProvider_Delete(_stateProvinceId);
				return result;
				}
		...
		public override Nettiers.AdventureWorks.Entities.TList<StateProvince> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.StateProvince[] items = proxy.StateProvinceProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.StateProvince objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<StateProvince> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.StateProvince[] items = proxy.StateProvinceProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.StateProvince objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<StateProvince> GetByCountryRegionCode(TransactionManager transactionManager, System.String _countryRegionCode, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.StateProvince[] items = proxy.StateProvinceProvider_GetByCountryRegionCode(_countryRegionCode, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.StateProvince objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<StateProvince> GetByTerritoryId(TransactionManager transactionManager, System.Int32 _territoryId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.StateProvince[] items = proxy.StateProvinceProvider_GetByTerritoryId(_territoryId, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.StateProvince GetByName(TransactionManager transactionManager, System.String _name, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.StateProvince items = proxy.StateProvinceProvider_GetByName(_name, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.StateProvince GetByRowguid(TransactionManager transactionManager, System.Guid _rowguid, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.StateProvince items = proxy.StateProvinceProvider_GetByRowguid(_rowguid, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.StateProvince GetByStateProvinceId(TransactionManager transactionManager, System.Int32 _stateProvinceId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.StateProvince items = proxy.StateProvinceProvider_GetByStateProvinceId(_stateProvinceId, start, pageLength, out count);
		...
		public override bool Insert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.StateProvince entity)
		{
			...
			try
			{
				WsProxy.StateProvince result = proxy.StateProvinceProvider_Insert(Convert(entity));
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<StateProvince> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.StateProvinceProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.StateProvince entity)
		{
			...
			try
			{
				WsProxy.StateProvince result = proxy.StateProvinceProvider_Update(Convert(entity));
				Convert(entity, result);
