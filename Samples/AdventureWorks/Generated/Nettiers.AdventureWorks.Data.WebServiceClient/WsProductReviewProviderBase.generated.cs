...
/*
	...
	Important: Do not modify this file. Edit the file Nettiers.AdventureWorks.Entities.ProductReview.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for Nettiers.AdventureWorks.Entities.ProductReview objects.
	///</summary>
	public abstract partial class WsProductReviewProviderBase : ProductReviewProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsProductReviewProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsProductReviewProviderBase()
		{		
		}
		...
		public WsProductReviewProviderBase(string url)
		{
			this.Url = url;
		}
		...
		/// </summary>
		public static Nettiers.AdventureWorks.Entities.ProductReview Convert(WsProxy.ProductReview item)
		{	
			Nettiers.AdventureWorks.Entities.ProductReview outItem = item == null ? null : new Nettiers.AdventureWorks.Entities.ProductReview();
		...
		#region Delete Methods
			...
			public override bool Delete(TransactionManager transactionManager, System.Int32 _productReviewId)
			{
				...
				bool result = proxy.ProductReviewProvider_Delete(_productReviewId);				
				return result;
				}
		...
		public override Nettiers.AdventureWorks.Entities.TList<ProductReview> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.ProductReview[] items = proxy.ProductReviewProvider_Find(whereClause, start, pagelen, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductReview objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ProductReview> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.ProductReview[] items = proxy.ProductReviewProvider_GetAll(start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductReview objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ProductReview> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			try
			{
			...
			WsProxy.ProductReview[] items = proxy.ProductReviewProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>		
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductReview objects.</returns>
		public override Nettiers.AdventureWorks.Entities.TList<ProductReview> GetByProductId(TransactionManager transactionManager, System.Int32 _productId, int start, int pageLength, out int count)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ProductReview[] items = proxy.ProductReviewProvider_GetByProductId(_productId, start, pageLength, out count);
		...
		public override Nettiers.AdventureWorks.Entities.ProductReview GetByProductReviewId(TransactionManager transactionManager, System.Int32 _productReviewId, int start, int pageLength, out int count)
		{
			...
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			WsProxy.ProductReview items = proxy.ProductReviewProvider_GetByProductReviewId(_productReviewId, start, pageLength, out count);
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.TList<ProductReview> entityList)
		{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			proxy.Url = Url;
			try
			{
				proxy.ProductReviewProvider_BulkInsert(Convert(entityList));
			}
			catch(SoapException soex)
			{
				System.Diagnostics.Debug.WriteLine(soex);
		...
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.ProductReview entity)
		{
			...
			try
			{
				WsProxy.ProductReview result = proxy.ProductReviewProvider_Update(Convert(entity));
				Convert(entity, result);
