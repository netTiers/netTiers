...
/*
	...
	Important: Do not modify this file. Edit the file SqlEmployeeDepartmentHistoryProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlEmployeeDepartmentHistoryProviderBase : EmployeeDepartmentHistoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlEmployeeDepartmentHistoryProviderBase"/> instance.
		/// </summary>
		public SqlEmployeeDepartmentHistoryProviderBase()
		{
		}
	...
	public SqlEmployeeDepartmentHistoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EmployeeDepartmentHistory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "HumanResources.usp_adwTiers_EmployeeDepartmentHistory_Get_List", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EmployeeDepartmentHistory> GetByEmployeeId(TransactionManager transactionManager, System.Int32 _employeeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "HumanResources.usp_adwTiers_EmployeeDepartmentHistory_GetByEmployeeId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EmployeeDepartmentHistory> GetByDepartmentId(TransactionManager transactionManager, System.Int16 _departmentId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "HumanResources.usp_adwTiers_EmployeeDepartmentHistory_GetByDepartmentId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<EmployeeDepartmentHistory> GetByShiftId(TransactionManager transactionManager, System.Byte _shiftId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "HumanResources.usp_adwTiers_EmployeeDepartmentHistory_GetByShiftId", _useStoredProcedure);
		...
		#region GetByEmployeeIdStartDateDepartmentIdShiftId
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, TList<Nettiers.AdventureWorks.Entities.EmployeeDepartmentHistory> entities)
		{
			...
			bulkCopy.DestinationTableName = "EmployeeDepartmentHistory";

			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("EmployeeID", typeof(System.Int32));
			col0.AllowDBNull = false;
			DataColumn col1 = dataTable.Columns.Add("DepartmentID", typeof(System.Int16));
			col1.AllowDBNull = false;
			DataColumn col2 = dataTable.Columns.Add("ShiftID", typeof(System.Byte));
			...
			foreach(Nettiers.AdventureWorks.Entities.EmployeeDepartmentHistory entity in entities)
			{
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "HumanResources.usp_adwTiers_EmployeeDepartmentHistory_Insert", _useStoredProcedure);
