...
/// </summary>
public abstract partial class SqlVProductModelCatalogDescriptionProviderBase : VProductModelCatalogDescriptionProviderBase
{
	...
	/// <summary>
	/// Creates a new <see cref="SqlVProductModelCatalogDescriptionProviderBase"/> instance.
	/// Uses connection string to connect to datasource.
	/// </summary>
	protected SqlVProductModelCatalogDescriptionProviderBase()
	{
	}
	...
	public SqlVProductModelCatalogDescriptionProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
	...
	public override VList<VProductModelCatalogDescription> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
	{
		...
		DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Production.usp_adwTiers_vProductModelCatalogDescription_Get_List", _useStoredProcedure);
	...
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
		DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Production.usp_adwTiers_vProductModelCatalogDescription_Get", _useStoredProcedure);
