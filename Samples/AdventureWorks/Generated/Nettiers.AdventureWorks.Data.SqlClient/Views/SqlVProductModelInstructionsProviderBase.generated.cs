...
/// </summary>
public abstract partial class SqlVProductModelInstructionsProviderBase : VProductModelInstructionsProviderBase
{
	...
	/// <summary>
	/// Creates a new <see cref="SqlVProductModelInstructionsProviderBase"/> instance.
	/// Uses connection string to connect to datasource.
	/// </summary>
	protected SqlVProductModelInstructionsProviderBase()
	{		
	}
	...
	public SqlVProductModelInstructionsProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
	...
	public override VList<VProductModelInstructions> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
	{
		...
		DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Production.usp_adwTiers_vProductModelInstructions_Get_List", _useStoredProcedure);
	...
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
		DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Production.usp_adwTiers_vProductModelInstructions_Get", _useStoredProcedure);
