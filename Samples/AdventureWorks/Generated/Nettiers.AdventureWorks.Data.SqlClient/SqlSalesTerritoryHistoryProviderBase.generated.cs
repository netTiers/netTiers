...
/*
	...
	Important: Do not modify this file. Edit the file SqlSalesTerritoryHistoryProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSalesTerritoryHistoryProviderBase : SalesTerritoryHistoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSalesTerritoryHistoryProviderBase"/> instance.
		/// </summary>
		public SqlSalesTerritoryHistoryProviderBase()
		{
		}
	...
	public SqlSalesTerritoryHistoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _salesPersonId, System.DateTime _startDate, System.Int32 _territoryId)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SalesTerritoryHistory)
					,_salesPersonId,_startDate,_territoryId);
		...
		public override TList<SalesTerritoryHistory> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<SalesTerritoryHistory>();

			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@ModifiedDate", DbType.DateTime, DBNull.Value);
			...
			//Create Collection
			TList<SalesTerritoryHistory> rows = new TList<SalesTerritoryHistory>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritoryHistory objects.</returns>
		public override TList<SalesTerritoryHistory> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_Find_Dynamic", typeof(SalesTerritoryHistoryColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SalesTerritoryHistory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritoryHistory objects.</returns>
		public override TList<SalesTerritoryHistory> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SalesTerritoryHistory> GetBySalesPersonId(TransactionManager transactionManager, System.Int32 _salesPersonId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_GetBySalesPersonId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SalesTerritoryHistory> GetByTerritoryId(TransactionManager transactionManager, System.Int32 _territoryId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_GetByTerritoryId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override Nettiers.AdventureWorks.Entities.SalesTerritoryHistory GetByRowguid(TransactionManager transactionManager, System.Guid _rowguid, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_GetByRowguid", _useStoredProcedure);

				database.AddInParameter(commandWrapper, "@Rowguid", DbType.Guid, _rowguid);

			IDataReader reader = null;
			TList<SalesTerritoryHistory> tmp = new TList<SalesTerritoryHistory>();
			try
			{
				//Provider Data Requesting Command Event
		...
		#region GetBySalesPersonIdStartDateTerritoryId
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_GetBySalesPersonIdStartDateTerritoryId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetBySalesPersonIdStartDateTerritoryId", tmp));
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetBySalesPersonIdStartDateTerritoryId", tmp));
			}
			finally
			{
				if (reader != null)
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, TList<Nettiers.AdventureWorks.Entities.SalesTerritoryHistory> entities)
		{
			...
			bulkCopy.DestinationTableName = "SalesTerritoryHistory";
			...
			foreach(Nettiers.AdventureWorks.Entities.SalesTerritoryHistory entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.SalesTerritoryHistory entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_Insert", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, Nettiers.AdventureWorks.Entities.SalesTerritoryHistory entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritoryHistory_Update", _useStoredProcedure);

			database.AddInParameter(commandWrapper, "@SalesPersonId", DbType.Int32, entity.SalesPersonId );
			database.AddInParameter(commandWrapper, "@OriginalSalesPersonId", DbType.Int32, entity.OriginalSalesPersonId);
			database.AddInParameter(commandWrapper, "@TerritoryId", DbType.Int32, entity.TerritoryId );
			database.AddInParameter(commandWrapper, "@OriginalTerritoryId", DbType.Int32, entity.OriginalTerritoryId);
			database.AddInParameter(commandWrapper, "@StartDate", DbType.DateTime, entity.StartDate );
