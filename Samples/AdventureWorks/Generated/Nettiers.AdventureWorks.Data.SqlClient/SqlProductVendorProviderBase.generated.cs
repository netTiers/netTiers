...
/*
	...
	Important: Do not modify this file. Edit the file SqlProductVendorProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlProductVendorProviderBase : ProductVendorProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlProductVendorProviderBase"/> instance.
		/// </summary>
		public SqlProductVendorProviderBase()
		{
		}
	...
	public SqlProductVendorProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _productId, System.Int32 _vendorId)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(ProductVendor)
					,_productId,_vendorId);
		...
		public override TList<ProductVendor> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<ProductVendor>();

			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@AverageLeadTime", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@StandardPrice", DbType.Currency, DBNull.Value);
		database.AddInParameter(commandWrapper, "@LastReceiptCost", DbType.Currency, DBNull.Value);
		database.AddInParameter(commandWrapper, "@LastReceiptDate", DbType.DateTime, DBNull.Value);
		database.AddInParameter(commandWrapper, "@MinOrderQty", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@MaxOrderQty", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@OnOrderQty", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@ModifiedDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("averageleadtime ") || clause.Trim().StartsWith("averageleadtime="))
				{
					database.SetParameterValue(commandWrapper, "@AverageLeadTime",
						clause.Trim().Remove(0,15).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("standardprice ") || clause.Trim().StartsWith("standardprice="))
				{
					database.SetParameterValue(commandWrapper, "@StandardPrice",
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("lastreceiptcost ") || clause.Trim().StartsWith("lastreceiptcost="))
				{
					database.SetParameterValue(commandWrapper, "@LastReceiptCost",
						clause.Trim().Remove(0,15).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("lastreceiptdate ") || clause.Trim().StartsWith("lastreceiptdate="))
				{
					database.SetParameterValue(commandWrapper, "@LastReceiptDate",
						clause.Trim().Remove(0,15).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("minorderqty ") || clause.Trim().StartsWith("minorderqty="))
				{
					database.SetParameterValue(commandWrapper, "@MinOrderQty",
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("maxorderqty ") || clause.Trim().StartsWith("maxorderqty="))
				{
					database.SetParameterValue(commandWrapper, "@MaxOrderQty",
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("onorderqty ") || clause.Trim().StartsWith("onorderqty="))
				{
					database.SetParameterValue(commandWrapper, "@OnOrderQty",
			...
			//Create Collection
			TList<ProductVendor> rows = new TList<ProductVendor>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductVendor objects.</returns>
		public override TList<ProductVendor> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_Find_Dynamic", typeof(ProductVendorColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProductVendor> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.ProductVendor objects.</returns>
		public override TList<ProductVendor> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProductVendor> GetByProductId(TransactionManager transactionManager, System.Int32 _productId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_GetByProductId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProductVendor> GetByUnitMeasureCode(TransactionManager transactionManager, System.String _unitMeasureCode, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_GetByUnitMeasureCode", _useStoredProcedure);

				database.AddInParameter(commandWrapper, "@UnitMeasureCode", DbType.StringFixedLength, _unitMeasureCode);

			IDataReader reader = null;
			TList<ProductVendor> tmp = new TList<ProductVendor>();
			try
			{
				//Provider Data Requesting Command Event
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<ProductVendor> GetByVendorId(TransactionManager transactionManager, System.Int32 _vendorId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_GetByVendorId", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_GetByProductIdVendorId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByProductIdVendorId", tmp));
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByProductIdVendorId", tmp));
			}
			finally
			{
				if (reader != null)
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_ProductVendor_Insert", _useStoredProcedure);
