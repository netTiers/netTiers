<%@ Control Language="C#" ClassName="CultureFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataCultureId" Text='<%# Bind("CultureId") %>' MaxLength="6"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataCultureId" runat="server" Display="Dynamic" ControlToValidate="dataCultureId" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
