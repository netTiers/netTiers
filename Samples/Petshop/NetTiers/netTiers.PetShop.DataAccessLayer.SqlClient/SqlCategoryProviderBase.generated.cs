...
namespace netTiers.PetShop.DataAccessLayer.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override netTiers.PetShop.TList<Category> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength)
		{
			...
			//Create Collection
			netTiers.PetShop.TList<Category> rows = new netTiers.PetShop.TList<Category>();
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of netTiers.PetShop.Category objects.</returns>
		public override netTiers.PetShop.TList<Category> GetAll(TransactionManager transactionManager, int start, int pageLength)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of netTiers.PetShop.Category objects.</returns>
		public override netTiers.PetShop.TList<Category> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		public override netTiers.PetShop.Category GetById(TransactionManager transactionManager, System.String id, int start, int pageLength)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			...
			IDataReader reader = null;
			netTiers.PetShop.TList<Category> tmp = new netTiers.PetShop.TList<Category>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.PetShop.Category> entities)
		{
			...
			foreach(netTiers.PetShop.Category entity in entities)
			{
		...
		public override bool Insert(TransactionManager transactionManager, netTiers.PetShop.Category entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
		public override bool Update(TransactionManager transactionManager, netTiers.PetShop.Category entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
