...
namespace netTiers.Petshop.Data.SqlClient
{
	...
	///</summary>
	public partial class SqlOrderStatusProviderBase : OrderStatusProviderBase
	{
		#region Declarations
    ...
    public string ProviderInvariantName
    {
		...
		public override netTiers.Petshop.Entities.TList<OrderStatus> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new netTiers.Petshop.Entities.TList<OrderStatus>();
		...
		database.AddInParameter(commandWrapper, "@Timestamp", DbType.Binary, DBNull.Value);
			...
			//Create Collection
			netTiers.Petshop.Entities.TList<OrderStatus> rows = new netTiers.Petshop.Entities.TList<OrderStatus>();
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override netTiers.Petshop.Entities.TList<OrderStatus> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of netTiers.Petshop.Entities.OrderStatus objects.</returns>
		public override netTiers.Petshop.Entities.TList<OrderStatus> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override netTiers.Petshop.Entities.TList<OrderStatus> GetByOrderId(TransactionManager transactionManager, System.Int32 orderId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override netTiers.Petshop.Entities.TList<OrderStatus> GetByOrderStatusId(TransactionManager transactionManager, System.Int32 orderStatusId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.OrderStatus_GetByOrderStatusId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override netTiers.Petshop.Entities.OrderStatus GetByLineNumOrderId(TransactionManager transactionManager, System.Int32 orderId, System.Int32 lineNum, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.OrderStatus_GetByLineNumOrderId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@OrderId", DbType.Int32, orderId);
				database.AddInParameter(commandWrapper, "@LineNum", DbType.Int32, lineNum);
			
			IDataReader reader = null;
			netTiers.Petshop.Entities.TList<OrderStatus> tmp = new netTiers.Petshop.Entities.TList<OrderStatus>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.Petshop.Entities.OrderStatus> entities)
		{
			...
			DataColumn col3 = dataTable.Columns.Add("OrderStatusId", typeof(System.Int32));
			...
			foreach(netTiers.Petshop.Entities.OrderStatus entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, netTiers.Petshop.Entities.OrderStatus entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, netTiers.Petshop.Entities.OrderStatus entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
