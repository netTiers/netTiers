...
/*
	...
	Important: Do not modify this file. Edit the file SqlProfilesProvider.cs instead.
*/
...
namespace PetShop.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlProfilesProviderBase : ProfilesProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlProfilesProviderBase"/> instance.
		/// </summary>
		public SqlProfilesProviderBase()
		{
		}
	...
	public SqlProfilesProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _uniqueId)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Profiles)
					,_uniqueId);
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PetShop.Business.Profiles objects.</returns>
		public override TList<Profiles> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Profiles_Find_Dynamic", typeof(ProfilesColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Profiles> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PetShop.Business.Profiles objects.</returns>
		public override TList<Profiles> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PetShop.Business.Profiles GetByUsernameApplicationName(TransactionManager transactionManager, System.String _username, System.String _applicationName, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			...
			IDataReader reader = null;
			TList<Profiles> tmp = new TList<Profiles>();
			try
			{
				//Provider Data Requesting Command Event
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PetShop.Business.Profiles GetByUniqueId(TransactionManager transactionManager, System.Int32 _uniqueId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
