<%@ Page Title="Check Out" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="CheckOut.aspx.cs" Inherits="PetShop.UI.CheckOut" %>
                        ...
                        <WizardSteps>
                            <asp:WizardStep ID="wzdStep1" runat="server" Title="Billing Address">
                                <asp:Panel ID="panFicusStep1" runat="server" DefaultButton="StartNextButton">
                                    <PC:AddressForm ID="billingForm" runat="server" />
                                    <table border="0" cellpadding="0" cellspacing="0" class="checkoutButtonBg" width="100%">
                                        <tr>
                                            <td>
                                            </td>
                                            <td align="right">
                                                <asp:LinkButton ID="StartNextButton" runat="server" CommandName="MoveNext" CssClass="continue">Next</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                            ...
                            <asp:WizardStep ID="wzdStep2" runat="server" Title="Shipping Address">
                                <asp:Panel ID="panFicusStep2" runat="server" DefaultButton="StepNextButton">
                                    ...
                                    <PC:AddressForm ID="shippingForm" runat="server" />
                                    <table border="0" cellpadding="0" cellspacing="0" class="checkoutButtonBg" width="100%">
                                        <tr>
                                            <td align="left">
                                                <asp:LinkButton ID="StepPreviousButton" runat="server" CausesValidation="False" CommandName="MovePrevious"
                                                    CssClass="back">Previous</asp:LinkButton>
                                            </td>
                                            <td align="right">
                                                <asp:LinkButton ID="StepNextButton" runat="server" CommandName="MoveNext" CssClass="continue">Next</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                            ...
                            <asp:WizardStep ID="wzdStep3" runat="server" Title="Payment Information">
                                <asp:Panel ID="panFicusStep3" runat="server" DefaultButton="StepNextButton2">
                                            ...
                                            <td class="label">
                                                ...
                                                <asp:RequiredFieldValidator ID="valCCNumber" runat="server" ControlToValidate="txtCCNumber"
                                                    Display="Dynamic" ErrorMessage="Please enter card number."></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                        ID="valCCNumber1" runat="server" ControlToValidate="txtCCNumber" Display="Dynamic"
                                                        ErrorMessage="Card number invalid." ValidationExpression="^([0-9]{15,16})$"></asp:RegularExpressionValidator>&nbsp;
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label">
                                                ...
                                                <asp:RequiredFieldValidator ID="valExpDate" runat="server" ControlToValidate="txtExpDate"
                                                    Display="Dynamic" ErrorMessage="Please enter expiration date."></asp:RequiredFieldValidator><asp:RegularExpressionValidator
                                                        ...
                                                        ValidationExpression="^((0[1-9])|(1[0-2]))\/(\d{4})$" Display="Dynamic"></asp:RegularExpressionValidator>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="checkoutButtonBg" width="100%">
                                        <tr>
                                            <td align="left">
                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="MovePrevious"
                                                    CssClass="back">Previous</asp:LinkButton>
                                            </td>
                                            <td align="right">
                                                <asp:LinkButton ID="StepNextButton2" runat="server" CommandName="MoveNext" CssClass="continue">Next</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                            ...
                            <asp:WizardStep ID="wzdStep4" runat="server" StepType="Finish" Title="Confirmation">
                                <asp:Panel ID="panFicusStep4" runat="server" DefaultButton="FinishButton">
                                    <div class="checkOutLabel">
                                        Your order will not be processed until you select "Submit Order" below.<br />
                                        <br />
                                        <strong>Billing address:<br />
                                        </strong>
                                        <PC:AddressConfirm ID="billingConfirm" runat="server">
                                        </PC:AddressConfirm><br />
                                        <strong>Shipping address:<br />
                                        </strong>
                                        <PC:AddressConfirm ID="shippingConfirm" runat="server">
                                        </PC:AddressConfirm>
                                    </div>
                                    <div class="checkOutLabel">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="checkoutButtonBg" width="100%">
                                        <tr>
                                            <td align="left">
                                                <asp:LinkButton ID="FinishPreviousButton" runat="server" CausesValidation="False"
                                                    CommandName="MovePrevious" CssClass="back">Previous</asp:LinkButton>
                                            </td>
                                            <td align="right">
                                                <asp:LinkButton ID="FinishButton" runat="server" CommandName="MoveComplete" CssClass="submit">Submit Order</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
                            ...
                            <asp:WizardStep ID="wzdStep5" runat="server" AllowReturn="False" StepType="Complete" Title="Receipt">
                                <div class="checkOutLabel">
                                    ...
                                    <br />
                                    <PC:CartList ID="CartListOrdered" runat="server" />
                                    <asp:Literal ID="ItemsOnBackOrder" runat="server" />
                                    <br />
                                    <p>
                                        A total of <strong>
