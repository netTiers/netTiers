<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PetShop.UI.Default" %>
...
<body class="homeBody">
    ...
    <asp:Panel ID="panFocus" runat="server" DefaultButton="btnSearch">
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="780">
            <tr valign="top">
                <td>
                    <img src="Comm_Images/Logo-home.gif" alt="home" />
                </td>
                ...
                <td class="homeBgSearch" width="50">
                    <asp:ImageButton ID="btnSearch" runat="server" AlternateText="Search" CausesValidation="false"
                        CssClass="paddingSearchicon" ImageUrl="Comm_Images/button-search.gif" OnClick="btnSearch_Click" />
                </td>
                <td class="homeBgSearch" width="50">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="780">
        ...
        <tr>
            <td width="112">
                <img height="290" src="Comm_Images/seahorse.gif" width="112" alt="Sea Horse" />
            </td>
            <td bgcolor="#FFFFFF" width="5">
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td class="footerHome">
                Version 4.0 - Powered by .NET 3.5
            </td>
            <td>
                &nbsp;
            </td>
