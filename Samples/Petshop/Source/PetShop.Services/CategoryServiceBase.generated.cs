...
namespace PetShop.Services
{
	...
	public partial class CategoryServiceBase : ServiceBase<Category, CategoryKey>
	{
		...
		public static Category CreateCategory(string _categoryId, string _name, string _descn)
		{
			...
			newEntityCategory.CategoryId  = _categoryId;
			newEntityCategory.Name  = _name;
			newEntityCategory.Descn  = _descn;
		...
		/// <summary>
		///  method that Gets rows in a <see cref="TList{Category}" /> from the datasource based on the primary key PK__Category__19093A0B7F60ED59 index.
		/// </summary>
		/// <param name="_categoryId"></param>
		/// <returns>Returns an instance of the <see cref="Category"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Category GetByCategoryId(string _categoryId)
		{
			...
			try
            {
				...
				entity = dataProvider.CategoryProvider.GetByCategoryId(transactionManager, _categoryId)   as Category;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="Category"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Category GetByCategoryId(string _categoryId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByCategoryId");
			...
			try
            {
				...
				entity = dataProvider.CategoryProvider.GetByCategoryId(transactionManager, _categoryId, start, pageLength, out totalCount)   as Category;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<Category> GetAll()
		{
			...
			try
            {
				...
				list = dataProvider.CategoryProvider.GetAll(transactionManager);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<Category> Find(string whereClause)
		{
			...
			try
            {
				...
				list = dataProvider.CategoryProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>Category</c> objects.</returns>
		public virtual TList<Category> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>Category</c> objects.</returns>
        public virtual TList<Category> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>Category</c> objects.</returns>
		public virtual TList<Category> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
			...
			try
            {
				...
				list = dataProvider.CategoryProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>Category</c> objects.</returns>
        public virtual TList<Category> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>Category</c> objects.</returns>
		public virtual TList<Category> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
		...
		public virtual TList<Category> Insert(TList<Category> entityCollection)
		{
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<Category>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<Category> Update(TList<Category> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<Category>(entityCollection));
			}
			#endregion Security and validation check
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override Category Save(Category entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
		...
		public virtual TList<Category> Save(TList<Category> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<Category>(entityCollection));
			}
			#endregion Security and validation check
		...
		public virtual TList<Category> Delete(TList<Category> entityCollection)
		{
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<Category>(entityCollection));
			}
			#endregion Security and validation check
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(string _categoryId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.CategoryProvider.Delete(transactionManager, _categoryId);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Category DeepLoadByCategoryId(string _categoryId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByCategoryId");
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;

			Category entity = GetByCategoryId(_categoryId);
		...
		/// <param name="entity">Category Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(Category entity)
		{
