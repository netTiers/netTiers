...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="UnitMeasureTest"/> instance.
		/// </summary>	
		public UnitMeasureTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  UnitMeasure objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(UnitMeasure mock)
        {
