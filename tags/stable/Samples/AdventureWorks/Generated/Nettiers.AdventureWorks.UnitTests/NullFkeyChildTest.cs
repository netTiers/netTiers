...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="NullFkeyChildTest"/> instance.
		/// </summary>	
		public NullFkeyChildTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  NullFkeyChild objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public NullFkeyChild CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            NullFkeyChild mock = NullFkeyChildTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, NullFkeyChild mock)
        {
            NullFkeyChildTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(NullFkeyChild mock)
        {
