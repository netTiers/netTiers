...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="AddressTypeTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  AddressType objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(AddressType mock)
        {
