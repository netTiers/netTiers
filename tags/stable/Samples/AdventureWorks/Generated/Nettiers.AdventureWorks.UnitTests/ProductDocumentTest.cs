...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ProductDocumentTest"/> instance.
		/// </summary>	
		public ProductDocumentTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  ProductDocument objects of the database.
		/// </summary>
        ...
        static private void SetSpecialTestData(ProductDocument mock)
        {
