...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TestIssue117TablecTest"/> instance.
		/// </summary>	
		public TestIssue117TablecTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TestIssue117Tablec objects of the database.
		/// </summary>
        ...
        static private void SetSpecialTestData(TestIssue117Tablec mock)
        {
