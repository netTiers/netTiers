...
{
    /// <summary>
    /// Provides tests for the <see cref="VIndividualDemographics"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VIndividualDemographicsTest"/> instance.
		/// </summary>	
		public VIndividualDemographicsTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VIndividualDemographics objects of the database.
		/// </summary>
