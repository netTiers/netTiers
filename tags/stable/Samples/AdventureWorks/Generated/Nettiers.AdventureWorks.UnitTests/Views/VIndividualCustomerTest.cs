...
{
    /// <summary>
    /// Provides tests for the <see cref="VIndividualCustomer"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VIndividualCustomerTest"/> instance.
		/// </summary>	
		public VIndividualCustomerTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VIndividualCustomer objects of the database.
		/// </summary>
