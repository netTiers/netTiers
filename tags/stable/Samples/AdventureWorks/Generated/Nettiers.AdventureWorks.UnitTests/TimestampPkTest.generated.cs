...
/*
	...
	Important: Do not modify this file. Edit the file TimestampPkTest.cs instead.
*/
...
namespace Nettiers.AdventureWorks.UnitTests
{
   ...
   public partial class TimestampPkTest
    {
    	// the TimestampPk instance used to test the repository.
		protected TimestampPk mock;
		
		// the TList<TimestampPk> instance used to test the repository.
		protected TList<TimestampPk> mockCollection;
        ...
        {		
			...
			System.Console.WriteLine("-- Testing the TimestampPk Entity with the {0} --", Nettiers.AdventureWorks.Data.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		private void Step_02_SelectAll_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				mockCollection = DataRepository.TimestampPkProvider.Find(tm, null, "", 0, 10, out count );
				Assert.IsTrue(count >= 0 && mockCollection != null, "Query Failed to issue Find Command.");
				
				System.Console.WriteLine("DataRepository.TimestampPkProvider.Find():");			
		...
		private void Step_04_Update_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				Assert.IsTrue(DataRepository.TimestampPkProvider.Update(tm, mock), "Update failed.");			
				
				System.Console.WriteLine("DataRepository.TimestampPkProvider.Update(mock):");			
				System.Console.WriteLine(mock);
		...
		private void Step_05_Delete_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				mock =  (TimestampPk)CreateMockInstance(tm);
				DataRepository.TimestampPkProvider.Insert(tm, mock);
			
				Assert.IsTrue(DataRepository.TimestampPkProvider.Delete(tm, mock), "Delete failed.");
				System.Console.WriteLine("DataRepository.TimestampPkProvider.Delete(mock):");			
				System.Console.WriteLine(mock);
		...
		private void Step_07_DeserializeEntity_Generated()
		{
			...
			{
				object item = EntityHelper.DeserializeEntityXml<TimestampPk>(sr.ReadToEnd());
				sr.Close();
			}
		...
		private void Step_09_DeserializeCollection_Generated()
		{
			...
			XmlSerializer mySerializer = new XmlSerializer(typeof(TList<TimestampPk>)); 
			using (System.IO.FileStream myFileStream = new System.IO.FileStream(fileName,  System.IO.FileMode.Open))
			{
				TList<TimestampPk> mockCollection = (TList<TimestampPk>) mySerializer.Deserialize(myFileStream);
				myFileStream.Close();
			}
			
			System.IO.File.Delete(fileName);
			System.Console.WriteLine("TList<TimestampPk> correctly deserialized from a temporary file.");	
		}
		#endregion
		...
		private void Step_11_IX_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				TimestampPk t0 = DataRepository.TimestampPkProvider.GetByTimestampPk(tm, entity.TimestampPk);
			}
		}
