...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="SalesPersonTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  SalesPerson objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(SalesPerson mock)
        {
