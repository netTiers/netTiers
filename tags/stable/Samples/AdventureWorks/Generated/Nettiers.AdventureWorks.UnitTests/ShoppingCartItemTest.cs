...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="ShoppingCartItemTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  ShoppingCartItem objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public ShoppingCartItem CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            ShoppingCartItem mock = ShoppingCartItemTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, ShoppingCartItem mock)
        {
            ShoppingCartItemTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(ShoppingCartItem mock)
        {
