...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="LocationTest"/> instance.
		/// </summary>	
		public LocationTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Location objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Location CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Location mock = LocationTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Location mock)
        {
            LocationTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Location mock)
        {
