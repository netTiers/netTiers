...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="JobCandidateTest"/> instance.
		/// </summary>	
		public JobCandidateTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  JobCandidate objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        static private void SetSpecialTestData(JobCandidate mock)
        {
