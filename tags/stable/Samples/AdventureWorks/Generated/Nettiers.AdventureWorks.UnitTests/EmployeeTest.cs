...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="EmployeeTest"/> instance.
		/// </summary>	
		public EmployeeTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  Employee objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
		...
		{
			// Establish additional pre-conditions here
            //Can't delete employees.  Mark them as not current.
        ...
        ///</summary>
        static public Employee CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Employee mock = EmployeeTest.CreateMockInstance_Generated(tm);
