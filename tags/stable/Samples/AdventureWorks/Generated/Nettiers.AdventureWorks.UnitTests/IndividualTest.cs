...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="IndividualTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  Individual objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public Individual CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            Individual mock = IndividualTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, Individual mock)
        {
            IndividualTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(Individual mock)
        {
            //Code your changes to the data object here.
            mock.Demographics = null;
        }
    }
}
