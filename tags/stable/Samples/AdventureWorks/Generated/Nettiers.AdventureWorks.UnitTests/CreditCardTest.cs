...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		...
		/// <summary>
		/// Selects a sample of  CreditCard objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public CreditCard CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            CreditCard mock = CreditCardTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, CreditCard mock)
        {
            CreditCardTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(CreditCard mock)
        {
