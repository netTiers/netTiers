...
namespace Nettiers.AdventureWorks.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CurrencyRateTest"/> instance.
		/// </summary>	
		...
		/// <summary>
		/// Selects a sample of  CurrencyRate objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public CurrencyRate CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            CurrencyRate mock = CurrencyRateTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, CurrencyRate mock)
        {
            CurrencyRateTest.UpdateMockInstance_Generated(tm, mock);
