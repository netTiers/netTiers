...
{
	/// <summary>
	/// This is the abstract edit form for the <see cref="Entities.ScrapReason"/> entity.
	/// </summary>
	/// <remarks>This class is overwritten by .netTiers at each generation.</remarks>
	[System.ComponentModel.DesignerCategoryAttribute("code")]
	public abstract class ScrapReasonEditControlBase : System.Windows.Forms.UserControl
	{
		#region Fields
		...
		/// <summary>
		/// TextBox for the ScrapReasonId property. 
		/// </summary>
		protected System.Windows.Forms.TextBox uxScrapReasonId;
		...
		/// <summary>
		/// Gets or sets the <see cref="Entities.ScrapReason"/> entity to edit with this form.
		/// </summary>
		/// <value>The <see cref="Entities.ScrapReason"/> instance.</value>
		public Entities.ScrapReason ScrapReason
		{
			get {return this._ScrapReason;}
			set
			{
		...
		private void BindControls()
		{
			...
			this.uxScrapReasonId.DataBindings.Add("Text", this.uxBindingSource, "ScrapReasonId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ScrapReasonEditControlBase"/> class.
		/// </summary>
		public ScrapReasonEditControlBase()
		{
			InitializeComponent();			
		...
		{
			if (_ScrapReason != null) _ScrapReason.Validate();
		}	
		...
		public void InitializeComponent()
		{
			...
			this.uxScrapReasonId = new System.Windows.Forms.TextBox();
			...
			this.uxScrapReasonIdLabel.Location = new System.Drawing.Point(3, 0);
            ...
            this.uxScrapReasonId.ReadOnly = true;
			//this.uxTableLayoutPanel.Controls.Add(this.uxScrapReasonId);
			this.uxScrapReasonId.Location = new System.Drawing.Point(160, 0);
			...
			// 
			// ScrapReasonEditControlBase
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			//this.Controls.Add(this.uxTableLayoutPanel);
			this.AutoScroll = true;
			this.Name = "ScrapReasonEditControlBase";
