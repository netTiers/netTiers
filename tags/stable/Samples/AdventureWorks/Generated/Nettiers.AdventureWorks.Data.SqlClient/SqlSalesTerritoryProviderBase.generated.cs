...
/*
	...
	Important: Do not modify this file. Edit the file SqlSalesTerritoryProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSalesTerritoryProviderBase : SalesTerritoryProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSalesTerritoryProviderBase"/> instance.
		/// </summary>
		public SqlSalesTerritoryProviderBase()
		{
		}
	...
	public SqlSalesTerritoryProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _territoryId)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SalesTerritory)
					,_territoryId);
		...
		public override TList<SalesTerritory> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<SalesTerritory>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@Group", DbType.String, DBNull.Value);
		database.AddInParameter(commandWrapper, "@SalesYtd", DbType.Currency, DBNull.Value);
		database.AddInParameter(commandWrapper, "@SalesLastYear", DbType.Currency, DBNull.Value);
		database.AddInParameter(commandWrapper, "@CostYtd", DbType.Currency, DBNull.Value);
		database.AddInParameter(commandWrapper, "@CostLastYear", DbType.Currency, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@ModifiedDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("group ") || clause.Trim().StartsWith("group="))
				{
					database.SetParameterValue(commandWrapper, "@Group", 
						clause.Trim().Remove(0,5).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("salesytd ") || clause.Trim().StartsWith("salesytd="))
				{
					database.SetParameterValue(commandWrapper, "@SalesYtd", 
						clause.Trim().Remove(0,8).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("saleslastyear ") || clause.Trim().StartsWith("saleslastyear="))
				{
					database.SetParameterValue(commandWrapper, "@SalesLastYear", 
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("costytd ") || clause.Trim().StartsWith("costytd="))
				{
					database.SetParameterValue(commandWrapper, "@CostYtd", 
						clause.Trim().Remove(0,7).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("costlastyear ") || clause.Trim().StartsWith("costlastyear="))
				{
					database.SetParameterValue(commandWrapper, "@CostLastYear", 
			...
			//Create Collection
			TList<SalesTerritory> rows = new TList<SalesTerritory>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritory objects.</returns>
		public override TList<SalesTerritory> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_Find_Dynamic", typeof(SalesTerritoryColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SalesTerritory> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.SalesTerritory objects.</returns>
		public override TList<SalesTerritory> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_GetPaged", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_GetByName", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Name", DbType.String, _name);
			
			IDataReader reader = null;
			TList<SalesTerritory> tmp = new TList<SalesTerritory>();
			try
			{
				//Provider Data Requesting Command Event
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_GetByRowguid", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_GetByTerritoryId", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_Insert", _useStoredProcedure);
			
			database.AddOutParameter(commandWrapper, "@TerritoryId", DbType.Int32, 4);
			...
			database.AddInParameter(commandWrapper, "@Group", DbType.String, entity.Group );
			...
			database.AddInParameter(commandWrapper, "@CostYtd", DbType.Currency, entity.CostYtd );
			database.AddInParameter(commandWrapper, "@CostLastYear", DbType.Currency, entity.CostLastYear );
			...
			object _territoryId = database.GetParameterValue(commandWrapper, "@TerritoryId");
			entity.TerritoryId = (System.Int32)_territoryId;
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Sales.usp_adwTiers_SalesTerritory_Update", _useStoredProcedure);
