...
/*
	...
	Important: Do not modify this file. Edit the file SqlVendorProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlVendorProviderBase : VendorProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlVendorProviderBase"/> instance.
		/// </summary>
		public SqlVendorProviderBase()
		{
		}
	...
	public SqlVendorProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<Vendor> GetByProductIdFromProductVendor(TransactionManager transactionManager, System.Int32 _productId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_GetByProductIdFromProductVendor", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@ProductId", DbType.Int32, _productId);
			
			IDataReader reader = null;
			// Create collection and fill
			TList<Vendor> rows = new TList<Vendor>();
			
			try
			{
				// Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByProductIdFromProductVendor", rows)); 
				...
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByProductIdFromProductVendor", rows)); 
		...
		/// <param name="count">out parameter to get total records for query.</param>
		/// <returns>Returns a <c>TList</c> of Vendor objects.</returns>
		public override TList<Vendor> GetByAddressIdFromVendorAddress(TransactionManager transactionManager, System.Int32 _addressId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_GetByAddressIdFromVendorAddress", _useStoredProcedure);
			...
			{
				// Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAddressIdFromVendorAddress", rows)); 
				...
				// Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAddressIdFromVendorAddress", rows)); 
		...
		/// <param name="count">out parameter to get total records for query.</param>
		/// <returns>Returns a <c>TList</c> of Vendor objects.</returns>
		public override TList<Vendor> GetByContactIdFromVendorContact(TransactionManager transactionManager, System.Int32 _contactId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_GetByContactIdFromVendorContact", _useStoredProcedure);
			...
			{
				// Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByContactIdFromVendorContact", rows)); 
				...
				// Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByContactIdFromVendorContact", rows)); 
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Vendor)
					,_vendorId);
		...
		public override TList<Vendor> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<Vendor>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@CreditRating", DbType.Byte, DBNull.Value);
		database.AddInParameter(commandWrapper, "@PreferredVendorStatus", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ActiveFlag", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@PurchasingWebServiceUrl", DbType.String, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ModifiedDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("creditrating ") || clause.Trim().StartsWith("creditrating="))
				{
					database.SetParameterValue(commandWrapper, "@CreditRating", 
						clause.Trim().Remove(0,12).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("preferredvendorstatus ") || clause.Trim().StartsWith("preferredvendorstatus="))
				{
					database.SetParameterValue(commandWrapper, "@PreferredVendorStatus", 
						clause.Trim().Remove(0,21).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("activeflag ") || clause.Trim().StartsWith("activeflag="))
				{
					database.SetParameterValue(commandWrapper, "@ActiveFlag", 
						clause.Trim().Remove(0,10).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("purchasingwebserviceurl ") || clause.Trim().StartsWith("purchasingwebserviceurl="))
				{
					database.SetParameterValue(commandWrapper, "@PurchasingWebServiceUrl", 
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.Vendor objects.</returns>
		public override TList<Vendor> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_Find_Dynamic", typeof(VendorColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Vendor> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.Vendor objects.</returns>
		public override TList<Vendor> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_GetPaged", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_GetByAccountNumber", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@AccountNumber", DbType.String, _accountNumber);
			
			IDataReader reader = null;
			TList<Vendor> tmp = new TList<Vendor>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByAccountNumber", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByAccountNumber", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_Vendor_GetByVendorId", _useStoredProcedure);
