...
/*
	...
	Important: Do not modify this file. Edit the file SqlPurchaseOrderDetailProvider.cs instead.
*/
...
namespace Nettiers.AdventureWorks.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlPurchaseOrderDetailProviderBase : PurchaseOrderDetailProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlPurchaseOrderDetailProviderBase"/> instance.
		/// </summary>
		public SqlPurchaseOrderDetailProviderBase()
		{
		}
	...
	public SqlPurchaseOrderDetailProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _purchaseOrderId, System.Int32 _purchaseOrderDetailId)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_Delete", _useStoredProcedure);
			database.AddInParameter(commandWrapper, "@PurchaseOrderId", DbType.Int32, _purchaseOrderId);
			database.AddInParameter(commandWrapper, "@PurchaseOrderDetailId", DbType.Int32, _purchaseOrderDetailId);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(PurchaseOrderDetail)
					,_purchaseOrderId,_purchaseOrderDetailId);
		...
		public override TList<PurchaseOrderDetail> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<PurchaseOrderDetail>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@PurchaseOrderDetailId", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@LineTotal", DbType.Currency, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ReceivedQty", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@RejectedQty", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@StockedQty", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ModifiedDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("purchaseorderdetailid ") || clause.Trim().StartsWith("purchaseorderdetailid="))
				{
					database.SetParameterValue(commandWrapper, "@PurchaseOrderDetailId", 
				...
				if (clause.Trim().StartsWith("receivedqty ") || clause.Trim().StartsWith("receivedqty="))
				{
					database.SetParameterValue(commandWrapper, "@ReceivedQty", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("rejectedqty ") || clause.Trim().StartsWith("rejectedqty="))
				{
					database.SetParameterValue(commandWrapper, "@RejectedQty", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<PurchaseOrderDetail> rows = new TList<PurchaseOrderDetail>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.PurchaseOrderDetail objects.</returns>
		public override TList<PurchaseOrderDetail> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_Find_Dynamic", typeof(PurchaseOrderDetailColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<PurchaseOrderDetail> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of Nettiers.AdventureWorks.Entities.PurchaseOrderDetail objects.</returns>
		public override TList<PurchaseOrderDetail> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<PurchaseOrderDetail> GetByPurchaseOrderId(TransactionManager transactionManager, System.Int32 _purchaseOrderId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_GetByPurchaseOrderId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByPurchaseOrderId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByPurchaseOrderId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<PurchaseOrderDetail> GetByProductId(TransactionManager transactionManager, System.Int32 _productId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_GetByProductId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@ProductId", DbType.Int32, _productId);
			
			IDataReader reader = null;
			TList<PurchaseOrderDetail> tmp = new TList<PurchaseOrderDetail>();
			try
			{
				//Provider Data Requesting Command Event
		...
		#region GetByPurchaseOrderIdPurchaseOrderDetailId
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_GetByPurchaseOrderIdPurchaseOrderDetailId", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByPurchaseOrderIdPurchaseOrderDetailId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByPurchaseOrderIdPurchaseOrderDetailId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "Purchasing.usp_adwTiers_PurchaseOrderDetail_Insert", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@PurchaseOrderId", DbType.Int32, entity.PurchaseOrderId );
			database.AddOutParameter(commandWrapper, "@PurchaseOrderDetailId", DbType.Int32, 4);
			...
			object _purchaseOrderDetailId = database.GetParameterValue(commandWrapper, "@PurchaseOrderDetailId");
			entity.PurchaseOrderDetailId = (System.Int32)_purchaseOrderDetailId;
