...
{		
	...
	///<summary>
	/// An interface representation of the 'EmployeeAddress' table.
	///</summary>
	/// <remarks>
	/// IMPORTANT!!! You should not modify this partial  interface, modify the IEmployeeAddress.cs file instead.
	/// All custom implementations should be done in the <see cref="IEmployeeAddress"/> class.
	/// </remarks>
	[ServiceContract]
	public partial interface IEmployeeAddressServiceBase
	{
		...
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{EmployeeAddress}" /> from the datasource based on the FK_EmployeeAddress_Address_AddressID key.
		...
		TList<EmployeeAddress> GetByAddressId(System.Int32 _addressId);
		...
		TList<EmployeeAddress> GetByAddressId(System.Int32 _addressId, int start, int pageLength, out int totalCount);
		
		/// <summary>
		/// 	method that Gets rows in a <see cref="TList{EmployeeAddress}" /> from the datasource based on the FK_EmployeeAddress_Employee_EmployeeID key.
		...
		TList<EmployeeAddress> GetByEmployeeId(System.Int32 _employeeId);
		...
		TList<EmployeeAddress> GetByEmployeeId(System.Int32 _employeeId, int start, int pageLength, out int totalCount);
		...
		EmployeeAddress Get(EmployeeAddressKey key);
		...
		EmployeeAddress GetByRowguid(System.Guid _rowguid);
		...
		EmployeeAddress GetByRowguid(System.Guid _rowguid, int start, int pageLength, out int totalCount);
		...
		EmployeeAddress GetByEmployeeIdAddressId(System.Int32 _employeeId, System.Int32 _addressId);
		...
		EmployeeAddress GetByEmployeeIdAddressId(System.Int32 _employeeId, System.Int32 _addressId, int start, int pageLength, out int totalCount);
		...
		TList<EmployeeAddress> GetAll(int start, int pageLength, out int totalCount);
		...
		TList<EmployeeAddress> GetPaged(out int totalCount);
		...
		TList<EmployeeAddress> GetPaged(int start, int pageLength, out int totalCount);
		...
		TList<EmployeeAddress> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount);
		...
		TList<EmployeeAddress> Find(string whereClause)	;
		...
		TList<EmployeeAddress> Find(string whereClause, int start, int pageLength, out int totalCount);
		...
		TList<EmployeeAddress> Find(IFilterParameterCollection parameters);
		...
		TList<EmployeeAddress> Find(IFilterParameterCollection parameters, string orderBy);
		...
		TList<EmployeeAddress> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	public virtualmethod that Inserts a EmployeeAddress object into the datasource using a transaction.
		/// </summary>
		...
		bool Insert(EmployeeAddress entity);
		...
		/// <summary>
		/// 	method that Inserts rows in <see cref="TList{EmployeeAddress}" /> to the datasource.
		/// </summary>
		...
		TList<EmployeeAddress> Insert(TList<EmployeeAddress> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Updates a EmployeeAddress object into the datasource using a transaction.
		/// </summary>
		...
		bool Update(EmployeeAddress entity);
		...
		/// <summary>
		/// 	method that Updates rows in <see cref="TList{EmployeeAddress}" /> to the datasource.
		/// </summary>
		...
		TList<EmployeeAddress> Update(TList<EmployeeAddress> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Saves a EmployeeAddress object into the datasource using a transaction.
		/// </summary>
		...
		/// <summary>
		/// 	method that Saves rows in <see cref="TList{EmployeeAddress}" /> to the datasource.
		/// </summary>
		...
		TList<EmployeeAddress> Save(TList<EmployeeAddress> entityCollection);
		...
		/// <summary>
		/// 	public virtualmethod that Deletes a EmployeeAddress object into the datasource using a transaction.
		/// </summary>
		...
		bool Delete(EmployeeAddress entity);
		...
		/// <summary>
		/// 	method that Deletes rows in <see cref="TList{EmployeeAddress}" /> to the datasource.
		/// </summary>
		...
		TList<EmployeeAddress> Delete(TList<EmployeeAddress> entityCollection);
		...
		bool Delete(EmployeeAddressKey key);
		...
		bool Delete(System.Int32 _employeeId, System.Int32 _addressId);
