...
{		
	...
	/// All custom implementations should be done in the <see cref="ScrapReason"/> class.
	/// </remarks>
	[DataObject]
	[CLSCompliant(true)]
	public partial class ScrapReasonServiceBase : ServiceBase<ScrapReason, ScrapReasonKey>
	{

		#region Constructors
		///<summary>
		/// Creates a new <see cref="ScrapReason"/> instance .
		///</summary>
		public ScrapReasonServiceBase() : base()
		{
		}
		...
		{
			ScrapReason newEntityScrapReason = new ScrapReason();
			newEntityScrapReason.Name  = _name;
			newEntityScrapReason.ModifiedDate  = _modifiedDate;
			return newEntityScrapReason;
		}
		#endregion Constructors


		#region Fields
		private static SecurityContext<ScrapReason> securityContext = new SecurityContext<ScrapReason>();
		...
		///</summary>
		public static SecurityContext<ScrapReason> SecurityContext
		{
			get
			{
		...
		public override ScrapReason Get(ScrapReasonKey key)
		{
			return GetByScrapReasonId(key.ScrapReasonId);
		}
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ScrapReason GetByName(System.String _name)
		{
            ...
            {	
				...
				entity = dataProvider.ScrapReasonProvider.GetByName(transactionManager, _name)   as ScrapReason;
			}
            catch (Exception exc)
            {
		...
		/// <returns>Returns an instance of the <see cref="ScrapReason"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ScrapReason GetByName(System.String _name, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByName");
            ...
            {	
				...
				entity = dataProvider.ScrapReasonProvider.GetByName(transactionManager, _name, start, pageLength, out totalCount)   as ScrapReason;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns an instance of the <see cref="ScrapReason"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ScrapReason GetByScrapReasonId(System.Int16 _scrapReasonId)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				entity = dataProvider.ScrapReasonProvider.GetByScrapReasonId(transactionManager, _scrapReasonId)   as ScrapReason;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns an instance of the <see cref="ScrapReason"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ScrapReason GetByScrapReasonId(System.Int16 _scrapReasonId, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetByScrapReasonId");
            ...
            {	
				...
				entity = dataProvider.ScrapReasonProvider.GetByScrapReasonId(transactionManager, _scrapReasonId, start, pageLength, out totalCount)   as ScrapReason;
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// </summary>
		/// <returns></returns>
		public override TList<ScrapReason> GetAll() 
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.ScrapReasonProvider.GetAll(transactionManager);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<ScrapReason> GetAll(int start, int pageLength, out int totalCount) 
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetAll");
            ...
            {	
				...
				list = dataProvider.ScrapReasonProvider.GetAll(transactionManager, start, pageLength, out totalCount);	
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<ScrapReason> GetPaged(out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>ScrapReason</c> objects.</returns>
		public virtual TList<ScrapReason> GetPaged(int start, int pageLength, out int totalCount)
		{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of <c>ScrapReason</c> objects.</returns>
		public override TList<ScrapReason> GetPaged(string whereClause,string orderBy, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.ScrapReasonProvider.GetPaged(transactionManager, whereClause, orderBy, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public virtual TList<ScrapReason> Find(string whereClause)
		{
			#region Security check
			// throws security exception if not authorized
            ...
            {	
				...
				list = dataProvider.ScrapReasonProvider.Find(transactionManager, whereClause);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override TList<ScrapReason> Find(string whereClause, int start, int pageLength, out int totalCount)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.ScrapReasonProvider.Find(transactionManager, whereClause, start, pageLength, out totalCount);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <returns>Returns a typed collection of <c>ScrapReason</c> objects.</returns>
		public virtual TList<ScrapReason> Find(IFilterParameterCollection parameters)
		{
        ...
        /// <returns>Returns a typed collection of <c>ScrapReason</c> objects.</returns>
        public virtual TList<ScrapReason> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns)
        {
		...
		/// <param name="orderBy">Specifies the sort criteria for the rows in the DataSource (Name ASC; BirthDay DESC, Name ASC);</param>
		/// <returns>Returns a typed collection of <c>ScrapReason</c> objects.</returns>
		public virtual TList<ScrapReason> Find(IFilterParameterCollection parameters, string orderBy)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.ScrapReasonProvider.Find(transactionManager, parameters, orderBy);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
        ...
        /// <returns>Returns a typed collection of <c>ScrapReason</c> objects.</returns>
        public virtual TList<ScrapReason> Find(IFilterParameterCollection parameters, ISortColumnCollection sortColumns, int start, int pageLength, out int count)
        {
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of <c>ScrapReason</c> objects.</returns>
		public virtual TList<ScrapReason> Find(IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Find");
            ...
            {	
				...
				list = dataProvider.ScrapReasonProvider.Find(transactionManager, parameters, orderBy, start, pageLength, out count);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		public override bool Insert(ScrapReason entity)
		{
            ...
            {	
				...
				result = dataProvider.ScrapReasonProvider.Insert(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Inserts rows in <see cref="TList{ScrapReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public virtual TList<ScrapReason> Insert(TList<ScrapReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Insert");
			...
			{
				throw new EntityNotValidException(entityCollection, "Insert", DomainUtil.GetErrorsFromList<ScrapReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ScrapReasonProvider.Insert(transactionManager, entityCollection); 
		...
		public override bool Update(ScrapReason entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.ScrapReasonProvider.Update(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Updates rows in <see cref="TList{ScrapReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<ScrapReason> Update(TList<ScrapReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Update");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Update", DomainUtil.GetErrorsFromList<ScrapReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ScrapReasonProvider.Update(transactionManager, entityCollection); 
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override ScrapReason Save(ScrapReason entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				dataProvider.ScrapReasonProvider.Save(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Saves rows in <see cref="TList{ScrapReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual TList<ScrapReason> Save(TList<ScrapReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Save");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Save", DomainUtil.GetErrorsFromList<ScrapReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ScrapReasonProvider.Save(transactionManager, entityCollection); 
		...
		public override bool Delete(ScrapReason entity)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.ScrapReasonProvider.Delete(transactionManager, entity); 
		...
		/// <summary>
		/// public virtual method that Deletes rows in <see cref="TList{ScrapReason}" /> to the datasource.
		/// </summary>
        ...
        /// </example>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual TList<ScrapReason> Delete(TList<ScrapReason> entityCollection)
		{
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			if (!entityCollection.IsValid)
			{
				throw new EntityNotValidException(entityCollection, "Delete", DomainUtil.GetErrorsFromList<ScrapReason>(entityCollection));
			}
			#endregion Security and validation check
			...
			try
            {
				...
				dataProvider.ScrapReasonProvider.Delete(transactionManager, entityCollection); 
		...
		public bool Delete(ScrapReasonKey key)
		{
			return Delete(key.ScrapReasonId );
		}
		...
		/// <returns>Returns true if operation suceeded.</returns>
		[DataObjectMethod(DataObjectMethodType.Delete)]
		public virtual bool Delete(System.Int16 _scrapReasonId)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("Delete");
			...
			try
            {
				...
				result = dataProvider.ScrapReasonProvider.Delete(transactionManager, _scrapReasonId);
		...
		/// <summary>
		/// public virtualDeep Loads the requested <see cref="ScrapReason"/> by the entity keys.  The criteria of the child 
		...
		/// <returns>Returns an instance of the <see cref="ScrapReason"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ScrapReason DeepLoadByName(System.String _name, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByName");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			ScrapReason entity = GetByName(_name);
		...
		/// <returns>Returns an instance of the <see cref="ScrapReason"/> class and DeepLoaded.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual ScrapReason DeepLoadByScrapReasonId(System.Int16 _scrapReasonId, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoadByScrapReasonId");		    
			bool isBorrowedTransaction = ConnectionScope.Current.HasTransaction;				
	
			ScrapReason entity = GetByScrapReasonId(_scrapReasonId);
		...
		/// <remarks>
		/// <seealso cref="DeepLoad(ScrapReason)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ScrapReason entity)
		{
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ScrapReason entity, bool deep)
		{
		...
		/// </remarks>
		/// <param name="entity">The <see cref="ScrapReason"/> object to load.</param>
		...
		/// <param name="childTypes">ScrapReason Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(ScrapReason entity, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				dataProvider.ScrapReasonProvider.DeepLoad(transactionManager, entity, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// Deep Loads the <see cref="TList{ScrapReason}" /> object with all of the child 
		/// property collections only 1 Level Deep.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(ScrapReason)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		/// <param name="entityCollection">the <see cref="TList{ScrapReason}" /> Object to deep loads.</param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<ScrapReason> entityCollection)
		{
			DeepLoad(entityCollection, false, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Loads the <see cref="TList{ScrapReason}" /> object.
		/// </summary>
		/// <remarks>
		/// <seealso cref="DeepLoad(ScrapReason)"/> overloaded methods for a recursive N Level deep loading method.
		/// </remarks>
		...
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual void DeepLoad(TList<ScrapReason> entityCollection, bool deep)
		{
			DeepLoad(entityCollection, deep, DeepLoadType.ExcludeChildren, System.Type.EmptyTypes);
		}	

		/// <summary>
		/// Deep Loads the entire <see cref="TList{ScrapReason}" /> object with criteria based of the child 
		/// property collections only N Levels Deep based on the DeepLoadType.
		/// </summary>
		/// <remarks>
		/// Use this method with caution as it is possible to DeepLoad with Recursion and traverse an entire collection's object graph.
		/// </remarks>
		/// <param name="entityCollection">The <see cref="TList{ScrapReason}" /> instance to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		...
		///	</param>
		/// <param name="childTypes"><see cref="ScrapReason"/> Property Collection Type Array To Include or Exclude from Load</param>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public override void DeepLoad(TList<ScrapReason> entityCollection, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{	
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepLoad");
			...
			try
            {
				...
				dataProvider.ScrapReasonProvider.DeepLoad(transactionManager, entityCollection, deep, deepLoadType, childTypes);
			}
            catch (Exception exc)
            {
				#region Handle transaction rollback and exception
		...
		/// <summary>
		/// public virtualDeep Saves the <see cref="ScrapReason"/> object with all of the child
		/// property collections N Levels Deep.
		/// </summary>
		/// <param name="entity">ScrapReason Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(ScrapReason entity)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(ScrapReason entity, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{
			#region Security and validation check
			// throws security exception if not authorized
            ...
            {	
				...
				result = dataProvider.ScrapReasonProvider.DeepSave(transactionManager, entity, deepSaveType, childTypes);
		...
		/// <summary>
		/// Deep Save the entire <see cref="TList{ScrapReason}" /> object with all of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection">TList{ScrapReason} Object</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public virtual bool DeepSave(TList<ScrapReason> entityCollection)
		{
			return DeepSave(entityCollection, DeepSaveType.ExcludeChildren, System.Type.EmptyTypes);
		}
		
		/// <summary>
		/// Deep Save the entire object graph of the <see cref="TList{ScrapReason}" /> object with criteria based of the child 
		/// property collections.
		/// </summary>
		/// <param name="entityCollection"><see cref="TList{ScrapReason}" /> Object</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">ScrapReason Property Collection Type Array To Include or Exclude from Save</param>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public override bool DeepSave(TList<ScrapReason> entityCollection, DeepSaveType deepSaveType, params System.Type[] childTypes)
		{	
			#region Security and validation check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("DeepSave");
			...
			try
            {
				...
				result = dataProvider.ScrapReasonProvider.DeepSave(transactionManager, entityCollection,  deepSaveType, childTypes);
