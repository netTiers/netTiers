...
namespace Nettiers.AdventureWorks.Data.WebServiceClient
{
	...
	/// </summary>
	public partial class WsVIndividualCustomerProviderBase : VIndividualCustomerProviderBase
	{
		#region Declarations	
		...
		/// <summary>
		/// Creates a new <see cref="WsVIndividualCustomerProviderBase"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsVIndividualCustomerProviderBase()
		{		
		}
		...
		public WsVIndividualCustomerProviderBase(string url)
		{
			this.url = url;
		}
		...
		public override VList<VIndividualCustomer> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			...
			WsProxy.VIndividualCustomer[] items = proxy.VIndividualCustomerProvider_Get(whereClause, orderBy, start, pageLength, out count);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VIndividualCustomer objects.</returns>
		public override VList<VIndividualCustomer> GetAll(TransactionManager transactionManager, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
			...
			WsProxy.VIndividualCustomer[] items = proxy.VIndividualCustomerProvider_GetAll(start, pageLength);			
			return Convert(items); 
			}
			catch(SoapException soex)
			{
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of VIndividualCustomer objects.</returns>
		public override VList<VIndividualCustomer> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength)
		{
			try
			{
			WsProxy.AdventureWorksServices proxy = new WsProxy.AdventureWorksServices();
