<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="ProductSubcategoryEdit.aspx.cs" Inherits="ProductSubcategoryEdit" Title="ProductSubcategory Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Product Subcategory - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="ProductSubcategoryId" runat="server" DataSourceID="ProductSubcategoryDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/ProductSubcategoryFields.ascx" />
			</EditItemTemplatePaths>
			...
			<EmptyDataTemplate>
				<b>ProductSubcategory not found!</b>
			</EmptyDataTemplate>
		...
		<data:ProductSubcategoryDataSource ID="ProductSubcategoryDataSource" runat="server"
			SelectMethod="GetByProductSubcategoryId"
		>
			<Parameters>
				<asp:QueryStringParameter Name="ProductSubcategoryId" QueryStringField="ProductSubcategoryId" Type="String" />
		...
		<data:ProductDataSource ID="ProductDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:ProductFilter  Column="ProductSubcategoryId" QueryStringField="ProductSubcategoryId" /> 
					</Filters>
				</data:SqlParameter>
