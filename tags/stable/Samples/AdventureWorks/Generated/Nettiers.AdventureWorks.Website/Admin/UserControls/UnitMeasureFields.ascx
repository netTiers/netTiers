<%@ Control Language="C#" ClassName="UnitMeasureFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataUnitMeasureCode" Text='<%# Bind("UnitMeasureCode") %>' MaxLength="3"></asp:TextBox><asp:RequiredFieldValidator ID="ReqVal_dataUnitMeasureCode" runat="server" Display="Dynamic" ControlToValidate="dataUnitMeasureCode" ErrorMessage="Required"></asp:RequiredFieldValidator>
				</td>
			</tr>
			<tr>
