<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="CreditCardEdit.aspx.cs" Inherits="CreditCardEdit" Title="CreditCard Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Credit Card - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="CreditCardId" runat="server" DataSourceID="CreditCardDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/CreditCardFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:CreditCardDataSource ID="CreditCardDataSource" runat="server"
			SelectMethod="GetByCreditCardId"
		>
			<Parameters>
		...
		<data:SalesOrderHeaderDataSource ID="SalesOrderHeaderDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:SalesOrderHeaderFilter  Column="CreditCardId" QueryStringField="CreditCardId" /> 
					</Filters>
				</data:SqlParameter>
