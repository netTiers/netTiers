<%@ Page Title="Sign In" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="PetShop.UI.SignIn" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphPage" runat="server">
    <div align="center" class="signinPosition">
        <asp:Login ID="Login" runat="server" CreateUserUrl="~/NewUser.aspx" SkinID="Login"
