...
{		
	...
	public partial class ItemServiceBase : ServiceBase<Item, ItemKey>
	{
		...
		public static Item CreateItem(System.Guid id, System.String name, System.String description, System.Double? price, System.String currency, System.String photo, System.Guid productId)
		{
		...
		public virtual TList<Item> GetByProductId(System.Guid productId)
		{
			int totalCount = -1;
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Item> GetByProductId(System.Guid productId, int start, int pageLength, out int totalCount)
		{
            ...
            {					
				...
				//Access repository
				list = new TList<Item>(dataProvider.ItemProvider.GetByProductId(transactionManager, productId, start, pageLength, out totalCount));
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Item GetById(System.Guid id)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="Item"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Item GetById(System.Guid id, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.ItemProvider.GetById(transactionManager, id, start, pageLength)   as Item;
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Item> GetBySuppIdFromInventory(System.Guid suppId)
		{
			int totalRecords = -1;
			return GetBySuppIdFromInventory(suppId, 0, defaultMaxRecords, out totalRecords);
		}
		...
		/// <returns>Returns a typed collection of Item objects.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Item> GetBySuppIdFromInventory(System.Guid suppId, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetBySuppIdFromInventory");
			TList<Item> list = null;
			TransactionManager transactionManager = null; 
			totalCount = -1;
			try
            {	
				...
				//call data provider
				list = dataProvider.ItemProvider.GetBySuppIdFromInventory(transactionManager, suppId, start,  pageLength, out totalCount);
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Item DeepLoadById(System.Guid id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
