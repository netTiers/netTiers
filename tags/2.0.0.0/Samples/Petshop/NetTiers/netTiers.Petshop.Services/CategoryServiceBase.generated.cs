...
{		
	...
	public partial class CategoryServiceBase : ServiceBase<Category, CategoryKey>
	{
		...
		public static Category CreateCategory(System.Guid id, System.String name, System.String advicePhoto)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Category GetById(System.Guid id)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="Category"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Category GetById(System.Guid id, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.CategoryProvider.GetById(transactionManager, id, start, pageLength)   as Category;
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Category DeepLoadById(System.Guid id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
