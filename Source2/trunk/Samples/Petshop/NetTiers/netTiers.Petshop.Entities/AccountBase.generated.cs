...
namespace netTiers.Petshop.Entities
{
	...
	{		
		...
		public AccountBase(System.Guid accountId, System.String accountFirstName, System.String accountLastName, 
			...
			System.Guid? accountCreditCardId, System.Guid? accountFavoriteCategoryId)
		{
			this.entityData = new AccountEntityData();
			this.backupData = null;
		...
		///<param name="accountCreditCardId"></param>
		///<param name="accountFavoriteCategoryId"></param>
		public static Account CreateAccount(System.Guid accountId, System.String accountFirstName, System.String accountLastName, 
			System.String accountStreetAddress, System.String accountPostalCode, System.String accountCity, System.String accountStateOrProvince, 
			System.String accountCountry, System.String accountTelephoneNumber, System.String accountEmail, System.String accountLogin, 
			System.String accountPassword, System.Boolean? accountIWantMyList, System.Boolean? accountIWantPetTips, System.String accountFavoriteLanguage, 
			System.Guid? accountCreditCardId, System.Guid? accountFavoriteCategoryId)
		...
		public virtual System.Guid? CreditCardId
		{
			...
			set
			{
				if (this.entityData.CreditCardId == value && this.entityData.CreditCardId != null )
					return;
		...
		/// This property can be set to null. 
		/// If this column is null, this property will return Guid.Empty. It is up to the developer
		/// to check the value of IsFavoriteCategoryIdNull() and perform business logic appropriately.
		/// </remarks>
		[DescriptionAttribute(""), BindableAttribute()]
		[DataObjectField(false,false,true)]
		public virtual System.Guid? FavoriteCategoryId
		{
			get
			{
			...
			set
			{
				if (this.entityData.FavoriteCategoryId == value && this.entityData.FavoriteCategoryId != null )
					return;
		...
		///	which are related to this object through the relation FK_Orders_Account
		/// </summary>	
		[BindableAttribute()]
...
/*
        ...
        public int CompareTo(Account rhs, AccountColumn which)
        {
            switch (which)
            {
            	...
            	case AccountColumn.FavoriteCategoryId:
            		return this.FavoriteCategoryId.Value.CompareTo(rhs.FavoriteCategoryId.Value);
	...
	internal class AccountEntityData : ICloneable
	{
		...
		/// CreditCardId : 
		/// </summary>
		public System.Guid?		  CreditCardId = null;
		
		/// <summary>
		/// FavoriteCategoryId : 
		/// </summary>
		public System.Guid?		  FavoriteCategoryId = null;
	...
	public class AccountKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the AccountKey class.
		/// </summary>
		public AccountKey(System.Guid id)
		{
			#region Init Properties
