...
*/
	...
	public sealed class Filter
	{
		...
		private bool IsOk(string ObjectPropertyValue , string Operator, string UserValue)
		{
			...
			{
				throw new Exception("L'op?rateur '" + Operator + "' n'est pas g?r? pour le type string !");
			}
			return Rt;
		}
		...
		private bool IsOk(int ObjectPropertyValue , string Operator, int UserValue)
		{
			...
			{
				throw new Exception("L'op?rateur '" + Operator + "' n'est pas g?r? pour le type int !");
			}
			return Rt;
		}
		...
		private bool IsOk(Guid ObjectPropertyValue , string Operator, Guid UserValue)
		{
			...
			{
				throw new Exception("L'op?rateur '" + Operator + "' n'est pas g?r? pour le type Guid !");
			}
			return Rt;
		}
		...
		private bool IsOk(double ObjectPropertyValue , string Operator, double UserValue)
		{
			...
			else
			{
				...
				throw new Exception("L'op?rateur '" + Operator + "' n'est pas g?r? pour le type double !");
			}
			return Rt;
		}
		...
		private bool IsOk(decimal ObjectPropertyValue , string Operator, decimal UserValue)
		{
			...
			else
			{
				...
				throw new Exception("L'op?rateur '" + Operator + "' n'est pas g?r? pour le type decimal !");
			}
			return Rt;			
		}
		...
		private bool IsOk(DateTime ObjectPropertyValue , string Operator, DateTime UserValue)
		{
			...
			else
			{
				...
				throw new Exception("L'op?rateur '" + Operator + "' n'est pas g?r? pour le type DateTime !");
			}
			return Rt;
		}
