...
public partial class SqlExtendedItemProviderBase : ExtendedItemProviderBase
{
	...
	public override VList<ExtendedItem> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
	{
	...
	/// <remarks></remarks>
	/// <returns>Returns a typed collection of ExtendedItem objects.</returns>
	public override VList<ExtendedItem> Get(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
