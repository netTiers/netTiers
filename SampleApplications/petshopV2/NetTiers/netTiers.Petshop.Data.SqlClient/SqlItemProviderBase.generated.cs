...
namespace netTiers.Petshop.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@ProductId", DbType.AnsiStringFixedLength, DBNull.Value);
		...
		public override netTiers.Petshop.Entities.TList<Item> GetByProductId(TransactionManager transactionManager, System.String productId, int start, int pageLength, out int count)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Item_GetByProductId", _useStoredProcedure);
				...
				database.AddInParameter(commandWrapper, "@ProductId", DbType.AnsiStringFixedLength, productId);
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.Petshop.Entities.Item> entities)
		{
			...
			DataColumn col6 = dataTable.Columns.Add("ProductId", typeof(System.String));
		...
		public override bool Insert(TransactionManager transactionManager, netTiers.Petshop.Entities.Item entity)
		{
			...
			database.AddInParameter(commandWrapper, "@ProductId", DbType.AnsiStringFixedLength, entity.ProductId );
