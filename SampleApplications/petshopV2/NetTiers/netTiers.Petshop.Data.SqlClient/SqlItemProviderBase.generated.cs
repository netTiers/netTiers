...
namespace netTiers.Petshop.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<Item> GetBySuppIdFromInventory(TransactionManager transactionManager, System.Guid suppId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Item_GetBySuppIdFromInventory", _useStoredProcedure);
			
			database.AddInParameter(commandWrapper, "@SuppId", DbType.Guid, suppId);
			
			IDataReader reader = null;
			//Create collection and fill
			netTiers.Petshop.Entities.TList<Item> rows = new netTiers.Petshop.Entities.TList<Item>();
		...
		public override netTiers.Petshop.Entities.TList<Item> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new netTiers.Petshop.Entities.TList<Item>();
		...
		database.AddInParameter(commandWrapper, "@Price", DbType.Double, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Currency", DbType.AnsiString, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Photo", DbType.AnsiString, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ProductId", DbType.Guid, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("currency ") || clause.Trim().StartsWith("currency="))
				{
					database.SetParameterValue(commandWrapper, "@Currency", 
						clause.Replace("currency","").Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				...
				{
					database.SetParameterValue(commandWrapper, "@ProductId", new Guid(
		...
		public override netTiers.Petshop.Entities.TList<Item> GetByProductId(TransactionManager transactionManager, System.Guid productId, int start, int pageLength, out int count)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Item_GetByProductId", _useStoredProcedure);
				...
				database.AddInParameter(commandWrapper, "@ProductId", DbType.Guid, productId);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Item_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Guid, id);
			
			IDataReader reader = null;
			netTiers.Petshop.Entities.TList<Item> tmp = new netTiers.Petshop.Entities.TList<Item>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.Petshop.Entities.Item> entities)
		{
			...
			DataColumn col3 = dataTable.Columns.Add("Price", typeof(System.Double));
			col3.AllowDBNull = true;		
			DataColumn col4 = dataTable.Columns.Add("Currency", typeof(System.String));
			col4.AllowDBNull = true;		
			DataColumn col5 = dataTable.Columns.Add("Photo", typeof(System.String));
			col5.AllowDBNull = true;		
			DataColumn col6 = dataTable.Columns.Add("ProductId", typeof(System.Guid));
			col6.AllowDBNull = false;		
			DataColumn col7 = dataTable.Columns.Add("Timestamp", typeof(System.Byte[]));
			...
			foreach(netTiers.Petshop.Entities.Item entity in entities)
			{
		...
		public override bool Insert(TransactionManager transactionManager, netTiers.Petshop.Entities.Item entity)
		{
			...
			database.AddInParameter(commandWrapper, "@Price", DbType.Double, (entity.Price.HasValue ? (object) entity.Price  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@Currency", DbType.AnsiString, entity.Currency );
			database.AddInParameter(commandWrapper, "@Photo", DbType.AnsiString, entity.Photo );
			database.AddInParameter(commandWrapper, "@ProductId", DbType.Guid, entity.ProductId );
