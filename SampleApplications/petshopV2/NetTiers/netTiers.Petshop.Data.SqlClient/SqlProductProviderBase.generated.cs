...
namespace netTiers.Petshop.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@CategoryId", DbType.Guid, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Timestamp", DbType.Binary, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				{
					database.SetParameterValue(commandWrapper, "@CategoryId", new Guid(
		...
		public override netTiers.Petshop.Entities.TList<Product> GetByCategoryId(TransactionManager transactionManager, System.Guid categoryId, int start, int pageLength, out int count)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Product_GetByCategoryId", _useStoredProcedure);
				...
				database.AddInParameter(commandWrapper, "@CategoryId", DbType.Guid, categoryId);
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.Petshop.Entities.Product> entities)
		{
			...
			DataColumn col3 = dataTable.Columns.Add("CategoryId", typeof(System.Guid));
		...
		public override bool Insert(TransactionManager transactionManager, netTiers.Petshop.Entities.Product entity)
		{
			...
			database.AddInParameter(commandWrapper, "@CategoryId", DbType.Guid, entity.CategoryId );
