...
namespace netTiers.Petshop.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String id, byte[] timestamp)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Category_Delete", _useStoredProcedure);
		...
		public override netTiers.Petshop.Entities.TList<Category> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new netTiers.Petshop.Entities.TList<Category>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Category_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@AdvicePhoto", DbType.AnsiString, DBNull.Value);
		database.AddInParameter(commandWrapper, "@Timestamp", DbType.Binary, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("advicephoto ") || clause.Trim().StartsWith("advicephoto="))
				{
					database.SetParameterValue(commandWrapper, "@AdvicePhoto", 
						clause.Replace("advicephoto","").Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			netTiers.Petshop.Entities.TList<Category> rows = new netTiers.Petshop.Entities.TList<Category>();
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Category_Get_List", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Category_GetPaged", _useStoredProcedure);
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Category_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.AnsiStringFixedLength, id);
			
			IDataReader reader = null;
			netTiers.Petshop.Entities.TList<Category> tmp = new netTiers.Petshop.Entities.TList<Category>();
			try
			{
				if (transactionManager != null)
				{
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.Petshop.Entities.Category> entities)
		{
			...
			DataColumn col2 = dataTable.Columns.Add("AdvicePhoto", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("AdvicePhoto", "AdvicePhoto");
			bulkCopy.ColumnMappings.Add("Timestamp", "Timestamp");
			
			foreach(netTiers.Petshop.Entities.Category entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["AdvicePhoto"] = entity.AdvicePhoto;
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Category_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@AdvicePhoto", DbType.AnsiString, entity.AdvicePhoto );
