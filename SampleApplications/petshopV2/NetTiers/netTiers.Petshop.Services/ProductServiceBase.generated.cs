...
{		
	...
	public partial class ProductServiceBase : ServiceBase<Product, ProductKey>
	{
		...
		public static Product CreateProduct(System.String id, System.String name, System.String description, System.String categoryId)
		{
		...
		public virtual TList<Product> GetByCategoryId(System.String categoryId)
		{
			int totalCount = -1;
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual TList<Product> GetByCategoryId(System.String categoryId, int start, int pageLength, out int totalCount)
		{
            ...
            {					
				...
				//Access repository
				list = new TList<Product>(dataProvider.ProductProvider.GetByCategoryId(categoryId, start, pageLength, out totalCount));
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Product GetById(System.String id)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="Product"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Product GetById(System.String id, int start, int pageLength, out int totalCount)
		{
			// throws security exception if not authorized
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.ProductProvider.GetById(id, start, pageLength)   as Product;
        ...
        /// <code><![CDATA[
		/// CList<Product> list = new CList<Product>();
		/// Product entity = new Product();
		/// entity.StringProperty = "foo";
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual Product DeepLoadById(System.String id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
