...
{		
	...
	public partial class CreditCardServiceBase : ServiceBase<CreditCard, CreditCardKey>
	{
		...
		public static CreditCard CreateCreditCard(System.String id, System.String number, System.String cardType, System.String expiryMonth, System.String expiryYear)
		{
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual CreditCard GetById(System.String id)
		{
			int totalCount = -1;
		...
		/// <returns>Returns an instance of the <see cref="CreditCard"/> class.</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual CreditCard GetById(System.String id, int start, int pageLength, out int totalCount)
		{
            ...
            {	
				...
				//Access Repository
				entity = dataProvider.CreditCardProvider.GetById(id, start, pageLength)   as CreditCard;
        ...
        /// <code><![CDATA[
		/// CList<CreditCard> list = new CList<CreditCard>();
		/// CreditCard entity = new CreditCard();
		/// entity.StringProperty = "foo";
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
		public virtual CreditCard DeepLoadById(System.String id, bool deep, DeepLoadType deepLoadType, params System.Type[] childTypes)
		{
			// throws security exception if not authorized
