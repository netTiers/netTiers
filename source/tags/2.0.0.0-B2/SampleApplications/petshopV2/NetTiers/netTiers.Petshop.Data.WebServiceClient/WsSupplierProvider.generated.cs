...
/*
	...
	Important: Do not modify this file. Edit the file netTiers.Petshop.Entities.Supplier.cs instead.
*/
...
namespace netTiers.Petshop.Data.WebServiceClient
{
	...
	///<summary>
	/// This class is the webservice client implementation that exposes CRUD methods for netTiers.Petshop.Entities.Supplier objects.
	///</summary>
	public partial class WsSupplierProvider : SupplierProviderBase
	{
		#region "Declarations"	
		...
		/// <summary>
		/// Creates a new <see cref="WsSupplierProvider"/> instance.
		/// Uses connection string to connect to datasource.
		/// </summary>
		public WsSupplierProvider()
		{		
		}
		...
		public WsSupplierProvider(string url)
		{
			this._url = url;
		}
		...
		/// </summary>
		public static netTiers.Petshop.Entities.TList<Supplier> Convert(WsProxy.Supplier[] items)
		{
			netTiers.Petshop.Entities.TList<Supplier> outItems = new netTiers.Petshop.Entities.TList<Supplier>();
			foreach(WsProxy.Supplier item in items)
			{
		...
		/// </summary>
		public static netTiers.Petshop.Entities.Supplier Convert(WsProxy.Supplier item)
		{	
			netTiers.Petshop.Entities.Supplier outItem = new netTiers.Petshop.Entities.Supplier();
		...
		/// Convert a nettiers collection to the ws proxy collection.
		/// </summary>
		public static netTiers.Petshop.Entities.Supplier Convert(netTiers.Petshop.Entities.Supplier outItem , WsProxy.Supplier item)
		{	
			outItem.SuppId = item.SuppId;
			outItem.Name = item.Name;
			outItem.Status = item.Status;
			outItem.Addr1 = item.Addr1;
			outItem.Addr2 = item.Addr2;
			outItem.City = item.City;
			outItem.State = item.State;
			outItem.Zip = item.Zip;
		...
		/// </summary>
		public static WsProxy.Supplier Convert(netTiers.Petshop.Entities.Supplier item)
		{			
			WsProxy.Supplier outItem = new WsProxy.Supplier();			
			outItem.SuppId = item.SuppId;
			outItem.Name = item.Name;
			outItem.Status = item.Status;
			outItem.Addr1 = item.Addr1;
		...
		/// </summary>
		public static WsProxy.Supplier[] Convert(netTiers.Petshop.Entities.TList<Supplier> items)
		{
			WsProxy.Supplier[] outItems = new WsProxy.Supplier[items.Count];
			int count = 0;
		
			foreach (netTiers.Petshop.Entities.Supplier item in items)
			{
		...
		public override TList<Supplier> GetByItemIdFromInventory(TransactionManager transactionManager, System.Guid itemId, int start, int pagelen, out int count)
		{
			WsProxy.petshopDBServices proxy = new WsProxy.petshopDBServices();
			proxy.Url = this._url;
				
			WsProxy.Supplier[] items = proxy.SupplierProvider_GetByItemIdFromInventory(itemId, start, pagelen, out count);
		...
		#region "Delete Functions"			
			...
			public override bool Delete(TransactionManager transactionManager, System.Guid suppId, byte[] timestamp)
			{
				...
				bool result = proxy.SupplierProvider_Delete(suppId, timestamp);				
				return result;
			}
		...
		public override netTiers.Petshop.Entities.TList<Supplier> Find(TransactionManager transactionManager, string whereClause, int start, int pagelen, out int count)
		{
			WsProxy.petshopDBServices proxy = new WsProxy.petshopDBServices();
			proxy.Url = this._url;
			
			WsProxy.Supplier[] items = proxy.SupplierProvider_Find(whereClause, start, pagelen, out count);
		...
		public override netTiers.Petshop.Entities.TList<Supplier> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			...
			WsProxy.Supplier[] items = proxy.SupplierProvider_GetAll(start, pageLength, out count);
		...
		public override netTiers.Petshop.Entities.TList<Supplier> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			...
			WsProxy.Supplier[] items = proxy.SupplierProvider_GetPaged(whereClause, orderBy, start, pageLength, out count);
		...
		public override netTiers.Petshop.Entities.Supplier GetBySuppId(TransactionManager transactionManager, System.Guid suppId, int start, int pageLength, out int count)
		{
			WsProxy.petshopDBServices proxy = new WsProxy.petshopDBServices();
			proxy.Url = this._url;
			WsProxy.Supplier items = proxy.SupplierProvider_GetBySuppId(suppId, start, pageLength, out count);
		...
		public override bool Insert(TransactionManager transactionManager, netTiers.Petshop.Entities.Supplier entity)
		{
			...
			try
			{
				WsProxy.Supplier result = proxy.SupplierProvider_Insert(Convert(entity));
		...
		/// </remarks>
		public override void BulkInsert(TransactionManager transactionManager, TList<netTiers.Petshop.Entities.Supplier> entityList)
		{
			WsProxy.petshopDBServices proxy = new WsProxy.petshopDBServices();
			proxy.Url = this._url;
			try
			{
				proxy.SupplierProvider_BulkInsert(Convert(entityList));
			}
			catch (Exception ex)
			{	
				System.Diagnostics.Debug.WriteLine(ex);
		...
		public override bool Update(TransactionManager transactionManager, netTiers.Petshop.Entities.Supplier entity)
		{
			...
			try
			{
				WsProxy.Supplier result = proxy.SupplierProvider_Update(Convert(entity));
				Convert(entity, result);
