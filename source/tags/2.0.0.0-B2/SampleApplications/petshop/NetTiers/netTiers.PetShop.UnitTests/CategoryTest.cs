...
namespace netTiers.PetShop.UnitTests
{
    ...
    public class CategoryTest
    {
		...
		TList<Category> mockCollection;
		
		TransactionManager transactionManager = null;
		
		/// <summary>
		/// Creates a new <see cref="CategoryTest"/> instance.
		/// </summary>	
		public CategoryTest()
		{			
			this.mock = (Category)CreateMockInstance();						
		}
        ...
        public void Init()
        {
			...
			System.Console.WriteLine("-- Testing the Category Entity with the {0} --", netTiers.PetShop.DataAccessLayer.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		{
			Assert.IsTrue(DataRepository.CategoryProvider.Insert(transactionManager, this.mock), "Insert failed");
									
			System.Console.WriteLine("DataRepository.CategoryProvider.Insert(this.mock):");			
		...
		public void Step_03_DeepLoad()
		{
			if (mockCollection.Count > 0)
			{
				...
				//mockCollection.Shuffle();
				DataRepository.CategoryProvider.DeepLoad(mockCollection[0], true);
				System.Console.WriteLine("Category instance correctly deep loaded at N level.");
		...
		public void Step_04_Update()
		{
			...
			Assert.IsTrue(DataRepository.CategoryProvider.Update(transactionManager, this.mock), "Update failed.");			
		
			// TODO : select sur l'id
			// TODO : verif si l'object recup? est egal
			
			System.Console.WriteLine("DataRepository.CategoryProvider.Update(this.mock):");			
			System.Console.WriteLine(this.mock);
		}
		...
		{
			Assert.IsTrue(DataRepository.CategoryProvider.Delete(transactionManager, this.mock), "Delete failed.");
			System.Console.WriteLine("DataRepository.CategoryProvider.Delete(this.mock):");			
			System.Console.WriteLine(this.mock);
		}
		...
		{
			Category entity = this.mock.Copy() as Category;
			//Assert.IsTrue(EntityHelper.AreObjectsEqual(entity, mock), "Copy is working");

			entity = (Category)this.mock.Clone();
		...
		///</summary>
		public Category CreateMockInstance()
		{		
		...
		///</summary>
		public Category UpdateMockInstance(Category mock)
		{
