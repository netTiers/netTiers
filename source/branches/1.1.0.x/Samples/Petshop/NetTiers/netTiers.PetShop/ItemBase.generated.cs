...
namespace netTiers.PetShop
{
	...
	public abstract partial class ItemBase : EntityBase, System.IComparable, System.ICloneable, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		public ItemBase(System.String itemId, System.String itemName, System.String itemDescription, System.Double? itemPrice, 
		...
		///<param name="itemPhoto"></param>
		///<param name="itemProductId"></param>
		public static Item CreateItem(System.String itemId, System.String itemName, System.String itemDescription, System.Double? itemPrice, 
			System.String itemCurrency, System.String itemPhoto, System.String itemProductId)
		{
		...
		public override System.String Id
		{
			...
			set
			{
				...
				OnPropertyChanged(ItemColumn.Id.ToString());
			}
		}
		...
		public virtual System.String Name
		{
			...
			set
			{
				...
				OnPropertyChanged(ItemColumn.Name.ToString());
			}
		}
		...
		public virtual System.String Description
		{
			...
			set
			{
				...
				OnPropertyChanged(ItemColumn.Description.ToString());
			}
		}
		...
		public virtual System.Double? Price
		{
			...
			set
			{
				...
				OnPropertyChanged(ItemColumn.Price.ToString());
			}
		}
		...
		public virtual System.String Currency
		{
			...
			set
			{
				...
				//if (value != null &&value.Length > 255)
				//{
    			//	throw new ArgumentOutOfRangeException("Currency", "Currency maximum length is 255.");
				//}
				...
				OnPropertyChanged(ItemColumn.Currency.ToString());
			}
		}
		...
		public virtual System.String Photo
		{
			...
			set
			{
				...
				//if (value != null &&value.Length > 255)
				//{
    			//	throw new ArgumentOutOfRangeException("Photo", "Photo maximum length is 255.");
				//}
				...
				OnPropertyChanged(ItemColumn.Photo.ToString());
			}
		}
		...
		public virtual System.String ProductId
		{
			...
			{
				//if ( value == null )
				//	throw new ArgumentNullException("value", "ProductId does not allow null values.");
				if (this.entityData.ProductId == value)
					return;
					
				//if (value.Length > 36)
				//{
    			//	throw new ArgumentOutOfRangeException("ProductId", "ProductId maximum length is 36.");
				//}
				...
				OnPropertyChanged(ItemColumn.ProductId.ToString());
			}
		}
		...
		public virtual System.Byte[] Timestamp
		{
			...
			set
			{
				...
				OnPropertyChanged(ItemColumn.Timestamp.ToString());
			}
		}
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as ItemData;
	            inTxn = true;
		...
		///<summary>
		///  Returns a Typed ItemBase Entity 
		///</summary>
...
/*
	...
	[Serializable]
	internal class ItemData : ICloneable
	{
		#region Variable Declarations
		...
		/// ProductId : 
		/// </summary>
		public System.String		  ProductId = string.Empty;
		...
		protected override void AddValidationRules()
		{
			...
			ValidationRules.AddRule(Validation.CommonRules.NotNull,"ProductId");
			ValidationRules.AddRule(Validation.CommonRules.StringMaxLength,new Validation.CommonRules.MaxLengthRuleArgs("ProductId",36));
