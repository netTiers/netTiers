...
<div class="titlepage">
<div><div class="mediaobject" align="left"><img src="images/logo.gif" align="left"></div><div><h1 class="title"><a name="IDAHAIO"></a>.NetTiers</h1></div><div><h2 class="subtitle">The .Net data tiers generator</h2></div><div><div class="authorgroup"><div class="author"><h3 class="author"><span class="firstname">John</span> <span class="surname">Roland</span></h3></div></div></div><div><p class="copyright">Copyright © 2005 http://www.nettiers.com</p></div><div><p class="pubdate">$Date$</p></div><div><p class="releaseinfo">$Revision$</p></div></div>
...
<dt>7.3. <a href="#IDABRIO">Parameters for webservice</a></dt>
</dl>
</div>
...
<li>
				Open source ! You can modify the templates and contribute (<a href="http://www.sourceforge.net/projects/cstemplates" target="_top">http://www.sourceforge.net/projects/cstemplates</a>)
			</li>
</ul>
</div>
</div>
...
<div class="mediaobject"><img src="images/design.gif"></div>
</div>
<div class="chapter" lang="en">
<div class="titlepage">
...
<dt><span class="section"><a href="#IDADHIO">Code examples :</a></span></dt>
</dl>
</div>
...
<tr>
<td>
								<div class="mediaobject"><img src="images/Employee_DatabaseTable.png"></div>
							</td>
<td>
								<div class="mediaobject"><img src="images/FullDiagram.png"></div>
							</td>
<td class="auto-generated">&nbsp;</td>
</tr>
</tbody>
...
<p>
				...
				<div class="mediaobject"><img src="images/ApplicationConfigurationFile.png"></div>
<P></P>
<p>
				...
				<div class="mediaobject"><img src="images/EntLib_01.png"></div>
<P></P>
<p>
				...
				<div class="mediaobject"><img src="images/EntLib_02.png"></div>
<P></P>
<p>
...
<dt><span class="section"><a href="#IDAFMIO">Sample</a></span></dt>
</dl>
</div>
<div class="section" lang="en">
<div class="titlepage">
...
<div class="mediaobject"><img src="images/nAnt.PNG"></div>
</div>
<div class="chapter" lang="en">
<div class="titlepage">
<div><div><h2 class="title"><a name="IDANNIO"></a>Chapter&nbsp;7.&nbsp;Templates parameters</h2></div></div>
</div>
...
<p>
				The templates can optionnaly generate some nUnit tests. So far these tests are limited to:
			</p>
<div class="itemizedlist">
<ul type="disc">
<li>Insert 
...
<div class="mediaobject"><img src="images/Northwind_UnitTests.png"></div>
</div>
</div>
<div class="chapter" lang="en">
<div class="titlepage">
<div><div><h2 class="title"><a name="IDAHTIO"></a>Chapter&nbsp;9.&nbsp;Recommandations</h2></div></div>
</div>
<div class="toc">
<p><b>Table of Contents</b></p>
<dl>
<dt><span class="section"><a href="#IDALTIO">Database design guide</a></span></dt>
</dl>
</div>
<div class="section" lang="en">
<div class="titlepage">
<div><div><h2 class="title" style="CLEAR: both"><a name="IDALTIO"></a>Database design guide</h2></div></div>
</div>
<p>
...
<dt><span class="section"><a href="#IDA4VIO">v1.1 - Caribert</a></span></dt>
</dl>
</div>
<div class="section" lang="en">
<div class="titlepage">
...
<li>
<p>Generation of nAnt and nDoc files</p>
</li>
</ul>
</div>
</div>
...
<dt><span class="section"><a href="#IDAFXIO">Contributors</a></span></dt>
</dl>
</div>
<div class="section" lang="en">
<div class="titlepage">
...
<p>The project is open source and is hosted at <a href="http://sourceforge.net/projects/cstemplates" target="_top">sourceforge</a>. You
			can also search for information or support via the <a href="http://www.ericjsmith.net/codesmith/forum/default.aspx?f=9&amp;m=3323" target="_top">codesmith
			forum</a>. The templates were originally developped by
			<span class="authorinitials">Ryan Hurdon</span> and are now maintained by
			<span class="authorinitials">John Roland</span>. Here are the list of actual
			contributors:</p>
</div>
<div class="section" lang="en">
<div class="titlepage">
...
<ul type="disc">
<li>
					Ryan Hurdon (Creator of the templates) 
  
<li>
					John Roland (refactoring, base classes, webservice, 
  unit tests, events, Visual studio integration, debuging) 
  
<li>
					Oskar Austegard for the sptemplate script. 
  
<li>
					Dave Kekish (multiple primary keys) 
  
<li>
					Fabio Fabrizio (Find methods, GetPaged methods) 
  
<li>
					Robert Hinojosa (deep load, deep save, entities's 
  children refactoring, view state, business rules, and more) 
  
<li>
					_ab for computed columns 
  
<li>
					Steven Smith for the shuffle method on collection
				</li>
</ul>
</div><a href="http://sourceforge.net" target="_top">
				<div class="mediaobject"><img src="http://sourceforge.net/sflogo.php?group_id=YOUR_GROUP_ID_GOES_HERE&amp;type=7"></div>
			</a></div>
</div>
</div>
